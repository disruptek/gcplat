...
type
  Call_LanguageDocumentsAnalyzeSentiment_593951 = ref object of OpenApiRestCall_593408
proc url_LanguageDocumentsAnalyzeSentiment_593953(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_LanguageDocumentsAnalyzeSentiment_593952(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_593966: Call_LanguageDocumentsAnalyzeSentiment_593951;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Analyzes the sentiment of the provided text.
  ## 
...
proc call*(call_593967: Call_LanguageDocumentsAnalyzeSentiment_593951;
          uploadProtocol: string = ""; fields: string = ""; quotaUser: string = "";
          alt: string = "json"; oauthToken: string = ""; callback: string = "";
          accessToken: string = ""; uploadType: string = ""; key: string = "";
          Xgafv: string = "1"; body: JsonNode = nil; prettyPrint: bool = true): Recallable =
...
var languageDocumentsAnalyzeSentiment* = Call_LanguageDocumentsAnalyzeSentiment_593951(
    ...
    validator: validate_LanguageDocumentsAnalyzeSentiment_593952, base: "/",
    url: url_LanguageDocumentsAnalyzeSentiment_593953, schemes: {Scheme.Https})
type
  Call_LanguageDocumentsAnalyzeSyntax_593970 = ref object of OpenApiRestCall_593408
proc url_LanguageDocumentsAnalyzeSyntax_593972(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_LanguageDocumentsAnalyzeSyntax_593971(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_593985: Call_LanguageDocumentsAnalyzeSyntax_593970; path: JsonNode;
...
proc call*(call_593986: Call_LanguageDocumentsAnalyzeSyntax_593970;
          uploadProtocol: string = ""; fields: string = ""; quotaUser: string = "";
          alt: string = "json"; oauthToken: string = ""; callback: string = "";
          accessToken: string = ""; uploadType: string = ""; key: string = "";
          Xgafv: string = "1"; body: JsonNode = nil; prettyPrint: bool = true): Recallable =
...
var languageDocumentsAnalyzeSyntax* = Call_LanguageDocumentsAnalyzeSyntax_593970(
    ...
    validator: validate_LanguageDocumentsAnalyzeSyntax_593971, base: "/",
    url: url_LanguageDocumentsAnalyzeSyntax_593972, schemes: {Scheme.Https})
type
  Call_LanguageDocumentsAnnotateText_593989 = ref object of OpenApiRestCall_593408
proc url_LanguageDocumentsAnnotateText_593991(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_LanguageDocumentsAnnotateText_593990(path: JsonNode; query: JsonNode;
...
proc call*(call_594004: Call_LanguageDocumentsAnnotateText_593989; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## A convenience method that provides all the features that analyzeSentiment,
  ## analyzeEntities, and analyzeSyntax provide in one call.
  ## 
...
proc call*(call_594005: Call_LanguageDocumentsAnnotateText_593989;
          uploadProtocol: string = ""; fields: string = ""; quotaUser: string = "";
          alt: string = "json"; oauthToken: string = ""; callback: string = "";
          accessToken: string = ""; uploadType: string = ""; key: string = "";
          Xgafv: string = "1"; body: JsonNode = nil; prettyPrint: bool = true): Recallable =
...
var languageDocumentsAnnotateText* = Call_LanguageDocumentsAnnotateText_593989(
    ...
    validator: validate_LanguageDocumentsAnnotateText_593990, base: "/",
    url: url_LanguageDocumentsAnnotateText_593991, schemes: {Scheme.Https})
export
  rest
