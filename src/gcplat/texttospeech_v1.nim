...
type
  Call_TexttospeechTextSynthesize_588710 = ref object of OpenApiRestCall_588441
proc url_TexttospeechTextSynthesize_588712(protocol: Scheme; host: string;
...
proc validate_TexttospeechTextSynthesize_588711(path: JsonNode; query: JsonNode;
...
proc call*(call_588871: Call_TexttospeechTextSynthesize_588710; path: JsonNode;
...
proc call*(call_588942: Call_TexttospeechTextSynthesize_588710;
...
var texttospeechTextSynthesize* = Call_TexttospeechTextSynthesize_588710(
    name: "texttospeechTextSynthesize", meth: HttpMethod.HttpPost,
    host: "texttospeech.googleapis.com", route: "/v1/text:synthesize",
    validator: validate_TexttospeechTextSynthesize_588711, base: "/",
    url: url_TexttospeechTextSynthesize_588712, schemes: {Scheme.Https})
type
  Call_TexttospeechVoicesList_588984 = ref object of OpenApiRestCall_588441
proc url_TexttospeechVoicesList_588986(protocol: Scheme; host: string; base: string;
...
proc validate_TexttospeechVoicesList_588985(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_588997 = query.getOrDefault("languageCode")
  valid_588997 = validateParameter(valid_588997, JString, required = false,
                                 default = nil)
  if valid_588997 != nil:
    section.add "languageCode", valid_588997
...
proc call*(call_588999: Call_TexttospeechVoicesList_588984; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns a list of Voice supported for synthesis.
  ## 
...
proc call*(call_589000: Call_TexttospeechVoicesList_588984;
          uploadProtocol: string = ""; fields: string = ""; quotaUser: string = "";
          alt: string = "json"; oauthToken: string = ""; callback: string = "";
          accessToken: string = ""; uploadType: string = ""; key: string = "";
  ...
  add(query_589001, "languageCode", newJString(languageCode))
  add(query_589001, "prettyPrint", newJBool(prettyPrint))
  result = call_589000.call(nil, query_589001, nil, nil, nil)

var texttospeechVoicesList* = Call_TexttospeechVoicesList_588984(
    name: "texttospeechVoicesList", meth: HttpMethod.HttpGet,
    host: "texttospeech.googleapis.com", route: "/v1/voices",
    validator: validate_TexttospeechVoicesList_588985, base: "/",
    url: url_TexttospeechVoicesList_588986, schemes: {Scheme.Https})
export
  rest
