...
type
  Call_TexttospeechTextSynthesize_578610 = ref object of OpenApiRestCall_578339
proc url_TexttospeechTextSynthesize_578612(protocol: Scheme; host: string;
...
proc validate_TexttospeechTextSynthesize_578611(path: JsonNode; query: JsonNode;
...
proc call*(call_578771: Call_TexttospeechTextSynthesize_578610; path: JsonNode;
...
proc call*(call_578842: Call_TexttospeechTextSynthesize_578610; key: string = "";
...
var texttospeechTextSynthesize* = Call_TexttospeechTextSynthesize_578610(
    name: "texttospeechTextSynthesize", meth: HttpMethod.HttpPost,
    host: "texttospeech.googleapis.com", route: "/v1/text:synthesize",
    validator: validate_TexttospeechTextSynthesize_578611, base: "/",
    url: url_TexttospeechTextSynthesize_578612, schemes: {Scheme.Https})
type
  Call_TexttospeechVoicesList_578884 = ref object of OpenApiRestCall_578339
proc url_TexttospeechVoicesList_578886(protocol: Scheme; host: string; base: string;
...
proc validate_TexttospeechVoicesList_578885(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_578895 = query.getOrDefault("languageCode")
  valid_578895 = validateParameter(valid_578895, JString, required = false,
                                 default = nil)
  if valid_578895 != nil:
    section.add "languageCode", valid_578895
...
proc call*(call_578899: Call_TexttospeechVoicesList_578884; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns a list of Voice supported for synthesis.
  ## 
...
proc call*(call_578900: Call_TexttospeechVoicesList_578884; key: string = "";
          prettyPrint: bool = true; oauthToken: string = ""; Xgafv: string = "1";
          alt: string = "json"; uploadType: string = ""; quotaUser: string = "";
  ...
  add(query_578901, "languageCode", newJString(languageCode))
  ...
  result = call_578900.call(nil, query_578901, nil, nil, nil)

var texttospeechVoicesList* = Call_TexttospeechVoicesList_578884(
    name: "texttospeechVoicesList", meth: HttpMethod.HttpGet,
    host: "texttospeech.googleapis.com", route: "/v1/voices",
    validator: validate_TexttospeechVoicesList_578885, base: "/",
    url: url_TexttospeechVoicesList_578886, schemes: {Scheme.Https})
export
  rest
