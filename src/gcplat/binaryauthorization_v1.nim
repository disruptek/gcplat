...
var binaryauthorizationProjectsAttestorsUpdate* = Call_BinaryauthorizationProjectsAttestorsUpdate_579923(
    ...
    host: "binaryauthorization.googleapis.com", route: "/v1/{name}",
...
var binaryauthorizationProjectsAttestorsCreate* = Call_BinaryauthorizationProjectsAttestorsCreate_579984(
    ...
    host: "binaryauthorization.googleapis.com", route: "/v1/{parent}/attestors",
...
var binaryauthorizationProjectsAttestorsList* = Call_BinaryauthorizationProjectsAttestorsList_579963(
    ...
    schemes: {Scheme.Https})
type
  Call_BinaryauthorizationProjectsAttestorsGetIamPolicy_580006 = ref object of OpenApiRestCall_579364
proc url_BinaryauthorizationProjectsAttestorsGetIamPolicy_580008(
...
proc validate_BinaryauthorizationProjectsAttestorsGetIamPolicy_580007(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
...
proc call*(call_580022: Call_BinaryauthorizationProjectsAttestorsGetIamPolicy_580006;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets the access control policy for a resource.
  ## Returns an empty policy if the resource exists and does not have a policy
...
proc call*(call_580023: Call_BinaryauthorizationProjectsAttestorsGetIamPolicy_580006;
...
var binaryauthorizationProjectsAttestorsGetIamPolicy* = Call_BinaryauthorizationProjectsAttestorsGetIamPolicy_580006(
    ...
    validator: validate_BinaryauthorizationProjectsAttestorsGetIamPolicy_580007,
    base: "/", url: url_BinaryauthorizationProjectsAttestorsGetIamPolicy_580008,
    schemes: {Scheme.Https})
type
  Call_BinaryauthorizationProjectsAttestorsSetIamPolicy_580026 = ref object of OpenApiRestCall_579364
proc url_BinaryauthorizationProjectsAttestorsSetIamPolicy_580028(
    protocol: Scheme; host: string; base: string; route: string; path: JsonNode;
    query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_BinaryauthorizationProjectsAttestorsSetIamPolicy_580027(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_580042: Call_BinaryauthorizationProjectsAttestorsSetIamPolicy_580026;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Sets the access control policy on the specified resource. Replaces any
  ## existing policy.
...
proc call*(call_580043: Call_BinaryauthorizationProjectsAttestorsSetIamPolicy_580026;
          resource: string; key: string = ""; prettyPrint: bool = true;
          oauthToken: string = ""; Xgafv: string = "1"; alt: string = "json";
          uploadType: string = ""; quotaUser: string = ""; body: JsonNode = nil;
          callback: string = ""; fields: string = ""; accessToken: string = "";
...
var binaryauthorizationProjectsAttestorsSetIamPolicy* = Call_BinaryauthorizationProjectsAttestorsSetIamPolicy_580026(
    ...
    validator: validate_BinaryauthorizationProjectsAttestorsSetIamPolicy_580027,
    base: "/", url: url_BinaryauthorizationProjectsAttestorsSetIamPolicy_580028,
    schemes: {Scheme.Https})
type
  Call_BinaryauthorizationProjectsAttestorsTestIamPermissions_580047 = ref object of OpenApiRestCall_579364
proc url_BinaryauthorizationProjectsAttestorsTestIamPermissions_580049(
    protocol: Scheme; host: string; base: string; route: string; path: JsonNode;
    query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_BinaryauthorizationProjectsAttestorsTestIamPermissions_580048(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_580063: Call_BinaryauthorizationProjectsAttestorsTestIamPermissions_580047;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Returns permissions that a caller has on the specified resource.
  ## If the resource does not exist, this will return an empty set of
...
proc call*(call_580064: Call_BinaryauthorizationProjectsAttestorsTestIamPermissions_580047;
          resource: string; key: string = ""; prettyPrint: bool = true;
          oauthToken: string = ""; Xgafv: string = "1"; alt: string = "json";
          uploadType: string = ""; quotaUser: string = ""; body: JsonNode = nil;
          callback: string = ""; fields: string = ""; accessToken: string = "";
...
var binaryauthorizationProjectsAttestorsTestIamPermissions* = Call_BinaryauthorizationProjectsAttestorsTestIamPermissions_580047(
    name: "binaryauthorizationProjectsAttestorsTestIamPermissions",
    meth: HttpMethod.HttpPost, host: "binaryauthorization.googleapis.com",
    route: "/v1/{resource}:testIamPermissions",
    validator: validate_BinaryauthorizationProjectsAttestorsTestIamPermissions_580048,
    base: "/", url: url_BinaryauthorizationProjectsAttestorsTestIamPermissions_580049,
    schemes: {Scheme.Https})
export
  rest
