...
type
  Call_OsloginUsersSshPublicKeysPatch_579984 = ref object of OpenApiRestCall_579408
proc url_OsloginUsersSshPublicKeysPatch_579986(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_OsloginUsersSshPublicKeysPatch_579985(path: JsonNode;
...
proc call*(call_580001: Call_OsloginUsersSshPublicKeysPatch_579984; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates an SSH public key and returns the profile information. This method
  ## supports patch semantics.
  ## 
...
proc call*(call_580002: Call_OsloginUsersSshPublicKeysPatch_579984; name: string;
          uploadProtocol: string = ""; fields: string = ""; quotaUser: string = "";
          alt: string = "json"; oauthToken: string = ""; callback: string = "";
          accessToken: string = ""; uploadType: string = ""; key: string = "";
...
var osloginUsersSshPublicKeysPatch* = Call_OsloginUsersSshPublicKeysPatch_579984(
    name: "osloginUsersSshPublicKeysPatch", meth: HttpMethod.HttpPatch,
    host: "oslogin.googleapis.com", route: "/v1/{name}",
    validator: validate_OsloginUsersSshPublicKeysPatch_579985, base: "/",
    url: url_OsloginUsersSshPublicKeysPatch_579986, schemes: {Scheme.Https})
type
...
proc call*(call_579980: Call_OsloginUsersProjectsDelete_579965; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a POSIX account.
  ## 
...
proc call*(call_579981: Call_OsloginUsersProjectsDelete_579965; name: string;
          uploadProtocol: string = ""; fields: string = ""; quotaUser: string = "";
          alt: string = "json"; oauthToken: string = ""; callback: string = "";
          accessToken: string = ""; uploadType: string = ""; key: string = "";
          Xgafv: string = "1"; prettyPrint: bool = true): Recallable =
...
type
  Call_OsloginUsersGetLoginProfile_580006 = ref object of OpenApiRestCall_579408
proc url_OsloginUsersGetLoginProfile_580008(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_OsloginUsersGetLoginProfile_580007(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_580020 = query.getOrDefault("projectId")
  ...
  var valid_580022 = query.getOrDefault("systemId")
  valid_580022 = validateParameter(valid_580022, JString, required = false,
                                 default = nil)
  if valid_580022 != nil:
    section.add "systemId", valid_580022
  result.add "query", section
  section = newJObject()
  result.add "header", section
  section = newJObject()
...
proc call*(call_580023: Call_OsloginUsersGetLoginProfile_580006; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Retrieves the profile information used for logging in to a virtual machine
  ## on Google Compute Engine.
  ## 
...
proc call*(call_580024: Call_OsloginUsersGetLoginProfile_580006; name: string;
          uploadProtocol: string = ""; fields: string = ""; quotaUser: string = "";
          alt: string = "json"; oauthToken: string = ""; callback: string = "";
          accessToken: string = ""; uploadType: string = ""; key: string = "";
  ...
  add(query_580026, "systemId", newJString(systemId))
  result = call_580024.call(path_580025, query_580026, nil, nil, nil)

var osloginUsersGetLoginProfile* = Call_OsloginUsersGetLoginProfile_580006(
    name: "osloginUsersGetLoginProfile", meth: HttpMethod.HttpGet,
    host: "oslogin.googleapis.com", route: "/v1/{name}/loginProfile",
    validator: validate_OsloginUsersGetLoginProfile_580007, base: "/",
    url: url_OsloginUsersGetLoginProfile_580008, schemes: {Scheme.Https})
type
  Call_OsloginUsersImportSshPublicKey_580027 = ref object of OpenApiRestCall_579408
proc url_OsloginUsersImportSshPublicKey_580029(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_OsloginUsersImportSshPublicKey_580028(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_580041 = query.getOrDefault("projectId")
...
proc call*(call_580044: Call_OsloginUsersImportSshPublicKey_580027; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Adds an SSH public key and returns the profile information. Default POSIX
  ## account information is set when no username and UID exist as part of the
  ## login profile.
...
proc call*(call_580045: Call_OsloginUsersImportSshPublicKey_580027; parent: string;
          uploadProtocol: string = ""; fields: string = ""; quotaUser: string = "";
          alt: string = "json"; oauthToken: string = ""; callback: string = "";
          accessToken: string = ""; uploadType: string = ""; key: string = "";
  ...
  add(query_580047, "projectId", newJString(projectId))
  if body != nil:
    body_580048 = body
  add(query_580047, "prettyPrint", newJBool(prettyPrint))
  result = call_580045.call(path_580046, query_580047, nil, nil, body_580048)

var osloginUsersImportSshPublicKey* = Call_OsloginUsersImportSshPublicKey_580027(
    ...
    validator: validate_OsloginUsersImportSshPublicKey_580028, base: "/",
    url: url_OsloginUsersImportSshPublicKey_580029, schemes: {Scheme.Https})
export
  rest
