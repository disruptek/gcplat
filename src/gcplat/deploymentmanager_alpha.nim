...
type
  Call_DeploymentmanagerTypesInsert_589578 = ref object of OpenApiRestCall_588466
proc url_DeploymentmanagerTypesInsert_589580(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_DeploymentmanagerTypesInsert_589579(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ## Creates a type.
  ## 
  var section: JsonNode
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `project` field"
  var valid_589581 = path.getOrDefault("project")
  valid_589581 = validateParameter(valid_589581, JString, required = true,
                                 default = nil)
  if valid_589581 != nil:
    section.add "project", valid_589581
  result.add "path", section
  ## parameters in `query` object:
  ##   fields: JString
  ##         : Selector specifying which fields to include in a partial response.
  ...
  ##              : Returns response with indentations and line breaks.
  section = newJObject()
  var valid_589582 = query.getOrDefault("fields")
  valid_589582 = validateParameter(valid_589582, JString, required = false,
                                 default = nil)
  if valid_589582 != nil:
    section.add "fields", valid_589582
  var valid_589583 = query.getOrDefault("quotaUser")
  valid_589583 = validateParameter(valid_589583, JString, required = false,
                                 default = nil)
  if valid_589583 != nil:
    section.add "quotaUser", valid_589583
  var valid_589584 = query.getOrDefault("alt")
  valid_589584 = validateParameter(valid_589584, JString, required = false,
                                 default = newJString("json"))
  if valid_589584 != nil:
    section.add "alt", valid_589584
  var valid_589585 = query.getOrDefault("oauth_token")
  valid_589585 = validateParameter(valid_589585, JString, required = false,
                                 default = nil)
  if valid_589585 != nil:
    section.add "oauth_token", valid_589585
  var valid_589586 = query.getOrDefault("userIp")
  valid_589586 = validateParameter(valid_589586, JString, required = false,
                                 default = nil)
  if valid_589586 != nil:
    section.add "userIp", valid_589586
...
proc call*(call_589590: Call_DeploymentmanagerTypesInsert_589578; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a type.
  ## 
...
proc call*(call_589591: Call_DeploymentmanagerTypesInsert_589578; project: string;
  ...
  add(path_589592, "project", newJString(project))
  if body != nil:
    body_589594 = body
  add(query_589593, "prettyPrint", newJBool(prettyPrint))
  result = call_589591.call(path_589592, query_589593, nil, nil, body_589594)

var deploymentmanagerTypesInsert* = Call_DeploymentmanagerTypesInsert_589578(
    name: "deploymentmanagerTypesInsert", meth: HttpMethod.HttpPost,
    host: "www.googleapis.com", route: "/{project}/global/types",
    validator: validate_DeploymentmanagerTypesInsert_589579,
    base: "/deploymentmanager/alpha/projects",
    url: url_DeploymentmanagerTypesInsert_589580, schemes: {Scheme.Https})
type
...
type
  Call_DeploymentmanagerTypesUpdate_589611 = ref object of OpenApiRestCall_588466
proc url_DeploymentmanagerTypesUpdate_589613(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_DeploymentmanagerTypesUpdate_589612(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ## Updates a type.
  ## 
  var section: JsonNode
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `type` field"
  var valid_589614 = path.getOrDefault("type")
  valid_589614 = validateParameter(valid_589614, JString, required = true,
                                 default = nil)
  if valid_589614 != nil:
    section.add "type", valid_589614
  var valid_589615 = path.getOrDefault("project")
  valid_589615 = validateParameter(valid_589615, JString, required = true,
                                 default = nil)
  if valid_589615 != nil:
    section.add "project", valid_589615
  result.add "path", section
  ## parameters in `query` object:
  ##   fields: JString
  ##         : Selector specifying which fields to include in a partial response.
  ...
  ##              : Returns response with indentations and line breaks.
  section = newJObject()
  var valid_589616 = query.getOrDefault("fields")
  valid_589616 = validateParameter(valid_589616, JString, required = false,
                                 default = nil)
  if valid_589616 != nil:
    section.add "fields", valid_589616
  var valid_589617 = query.getOrDefault("quotaUser")
  valid_589617 = validateParameter(valid_589617, JString, required = false,
                                 default = nil)
  if valid_589617 != nil:
    section.add "quotaUser", valid_589617
  var valid_589618 = query.getOrDefault("alt")
  valid_589618 = validateParameter(valid_589618, JString, required = false,
                                 default = newJString("json"))
  if valid_589618 != nil:
    section.add "alt", valid_589618
  var valid_589619 = query.getOrDefault("oauth_token")
  valid_589619 = validateParameter(valid_589619, JString, required = false,
                                 default = nil)
  if valid_589619 != nil:
    section.add "oauth_token", valid_589619
  var valid_589620 = query.getOrDefault("userIp")
  valid_589620 = validateParameter(valid_589620, JString, required = false,
                                 default = nil)
  if valid_589620 != nil:
    section.add "userIp", valid_589620
  var valid_589621 = query.getOrDefault("key")
  valid_589621 = validateParameter(valid_589621, JString, required = false,
                                 default = nil)
  if valid_589621 != nil:
    section.add "key", valid_589621
...
proc call*(call_589624: Call_DeploymentmanagerTypesUpdate_589611; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates a type.
  ## 
...
proc call*(call_589625: Call_DeploymentmanagerTypesUpdate_589611; `type`: string;
          project: string; fields: string = ""; quotaUser: string = "";
          alt: string = "json"; oauthToken: string = ""; userIp: string = "";
          key: string = ""; body: JsonNode = nil; prettyPrint: bool = true): Recallable =
  ...
  add(path_589626, "type", newJString(`type`))
  ...
  add(query_589627, "userIp", newJString(userIp))
  add(query_589627, "key", newJString(key))
  add(path_589626, "project", newJString(project))
  if body != nil:
    body_589628 = body
  add(query_589627, "prettyPrint", newJBool(prettyPrint))
  result = call_589625.call(path_589626, query_589627, nil, nil, body_589628)

var deploymentmanagerTypesUpdate* = Call_DeploymentmanagerTypesUpdate_589611(
    name: "deploymentmanagerTypesUpdate", meth: HttpMethod.HttpPut,
    host: "www.googleapis.com", route: "/{project}/global/types/{type}",
    validator: validate_DeploymentmanagerTypesUpdate_589612,
    base: "/deploymentmanager/alpha/projects",
    url: url_DeploymentmanagerTypesUpdate_589613, schemes: {Scheme.Https})
type
  Call_DeploymentmanagerTypesGet_589595 = ref object of OpenApiRestCall_588466
proc url_DeploymentmanagerTypesGet_589597(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_DeploymentmanagerTypesGet_589596(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `type` field"
  var valid_589598 = path.getOrDefault("type")
  valid_589598 = validateParameter(valid_589598, JString, required = true,
                                 default = nil)
  if valid_589598 != nil:
    section.add "type", valid_589598
  var valid_589599 = path.getOrDefault("project")
  valid_589599 = validateParameter(valid_589599, JString, required = true,
                                 default = nil)
  if valid_589599 != nil:
    section.add "project", valid_589599
  result.add "path", section
  ## parameters in `query` object:
  ##   fields: JString
  ##         : Selector specifying which fields to include in a partial response.
  ...
  var valid_589604 = query.getOrDefault("userIp")
  valid_589604 = validateParameter(valid_589604, JString, required = false,
                                 default = nil)
  if valid_589604 != nil:
    section.add "userIp", valid_589604
  var valid_589605 = query.getOrDefault("key")
  valid_589605 = validateParameter(valid_589605, JString, required = false,
                                 default = nil)
  if valid_589605 != nil:
    section.add "key", valid_589605
  var valid_589606 = query.getOrDefault("prettyPrint")
  valid_589606 = validateParameter(valid_589606, JBool, required = false,
                                 default = newJBool(true))
  if valid_589606 != nil:
    section.add "prettyPrint", valid_589606
  result.add "query", section
  section = newJObject()
  result.add "header", section
  section = newJObject()
...
proc call*(call_589607: Call_DeploymentmanagerTypesGet_589595; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets information about a specific type.
  ## 
  let valid = call_589607.validator(path, query, header, formData, body)
  let scheme = call_589607.pickScheme
  if scheme.isNone:
    raise newException(IOError, "unable to find a supported scheme")
  let url = call_589607.url(scheme.get, call_589607.host, call_589607.base,
                         call_589607.route, valid.getOrDefault("path"),
                         valid.getOrDefault("query"))
  result = hook(call_589607, url, valid)

proc call*(call_589608: Call_DeploymentmanagerTypesGet_589595; `type`: string;
          project: string; fields: string = ""; quotaUser: string = "";
          alt: string = "json"; oauthToken: string = ""; userIp: string = "";
  ...
  ##   prettyPrint: bool
  ##              : Returns response with indentations and line breaks.
  var path_589609 = newJObject()
  var query_589610 = newJObject()
  add(path_589609, "type", newJString(`type`))
  add(query_589610, "fields", newJString(fields))
  add(query_589610, "quotaUser", newJString(quotaUser))
  add(query_589610, "alt", newJString(alt))
  add(query_589610, "oauth_token", newJString(oauthToken))
  add(query_589610, "userIp", newJString(userIp))
  add(query_589610, "key", newJString(key))
  add(path_589609, "project", newJString(project))
  add(query_589610, "prettyPrint", newJBool(prettyPrint))
  result = call_589608.call(path_589609, query_589610, nil, nil, nil)

var deploymentmanagerTypesGet* = Call_DeploymentmanagerTypesGet_589595(
    name: "deploymentmanagerTypesGet", meth: HttpMethod.HttpGet,
    host: "www.googleapis.com", route: "/{project}/global/types/{type}",
    validator: validate_DeploymentmanagerTypesGet_589596,
    base: "/deploymentmanager/alpha/projects", url: url_DeploymentmanagerTypesGet_589597,
    schemes: {Scheme.Https})
type
  Call_DeploymentmanagerTypesPatch_589645 = ref object of OpenApiRestCall_588466
proc url_DeploymentmanagerTypesPatch_589647(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_DeploymentmanagerTypesPatch_589646(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `type` field"
  var valid_589648 = path.getOrDefault("type")
  valid_589648 = validateParameter(valid_589648, JString, required = true,
                                 default = nil)
  if valid_589648 != nil:
    section.add "type", valid_589648
  var valid_589649 = path.getOrDefault("project")
  valid_589649 = validateParameter(valid_589649, JString, required = true,
                                 default = nil)
  if valid_589649 != nil:
    section.add "project", valid_589649
  result.add "path", section
  ## parameters in `query` object:
  ##   fields: JString
  ##         : Selector specifying which fields to include in a partial response.
...
proc call*(call_589658: Call_DeploymentmanagerTypesPatch_589645; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates a type. This method supports patch semantics.
  ## 
  let valid = call_589658.validator(path, query, header, formData, body)
  let scheme = call_589658.pickScheme
  if scheme.isNone:
    raise newException(IOError, "unable to find a supported scheme")
  let url = call_589658.url(scheme.get, call_589658.host, call_589658.base,
                         call_589658.route, valid.getOrDefault("path"),
                         valid.getOrDefault("query"))
  result = hook(call_589658, url, valid)

proc call*(call_589659: Call_DeploymentmanagerTypesPatch_589645; `type`: string;
          project: string; fields: string = ""; quotaUser: string = "";
          alt: string = "json"; oauthToken: string = ""; userIp: string = "";
          key: string = ""; body: JsonNode = nil; prettyPrint: bool = true): Recallable =
  ...
  ##   prettyPrint: bool
  ##              : Returns response with indentations and line breaks.
  var path_589660 = newJObject()
  var query_589661 = newJObject()
  var body_589662 = newJObject()
  add(path_589660, "type", newJString(`type`))
  add(query_589661, "fields", newJString(fields))
  add(query_589661, "quotaUser", newJString(quotaUser))
  add(query_589661, "alt", newJString(alt))
  add(query_589661, "oauth_token", newJString(oauthToken))
  add(query_589661, "userIp", newJString(userIp))
  add(query_589661, "key", newJString(key))
  add(path_589660, "project", newJString(project))
  if body != nil:
    body_589662 = body
  add(query_589661, "prettyPrint", newJBool(prettyPrint))
  result = call_589659.call(path_589660, query_589661, nil, nil, body_589662)

var deploymentmanagerTypesPatch* = Call_DeploymentmanagerTypesPatch_589645(
    name: "deploymentmanagerTypesPatch", meth: HttpMethod.HttpPatch,
    host: "www.googleapis.com", route: "/{project}/global/types/{type}",
    validator: validate_DeploymentmanagerTypesPatch_589646,
    base: "/deploymentmanager/alpha/projects",
    url: url_DeploymentmanagerTypesPatch_589647, schemes: {Scheme.Https})
type
  Call_DeploymentmanagerTypesDelete_589629 = ref object of OpenApiRestCall_588466
proc url_DeploymentmanagerTypesDelete_589631(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_DeploymentmanagerTypesDelete_589630(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `type` field"
  var valid_589632 = path.getOrDefault("type")
  valid_589632 = validateParameter(valid_589632, JString, required = true,
                                 default = nil)
  if valid_589632 != nil:
    section.add "type", valid_589632
  var valid_589633 = path.getOrDefault("project")
  valid_589633 = validateParameter(valid_589633, JString, required = true,
                                 default = nil)
  if valid_589633 != nil:
    section.add "project", valid_589633
  result.add "path", section
  ## parameters in `query` object:
  ##   fields: JString
  ##         : Selector specifying which fields to include in a partial response.
  ...
  var valid_589635 = query.getOrDefault("quotaUser")
  valid_589635 = validateParameter(valid_589635, JString, required = false,
                                 default = nil)
  if valid_589635 != nil:
    section.add "quotaUser", valid_589635
  var valid_589636 = query.getOrDefault("alt")
  valid_589636 = validateParameter(valid_589636, JString, required = false,
                                 default = newJString("json"))
  if valid_589636 != nil:
    section.add "alt", valid_589636
  var valid_589637 = query.getOrDefault("oauth_token")
  valid_589637 = validateParameter(valid_589637, JString, required = false,
                                 default = nil)
  if valid_589637 != nil:
    section.add "oauth_token", valid_589637
  var valid_589638 = query.getOrDefault("userIp")
  valid_589638 = validateParameter(valid_589638, JString, required = false,
                                 default = nil)
  if valid_589638 != nil:
    section.add "userIp", valid_589638
...
proc call*(call_589641: Call_DeploymentmanagerTypesDelete_589629; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a type and all of the resources in the type.
  ## 
...
proc call*(call_589642: Call_DeploymentmanagerTypesDelete_589629; `type`: string;
          project: string; fields: string = ""; quotaUser: string = "";
          alt: string = "json"; oauthToken: string = ""; userIp: string = "";
          key: string = ""; prettyPrint: bool = true): Recallable =
  ...
  add(path_589643, "type", newJString(`type`))
  ...
  add(path_589643, "project", newJString(project))
  add(query_589644, "prettyPrint", newJBool(prettyPrint))
  result = call_589642.call(path_589643, query_589644, nil, nil, nil)

var deploymentmanagerTypesDelete* = Call_DeploymentmanagerTypesDelete_589629(
    name: "deploymentmanagerTypesDelete", meth: HttpMethod.HttpDelete,
    host: "www.googleapis.com", route: "/{project}/global/types/{type}",
    validator: validate_DeploymentmanagerTypesDelete_589630,
    base: "/deploymentmanager/alpha/projects",
    url: url_DeploymentmanagerTypesDelete_589631, schemes: {Scheme.Https})
export
  rest
