...
type
  Call_ComposerProjectsLocationsEnvironmentsGet_578610 = ref object of OpenApiRestCall_578339
proc url_ComposerProjectsLocationsEnvironmentsGet_578612(protocol: Scheme;
...
proc validate_ComposerProjectsLocationsEnvironmentsGet_578611(path: JsonNode;
...
proc call*(call_578785: Call_ComposerProjectsLocationsEnvironmentsGet_578610;
...
proc call*(call_578856: Call_ComposerProjectsLocationsEnvironmentsGet_578610;
...
var composerProjectsLocationsEnvironmentsGet* = Call_ComposerProjectsLocationsEnvironmentsGet_578610(
    name: "composerProjectsLocationsEnvironmentsGet", meth: HttpMethod.HttpGet,
    host: "composer.googleapis.com", route: "/v1beta1/{name}",
    validator: validate_ComposerProjectsLocationsEnvironmentsGet_578611,
    base: "/", url: url_ComposerProjectsLocationsEnvironmentsGet_578612,
...
var composerProjectsLocationsEnvironmentsPatch* = Call_ComposerProjectsLocationsEnvironmentsPatch_578917(
    ...
    schemes: {Scheme.Https})
type
  Call_ComposerProjectsLocationsEnvironmentsDelete_578898 = ref object of OpenApiRestCall_578339
proc url_ComposerProjectsLocationsEnvironmentsDelete_578900(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_ComposerProjectsLocationsEnvironmentsDelete_578899(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_578913: Call_ComposerProjectsLocationsEnvironmentsDelete_578898;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Delete an environment.
  ## 
...
proc call*(call_578914: Call_ComposerProjectsLocationsEnvironmentsDelete_578898;
          name: string; key: string = ""; prettyPrint: bool = true;
          oauthToken: string = ""; Xgafv: string = "1"; alt: string = "json";
          uploadType: string = ""; quotaUser: string = ""; callback: string = "";
          fields: string = ""; accessToken: string = ""; uploadProtocol: string = ""): Recallable =
...
var composerProjectsLocationsEnvironmentsDelete* = Call_ComposerProjectsLocationsEnvironmentsDelete_578898(
    name: "composerProjectsLocationsEnvironmentsDelete",
    meth: HttpMethod.HttpDelete, host: "composer.googleapis.com",
    route: "/v1beta1/{name}",
    validator: validate_ComposerProjectsLocationsEnvironmentsDelete_578899,
    base: "/", url: url_ComposerProjectsLocationsEnvironmentsDelete_578900,
    schemes: {Scheme.Https})
type
