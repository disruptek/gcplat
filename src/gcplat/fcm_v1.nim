...
type
  Call_FcmProjectsMessagesSend_593677 = ref object of OpenApiRestCall_593408
proc url_FcmProjectsMessagesSend_593679(protocol: Scheme; host: string; base: string;
...
proc validate_FcmProjectsMessagesSend_593678(path: JsonNode; query: JsonNode;
...
proc call*(call_593853: Call_FcmProjectsMessagesSend_593677; path: JsonNode;
...
proc call*(call_593924: Call_FcmProjectsMessagesSend_593677; parent: string;
  ...
  add(path_593925, "parent", newJString(parent))
...
var fcmProjectsMessagesSend* = Call_FcmProjectsMessagesSend_593677(
    name: "fcmProjectsMessagesSend", meth: HttpMethod.HttpPost,
    host: "fcm.googleapis.com", route: "/v1/{parent}/messages:send",
    validator: validate_FcmProjectsMessagesSend_593678, base: "/",
    url: url_FcmProjectsMessagesSend_593679, schemes: {Scheme.Https})
export
  rest
