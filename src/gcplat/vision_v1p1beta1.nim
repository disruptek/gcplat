...
type
  Call_VisionProjectsImagesAnnotate_594077 = ref object of OpenApiRestCall_593421
proc url_VisionProjectsImagesAnnotate_594079(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VisionProjectsImagesAnnotate_594078(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ## Run image detection and annotation for a batch of images.
  ## 
  var section: JsonNode
...
proc call*(call_594093: Call_VisionProjectsImagesAnnotate_594077; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Run image detection and annotation for a batch of images.
  ## 
...
proc call*(call_594094: Call_VisionProjectsImagesAnnotate_594077; parent: string;
          uploadProtocol: string = ""; fields: string = ""; quotaUser: string = "";
          alt: string = "json"; oauthToken: string = ""; callback: string = "";
          accessToken: string = ""; uploadType: string = ""; key: string = "";
          Xgafv: string = "1"; body: JsonNode = nil; prettyPrint: bool = true): Recallable =
...
var visionProjectsImagesAnnotate* = Call_VisionProjectsImagesAnnotate_594077(
    ...
    validator: validate_VisionProjectsImagesAnnotate_594078, base: "/",
    url: url_VisionProjectsImagesAnnotate_594079, schemes: {Scheme.Https})
type
  Call_VisionProjectsImagesAsyncBatchAnnotate_594098 = ref object of OpenApiRestCall_593421
proc url_VisionProjectsImagesAsyncBatchAnnotate_594100(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VisionProjectsImagesAsyncBatchAnnotate_594099(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ## Run asynchronous image detection and annotation for a list of images.
  ## 
  ## Progress and results can be retrieved through the
...
proc call*(call_594114: Call_VisionProjectsImagesAsyncBatchAnnotate_594098;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Run asynchronous image detection and annotation for a list of images.
  ## 
...
proc call*(call_594115: Call_VisionProjectsImagesAsyncBatchAnnotate_594098;
          parent: string; uploadProtocol: string = ""; fields: string = "";
          quotaUser: string = ""; alt: string = "json"; oauthToken: string = "";
          callback: string = ""; accessToken: string = ""; uploadType: string = "";
          key: string = ""; Xgafv: string = "1"; body: JsonNode = nil;
...
var visionProjectsImagesAsyncBatchAnnotate* = Call_VisionProjectsImagesAsyncBatchAnnotate_594098(
    name: "visionProjectsImagesAsyncBatchAnnotate", meth: HttpMethod.HttpPost,
    host: "vision.googleapis.com",
    route: "/v1p1beta1/{parent}/images:asyncBatchAnnotate",
    validator: validate_VisionProjectsImagesAsyncBatchAnnotate_594099, base: "/",
    url: url_VisionProjectsImagesAsyncBatchAnnotate_594100,
