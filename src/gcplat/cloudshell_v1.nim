...
type
  Call_CloudshellOperationsGet_579677 = ref object of OpenApiRestCall_579408
proc url_CloudshellOperationsGet_579679(protocol: Scheme; host: string; base: string;
...
proc validate_CloudshellOperationsGet_579678(path: JsonNode; query: JsonNode;
...
proc call*(call_579852: Call_CloudshellOperationsGet_579677; path: JsonNode;
...
proc call*(call_579923: Call_CloudshellOperationsGet_579677; name: string;
...
var cloudshellOperationsGet* = Call_CloudshellOperationsGet_579677(
    name: "cloudshellOperationsGet", meth: HttpMethod.HttpGet,
    host: "cloudshell.googleapis.com", route: "/v1/{name}",
    validator: validate_CloudshellOperationsGet_579678, base: "/",
    url: url_CloudshellOperationsGet_579679, schemes: {Scheme.Https})
type
  Call_CloudshellOperationsDelete_579965 = ref object of OpenApiRestCall_579408
proc url_CloudshellOperationsDelete_579967(protocol: Scheme; host: string;
...
proc validate_CloudshellOperationsDelete_579966(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_579980: Call_CloudshellOperationsDelete_579965; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a long-running operation. This method indicates that the client is
  ## no longer interested in the operation result. It does not cancel the
  ## operation. If the server doesn't support this method, it returns
...
proc call*(call_579981: Call_CloudshellOperationsDelete_579965; name: string;
          uploadProtocol: string = ""; fields: string = ""; quotaUser: string = "";
          alt: string = "json"; oauthToken: string = ""; callback: string = "";
          accessToken: string = ""; uploadType: string = ""; key: string = "";
          Xgafv: string = "1"; prettyPrint: bool = true): Recallable =
...
var cloudshellOperationsDelete* = Call_CloudshellOperationsDelete_579965(
    name: "cloudshellOperationsDelete", meth: HttpMethod.HttpDelete,
    host: "cloudshell.googleapis.com", route: "/v1/{name}",
    validator: validate_CloudshellOperationsDelete_579966, base: "/",
    url: url_CloudshellOperationsDelete_579967, schemes: {Scheme.Https})
type
  Call_CloudshellOperationsCancel_579984 = ref object of OpenApiRestCall_579408
proc url_CloudshellOperationsCancel_579986(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_CloudshellOperationsCancel_579985(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_580000: Call_CloudshellOperationsCancel_579984; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Starts asynchronous cancellation on a long-running operation.  The server
  ## makes a best effort to cancel the operation, but success is not
  ## guaranteed.  If the server doesn't support this method, it returns
...
proc call*(call_580001: Call_CloudshellOperationsCancel_579984; name: string;
          uploadProtocol: string = ""; fields: string = ""; quotaUser: string = "";
          alt: string = "json"; oauthToken: string = ""; callback: string = "";
          accessToken: string = ""; uploadType: string = ""; key: string = "";
...
var cloudshellOperationsCancel* = Call_CloudshellOperationsCancel_579984(
    name: "cloudshellOperationsCancel", meth: HttpMethod.HttpPost,
    host: "cloudshell.googleapis.com", route: "/v1/{name}:cancel",
    validator: validate_CloudshellOperationsCancel_579985, base: "/",
    url: url_CloudshellOperationsCancel_579986, schemes: {Scheme.Https})
export
  rest
