...
type
  Call_CloudshellOperationsGet_588710 = ref object of OpenApiRestCall_588441
proc url_CloudshellOperationsGet_588712(protocol: Scheme; host: string; base: string;
...
proc validate_CloudshellOperationsGet_588711(path: JsonNode; query: JsonNode;
...
proc call*(call_588885: Call_CloudshellOperationsGet_588710; path: JsonNode;
...
proc call*(call_588956: Call_CloudshellOperationsGet_588710; name: string;
...
var cloudshellOperationsGet* = Call_CloudshellOperationsGet_588710(
    name: "cloudshellOperationsGet", meth: HttpMethod.HttpGet,
    host: "cloudshell.googleapis.com", route: "/v1/{name}",
    validator: validate_CloudshellOperationsGet_588711, base: "/",
    url: url_CloudshellOperationsGet_588712, schemes: {Scheme.Https})
type
  Call_CloudshellOperationsDelete_588998 = ref object of OpenApiRestCall_588441
proc url_CloudshellOperationsDelete_589000(protocol: Scheme; host: string;
...
proc validate_CloudshellOperationsDelete_588999(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_589013: Call_CloudshellOperationsDelete_588998; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a long-running operation. This method indicates that the client is
  ## no longer interested in the operation result. It does not cancel the
  ## operation. If the server doesn't support this method, it returns
...
proc call*(call_589014: Call_CloudshellOperationsDelete_588998; name: string;
          uploadProtocol: string = ""; fields: string = ""; quotaUser: string = "";
          alt: string = "json"; oauthToken: string = ""; callback: string = "";
          accessToken: string = ""; uploadType: string = ""; key: string = "";
          Xgafv: string = "1"; prettyPrint: bool = true): Recallable =
...
var cloudshellOperationsDelete* = Call_CloudshellOperationsDelete_588998(
    name: "cloudshellOperationsDelete", meth: HttpMethod.HttpDelete,
    host: "cloudshell.googleapis.com", route: "/v1/{name}",
    validator: validate_CloudshellOperationsDelete_588999, base: "/",
    url: url_CloudshellOperationsDelete_589000, schemes: {Scheme.Https})
type
  Call_CloudshellOperationsCancel_589017 = ref object of OpenApiRestCall_588441
proc url_CloudshellOperationsCancel_589019(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_CloudshellOperationsCancel_589018(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_589033: Call_CloudshellOperationsCancel_589017; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Starts asynchronous cancellation on a long-running operation.  The server
  ## makes a best effort to cancel the operation, but success is not
  ## guaranteed.  If the server doesn't support this method, it returns
...
proc call*(call_589034: Call_CloudshellOperationsCancel_589017; name: string;
          uploadProtocol: string = ""; fields: string = ""; quotaUser: string = "";
          alt: string = "json"; oauthToken: string = ""; callback: string = "";
          accessToken: string = ""; uploadType: string = ""; key: string = "";
...
var cloudshellOperationsCancel* = Call_CloudshellOperationsCancel_589017(
    name: "cloudshellOperationsCancel", meth: HttpMethod.HttpPost,
    host: "cloudshell.googleapis.com", route: "/v1/{name}:cancel",
    validator: validate_CloudshellOperationsCancel_589018, base: "/",
    url: url_CloudshellOperationsCancel_589019, schemes: {Scheme.Https})
export
  rest
