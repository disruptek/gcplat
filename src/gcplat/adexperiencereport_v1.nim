...
type
  Call_AdexperiencereportViolatingSitesList_579677 = ref object of OpenApiRestCall_579408
proc url_AdexperiencereportViolatingSitesList_579679(protocol: Scheme;
...
proc validate_AdexperiencereportViolatingSitesList_579678(path: JsonNode;
...
proc call*(call_579837: Call_AdexperiencereportViolatingSitesList_579677;
...
proc call*(call_579908: Call_AdexperiencereportViolatingSitesList_579677;
...
var adexperiencereportViolatingSitesList* = Call_AdexperiencereportViolatingSitesList_579677(
    ...
    validator: validate_AdexperiencereportViolatingSitesList_579678, base: "/",
    url: url_AdexperiencereportViolatingSitesList_579679, schemes: {Scheme.Https})
type
  Call_AdexperiencereportSitesGet_579949 = ref object of OpenApiRestCall_579408
proc url_AdexperiencereportSitesGet_579951(protocol: Scheme; host: string;
...
proc validate_AdexperiencereportSitesGet_579950(path: JsonNode; query: JsonNode;
...
proc call*(call_579978: Call_AdexperiencereportSitesGet_579949; path: JsonNode;
...
proc call*(call_579979: Call_AdexperiencereportSitesGet_579949; name: string;
          uploadProtocol: string = ""; fields: string = ""; quotaUser: string = "";
          alt: string = "json"; oauthToken: string = ""; callback: string = "";
          accessToken: string = ""; uploadType: string = ""; key: string = "";
          Xgafv: string = "1"; prettyPrint: bool = true): Recallable =
...
var adexperiencereportSitesGet* = Call_AdexperiencereportSitesGet_579949(
    name: "adexperiencereportSitesGet", meth: HttpMethod.HttpGet,
    host: "adexperiencereport.googleapis.com", route: "/v1/{name}",
    validator: validate_AdexperiencereportSitesGet_579950, base: "/",
    url: url_AdexperiencereportSitesGet_579951, schemes: {Scheme.Https})
export
  rest
