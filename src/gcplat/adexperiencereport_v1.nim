...
type
  Call_AdexperiencereportViolatingSitesList_597677 = ref object of OpenApiRestCall_597408
proc url_AdexperiencereportViolatingSitesList_597679(protocol: Scheme;
...
proc validate_AdexperiencereportViolatingSitesList_597678(path: JsonNode;
...
proc call*(call_597837: Call_AdexperiencereportViolatingSitesList_597677;
...
proc call*(call_597908: Call_AdexperiencereportViolatingSitesList_597677;
...
var adexperiencereportViolatingSitesList* = Call_AdexperiencereportViolatingSitesList_597677(
    ...
    validator: validate_AdexperiencereportViolatingSitesList_597678, base: "/",
    url: url_AdexperiencereportViolatingSitesList_597679, schemes: {Scheme.Https})
type
  Call_AdexperiencereportSitesGet_597949 = ref object of OpenApiRestCall_597408
proc url_AdexperiencereportSitesGet_597951(protocol: Scheme; host: string;
...
proc validate_AdexperiencereportSitesGet_597950(path: JsonNode; query: JsonNode;
...
proc call*(call_597978: Call_AdexperiencereportSitesGet_597949; path: JsonNode;
...
proc call*(call_597979: Call_AdexperiencereportSitesGet_597949; name: string;
          uploadProtocol: string = ""; fields: string = ""; quotaUser: string = "";
          alt: string = "json"; oauthToken: string = ""; callback: string = "";
          accessToken: string = ""; uploadType: string = ""; key: string = "";
          Xgafv: string = "1"; prettyPrint: bool = true): Recallable =
...
var adexperiencereportSitesGet* = Call_AdexperiencereportSitesGet_597949(
    name: "adexperiencereportSitesGet", meth: HttpMethod.HttpGet,
    host: "adexperiencereport.googleapis.com", route: "/v1/{name}",
    validator: validate_AdexperiencereportSitesGet_597950, base: "/",
    url: url_AdexperiencereportSitesGet_597951, schemes: {Scheme.Https})
export
  rest
