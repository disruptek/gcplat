...
var predictionHostedmodelsPredict* = Call_PredictionHostedmodelsPredict_593677(
    ...
    base: "/prediction/v1.4", url: url_PredictionHostedmodelsPredict_593679,
    schemes: {Scheme.Https})
type
  Call_PredictionTrainedmodelsInsert_593963 = ref object of OpenApiRestCall_593408
proc url_PredictionTrainedmodelsInsert_593965(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PredictionTrainedmodelsInsert_593964(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_593974: Call_PredictionTrainedmodelsInsert_593963; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Begin training your model.
  ## 
...
proc call*(call_593975: Call_PredictionTrainedmodelsInsert_593963;
...
var predictionTrainedmodelsInsert* = Call_PredictionTrainedmodelsInsert_593963(
    name: "predictionTrainedmodelsInsert", meth: HttpMethod.HttpPost,
    host: "www.googleapis.com", route: "/trainedmodels",
    validator: validate_PredictionTrainedmodelsInsert_593964,
    base: "/prediction/v1.4", url: url_PredictionTrainedmodelsInsert_593965,
    schemes: {Scheme.Https})
type
  Call_PredictionTrainedmodelsUpdate_593993 = ref object of OpenApiRestCall_593408
proc url_PredictionTrainedmodelsUpdate_593995(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PredictionTrainedmodelsUpdate_593994(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_593996 = path.getOrDefault("id")
  valid_593996 = validateParameter(valid_593996, JString, required = true,
                                 default = nil)
  if valid_593996 != nil:
    section.add "id", valid_593996
  result.add "path", section
  ## parameters in `query` object:
  ##   fields: JString
  ##         : Selector specifying which fields to include in a partial response.
...
proc call*(call_594005: Call_PredictionTrainedmodelsUpdate_593993; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Add new data to a trained model.
  ## 
...
proc call*(call_594006: Call_PredictionTrainedmodelsUpdate_593993; id: string;
          fields: string = ""; quotaUser: string = ""; alt: string = "json";
          oauthToken: string = ""; userIp: string = ""; key: string = "";
          body: JsonNode = nil; prettyPrint: bool = true): Recallable =
  ...
  add(path_594007, "id", newJString(id))
...
var predictionTrainedmodelsUpdate* = Call_PredictionTrainedmodelsUpdate_593993(
    name: "predictionTrainedmodelsUpdate", meth: HttpMethod.HttpPut,
    host: "www.googleapis.com", route: "/trainedmodels/{id}",
    validator: validate_PredictionTrainedmodelsUpdate_593994,
    base: "/prediction/v1.4", url: url_PredictionTrainedmodelsUpdate_593995,
    schemes: {Scheme.Https})
type
  Call_PredictionTrainedmodelsGet_593978 = ref object of OpenApiRestCall_593408
proc url_PredictionTrainedmodelsGet_593980(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PredictionTrainedmodelsGet_593979(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `id` field"
  var valid_593981 = path.getOrDefault("id")
  valid_593981 = validateParameter(valid_593981, JString, required = true,
                                 default = nil)
  if valid_593981 != nil:
    section.add "id", valid_593981
  result.add "path", section
  ## parameters in `query` object:
  ##   fields: JString
  ##         : Selector specifying which fields to include in a partial response.
...
proc call*(call_593989: Call_PredictionTrainedmodelsGet_593978; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Check training status of your model.
  ## 
...
proc call*(call_593990: Call_PredictionTrainedmodelsGet_593978; id: string;
          fields: string = ""; quotaUser: string = ""; alt: string = "json";
          oauthToken: string = ""; userIp: string = ""; key: string = "";
  ...
  add(path_593991, "id", newJString(id))
...
var predictionTrainedmodelsGet* = Call_PredictionTrainedmodelsGet_593978(
    name: "predictionTrainedmodelsGet", meth: HttpMethod.HttpGet,
    host: "www.googleapis.com", route: "/trainedmodels/{id}",
    validator: validate_PredictionTrainedmodelsGet_593979,
    base: "/prediction/v1.4", url: url_PredictionTrainedmodelsGet_593980,
    schemes: {Scheme.Https})
type
  Call_PredictionTrainedmodelsDelete_594010 = ref object of OpenApiRestCall_593408
proc url_PredictionTrainedmodelsDelete_594012(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PredictionTrainedmodelsDelete_594011(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `id` field"
  var valid_594013 = path.getOrDefault("id")
  valid_594013 = validateParameter(valid_594013, JString, required = true,
                                 default = nil)
  if valid_594013 != nil:
    section.add "id", valid_594013
  result.add "path", section
  ## parameters in `query` object:
  ##   fields: JString
  ##         : Selector specifying which fields to include in a partial response.
...
proc call*(call_594021: Call_PredictionTrainedmodelsDelete_594010; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Delete a trained model.
  ## 
...
proc call*(call_594022: Call_PredictionTrainedmodelsDelete_594010; id: string;
          fields: string = ""; quotaUser: string = ""; alt: string = "json";
          oauthToken: string = ""; userIp: string = ""; key: string = "";
          prettyPrint: bool = true): Recallable =
  ...
  add(path_594023, "id", newJString(id))
...
var predictionTrainedmodelsDelete* = Call_PredictionTrainedmodelsDelete_594010(
    name: "predictionTrainedmodelsDelete", meth: HttpMethod.HttpDelete,
    host: "www.googleapis.com", route: "/trainedmodels/{id}",
    validator: validate_PredictionTrainedmodelsDelete_594011,
    base: "/prediction/v1.4", url: url_PredictionTrainedmodelsDelete_594012,
    schemes: {Scheme.Https})
type
  Call_PredictionTrainedmodelsPredict_594025 = ref object of OpenApiRestCall_593408
proc url_PredictionTrainedmodelsPredict_594027(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PredictionTrainedmodelsPredict_594026(path: JsonNode;
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `id` field"
  var valid_594028 = path.getOrDefault("id")
  valid_594028 = validateParameter(valid_594028, JString, required = true,
                                 default = nil)
  if valid_594028 != nil:
    section.add "id", valid_594028
  result.add "path", section
  ## parameters in `query` object:
  ##   fields: JString
  ##         : Selector specifying which fields to include in a partial response.
...
proc call*(call_594037: Call_PredictionTrainedmodelsPredict_594025; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Submit model id and request a prediction
  ## 
...
proc call*(call_594038: Call_PredictionTrainedmodelsPredict_594025; id: string;
          fields: string = ""; quotaUser: string = ""; alt: string = "json";
          oauthToken: string = ""; userIp: string = ""; key: string = "";
          body: JsonNode = nil; prettyPrint: bool = true): Recallable =
  ...
  add(path_594039, "id", newJString(id))
...
var predictionTrainedmodelsPredict* = Call_PredictionTrainedmodelsPredict_594025(
    name: "predictionTrainedmodelsPredict", meth: HttpMethod.HttpPost,
    host: "www.googleapis.com", route: "/trainedmodels/{id}/predict",
    validator: validate_PredictionTrainedmodelsPredict_594026,
    base: "/prediction/v1.4", url: url_PredictionTrainedmodelsPredict_594027,
    schemes: {Scheme.Https})
export
  rest
