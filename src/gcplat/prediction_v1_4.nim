...
var predictionHostedmodelsPredict* = Call_PredictionHostedmodelsPredict_579677(
    ...
    base: "/prediction/v1.4", url: url_PredictionHostedmodelsPredict_579679,
    schemes: {Scheme.Https})
type
  Call_PredictionTrainedmodelsInsert_579963 = ref object of OpenApiRestCall_579408
proc url_PredictionTrainedmodelsInsert_579965(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_PredictionTrainedmodelsInsert_579964(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_579974: Call_PredictionTrainedmodelsInsert_579963; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Begin training your model.
  ## 
...
proc call*(call_579975: Call_PredictionTrainedmodelsInsert_579963;
...
var predictionTrainedmodelsInsert* = Call_PredictionTrainedmodelsInsert_579963(
    name: "predictionTrainedmodelsInsert", meth: HttpMethod.HttpPost,
    host: "www.googleapis.com", route: "/trainedmodels",
    validator: validate_PredictionTrainedmodelsInsert_579964,
    base: "/prediction/v1.4", url: url_PredictionTrainedmodelsInsert_579965,
    schemes: {Scheme.Https})
type
  Call_PredictionTrainedmodelsUpdate_579993 = ref object of OpenApiRestCall_579408
proc url_PredictionTrainedmodelsUpdate_579995(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_PredictionTrainedmodelsUpdate_579994(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_580005: Call_PredictionTrainedmodelsUpdate_579993; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Add new data to a trained model.
  ## 
...
proc call*(call_580006: Call_PredictionTrainedmodelsUpdate_579993; id: string;
          fields: string = ""; quotaUser: string = ""; alt: string = "json";
          oauthToken: string = ""; userIp: string = ""; key: string = "";
          body: JsonNode = nil; prettyPrint: bool = true): Recallable =
...
var predictionTrainedmodelsUpdate* = Call_PredictionTrainedmodelsUpdate_579993(
    name: "predictionTrainedmodelsUpdate", meth: HttpMethod.HttpPut,
    host: "www.googleapis.com", route: "/trainedmodels/{id}",
    validator: validate_PredictionTrainedmodelsUpdate_579994,
    base: "/prediction/v1.4", url: url_PredictionTrainedmodelsUpdate_579995,
    schemes: {Scheme.Https})
type
  Call_PredictionTrainedmodelsGet_579978 = ref object of OpenApiRestCall_579408
proc url_PredictionTrainedmodelsGet_579980(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_PredictionTrainedmodelsGet_579979(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_579989: Call_PredictionTrainedmodelsGet_579978; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Check training status of your model.
  ## 
...
proc call*(call_579990: Call_PredictionTrainedmodelsGet_579978; id: string;
          fields: string = ""; quotaUser: string = ""; alt: string = "json";
          oauthToken: string = ""; userIp: string = ""; key: string = "";
  ...
  add(path_579991, "id", newJString(id))
...
var predictionTrainedmodelsGet* = Call_PredictionTrainedmodelsGet_579978(
    name: "predictionTrainedmodelsGet", meth: HttpMethod.HttpGet,
    host: "www.googleapis.com", route: "/trainedmodels/{id}",
    validator: validate_PredictionTrainedmodelsGet_579979,
    base: "/prediction/v1.4", url: url_PredictionTrainedmodelsGet_579980,
    schemes: {Scheme.Https})
type
  Call_PredictionTrainedmodelsDelete_580010 = ref object of OpenApiRestCall_579408
proc url_PredictionTrainedmodelsDelete_580012(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_PredictionTrainedmodelsDelete_580011(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_580021: Call_PredictionTrainedmodelsDelete_580010; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Delete a trained model.
  ## 
...
proc call*(call_580022: Call_PredictionTrainedmodelsDelete_580010; id: string;
          fields: string = ""; quotaUser: string = ""; alt: string = "json";
          oauthToken: string = ""; userIp: string = ""; key: string = "";
          prettyPrint: bool = true): Recallable =
  ...
  add(path_580023, "id", newJString(id))
...
var predictionTrainedmodelsDelete* = Call_PredictionTrainedmodelsDelete_580010(
    name: "predictionTrainedmodelsDelete", meth: HttpMethod.HttpDelete,
    host: "www.googleapis.com", route: "/trainedmodels/{id}",
    validator: validate_PredictionTrainedmodelsDelete_580011,
    base: "/prediction/v1.4", url: url_PredictionTrainedmodelsDelete_580012,
    schemes: {Scheme.Https})
type
  Call_PredictionTrainedmodelsPredict_580025 = ref object of OpenApiRestCall_579408
proc url_PredictionTrainedmodelsPredict_580027(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_PredictionTrainedmodelsPredict_580026(path: JsonNode;
...
proc call*(call_580037: Call_PredictionTrainedmodelsPredict_580025; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Submit model id and request a prediction
  ## 
...
proc call*(call_580038: Call_PredictionTrainedmodelsPredict_580025; id: string;
          fields: string = ""; quotaUser: string = ""; alt: string = "json";
          oauthToken: string = ""; userIp: string = ""; key: string = "";
          body: JsonNode = nil; prettyPrint: bool = true): Recallable =
  ...
  add(path_580039, "id", newJString(id))
...
var predictionTrainedmodelsPredict* = Call_PredictionTrainedmodelsPredict_580025(
    name: "predictionTrainedmodelsPredict", meth: HttpMethod.HttpPost,
    host: "www.googleapis.com", route: "/trainedmodels/{id}/predict",
    validator: validate_PredictionTrainedmodelsPredict_580026,
    base: "/prediction/v1.4", url: url_PredictionTrainedmodelsPredict_580027,
    schemes: {Scheme.Https})
export
  rest
