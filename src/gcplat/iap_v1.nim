...
var iapGetIamPolicy* = Call_IapGetIamPolicy_593677(name: "iapGetIamPolicy",
    ...
    route: "/v1/{resource}:getIamPolicy", validator: validate_IapGetIamPolicy_593678,
    base: "/", url: url_IapGetIamPolicy_593679, schemes: {Scheme.Https})
type
...
var iapSetIamPolicy* = Call_IapSetIamPolicy_593967(name: "iapSetIamPolicy",
    meth: HttpMethod.HttpPost, host: "iap.googleapis.com",
    route: "/v1/{resource}:setIamPolicy", validator: validate_IapSetIamPolicy_593968,
    base: "/", url: url_IapSetIamPolicy_593969, schemes: {Scheme.Https})
type
