...
var iapGetIamPolicy* = Call_IapGetIamPolicy_588710(name: "iapGetIamPolicy",
    ...
    route: "/v1/{resource}:getIamPolicy", validator: validate_IapGetIamPolicy_588711,
    base: "/", url: url_IapGetIamPolicy_588712, schemes: {Scheme.Https})
type
...
var iapSetIamPolicy* = Call_IapSetIamPolicy_589000(name: "iapSetIamPolicy",
    meth: HttpMethod.HttpPost, host: "iap.googleapis.com",
    route: "/v1/{resource}:setIamPolicy", validator: validate_IapSetIamPolicy_589001,
    base: "/", url: url_IapSetIamPolicy_589002, schemes: {Scheme.Https})
type
