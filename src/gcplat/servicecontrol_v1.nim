...
type
  Call_ServicecontrolServicesAllocateQuota_588710 = ref object of OpenApiRestCall_588441
proc url_ServicecontrolServicesAllocateQuota_588712(protocol: Scheme; host: string;
...
proc validate_ServicecontrolServicesAllocateQuota_588711(path: JsonNode;
  ...
  var valid_588838 = path.getOrDefault("serviceName")
  valid_588838 = validateParameter(valid_588838, JString, required = true,
                                 default = nil)
  if valid_588838 != nil:
    section.add "serviceName", valid_588838
...
proc call*(call_588886: Call_ServicecontrolServicesAllocateQuota_588710;
...
proc call*(call_588957: Call_ServicecontrolServicesAllocateQuota_588710;
  ...
  add(path_588958, "serviceName", newJString(serviceName))
  result = call_588957.call(path_588958, query_588960, nil, nil, body_588961)

var servicecontrolServicesAllocateQuota* = Call_ServicecontrolServicesAllocateQuota_588710(
    ...
    validator: validate_ServicecontrolServicesAllocateQuota_588711, base: "/",
    url: url_ServicecontrolServicesAllocateQuota_588712, schemes: {Scheme.Https})
type
  Call_ServicecontrolServicesCheck_589000 = ref object of OpenApiRestCall_588441
proc url_ServicecontrolServicesCheck_589002(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_ServicecontrolServicesCheck_589001(path: JsonNode; query: JsonNode;
  ...
  assert path != nil,
        "path argument is necessary due to required `serviceName` field"
  var valid_589003 = path.getOrDefault("serviceName")
  valid_589003 = validateParameter(valid_589003, JString, required = true,
                                 default = nil)
  if valid_589003 != nil:
    section.add "serviceName", valid_589003
  result.add "path", section
  ## parameters in `query` object:
  ##   upload_protocol: JString
  ##                  : Upload protocol for media (e.g. "raw", "multipart").
...
proc call*(call_589016: Call_ServicecontrolServicesCheck_589000; path: JsonNode;
...
proc call*(call_589017: Call_ServicecontrolServicesCheck_589000;
          serviceName: string; uploadProtocol: string = ""; fields: string = "";
          quotaUser: string = ""; alt: string = "json"; oauthToken: string = "";
          callback: string = ""; accessToken: string = ""; uploadType: string = "";
          key: string = ""; Xgafv: string = "1"; body: JsonNode = nil;
  ...
  add(path_589018, "serviceName", newJString(serviceName))
  result = call_589017.call(path_589018, query_589019, nil, nil, body_589020)

var servicecontrolServicesCheck* = Call_ServicecontrolServicesCheck_589000(
    name: "servicecontrolServicesCheck", meth: HttpMethod.HttpPost,
    host: "servicecontrol.googleapis.com",
    route: "/v1/services/{serviceName}:check",
    validator: validate_ServicecontrolServicesCheck_589001, base: "/",
    url: url_ServicecontrolServicesCheck_589002, schemes: {Scheme.Https})
type
  Call_ServicecontrolServicesReport_589021 = ref object of OpenApiRestCall_588441
proc url_ServicecontrolServicesReport_589023(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_ServicecontrolServicesReport_589022(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `serviceName` field"
  var valid_589024 = path.getOrDefault("serviceName")
  valid_589024 = validateParameter(valid_589024, JString, required = true,
                                 default = nil)
  if valid_589024 != nil:
    section.add "serviceName", valid_589024
  result.add "path", section
  ## parameters in `query` object:
  ##   upload_protocol: JString
  ##                  : Upload protocol for media (e.g. "raw", "multipart").
...
proc call*(call_589037: Call_ServicecontrolServicesReport_589021; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Reports operation results to Google Service Control, such as logs and
  ## metrics. It should be called after an operation is completed.
  ## 
...
proc call*(call_589038: Call_ServicecontrolServicesReport_589021;
          serviceName: string; uploadProtocol: string = ""; fields: string = "";
          quotaUser: string = ""; alt: string = "json"; oauthToken: string = "";
          callback: string = ""; accessToken: string = ""; uploadType: string = "";
          key: string = ""; Xgafv: string = "1"; body: JsonNode = nil;
  ...
  add(path_589039, "serviceName", newJString(serviceName))
  result = call_589038.call(path_589039, query_589040, nil, nil, body_589041)

var servicecontrolServicesReport* = Call_ServicecontrolServicesReport_589021(
    name: "servicecontrolServicesReport", meth: HttpMethod.HttpPost,
    host: "servicecontrol.googleapis.com",
    route: "/v1/services/{serviceName}:report",
    validator: validate_ServicecontrolServicesReport_589022, base: "/",
    url: url_ServicecontrolServicesReport_589023, schemes: {Scheme.Https})
export
  rest
