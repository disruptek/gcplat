...
type
  Call_VerifiedaccessChallengeCreate_588710 = ref object of OpenApiRestCall_588441
proc url_VerifiedaccessChallengeCreate_588712(protocol: Scheme; host: string;
...
proc validate_VerifiedaccessChallengeCreate_588711(path: JsonNode; query: JsonNode;
...
proc call*(call_588871: Call_VerifiedaccessChallengeCreate_588710; path: JsonNode;
...
proc call*(call_588942: Call_VerifiedaccessChallengeCreate_588710;
...
var verifiedaccessChallengeCreate* = Call_VerifiedaccessChallengeCreate_588710(
    name: "verifiedaccessChallengeCreate", meth: HttpMethod.HttpPost,
    host: "verifiedaccess.googleapis.com", route: "/v1/challenge",
    validator: validate_VerifiedaccessChallengeCreate_588711, base: "/",
    url: url_VerifiedaccessChallengeCreate_588712, schemes: {Scheme.Https})
type
  Call_VerifiedaccessChallengeVerify_588984 = ref object of OpenApiRestCall_588441
proc url_VerifiedaccessChallengeVerify_588986(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_VerifiedaccessChallengeVerify_588985(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_588999: Call_VerifiedaccessChallengeVerify_588984; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## VerifyChallengeResponse API
  ## 
...
proc call*(call_589000: Call_VerifiedaccessChallengeVerify_588984;
          uploadProtocol: string = ""; fields: string = ""; quotaUser: string = "";
          alt: string = "json"; oauthToken: string = ""; callback: string = "";
          accessToken: string = ""; uploadType: string = ""; key: string = "";
          Xgafv: string = "1"; body: JsonNode = nil; prettyPrint: bool = true): Recallable =
...
var verifiedaccessChallengeVerify* = Call_VerifiedaccessChallengeVerify_588984(
    name: "verifiedaccessChallengeVerify", meth: HttpMethod.HttpPost,
    host: "verifiedaccess.googleapis.com", route: "/v1/challenge:verify",
    validator: validate_VerifiedaccessChallengeVerify_588985, base: "/",
    url: url_VerifiedaccessChallengeVerify_588986, schemes: {Scheme.Https})
export
  rest
