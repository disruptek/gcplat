...
const
  gcpServiceName = "verifiedaccess"
proc composeQueryString(query: JsonNode): string
method hook(call: OpenApiRestCall; url: Uri; input: JsonNode): Recallable {.base.}
type
  Call_VerifiedaccessChallengeCreate_578610 = ref object of OpenApiRestCall_578339
proc url_VerifiedaccessChallengeCreate_578612(protocol: Scheme; host: string;
...
proc validate_VerifiedaccessChallengeCreate_578611(path: JsonNode; query: JsonNode;
...
proc call*(call_578771: Call_VerifiedaccessChallengeCreate_578610; path: JsonNode;
...
proc call*(call_578842: Call_VerifiedaccessChallengeCreate_578610;
...
var verifiedaccessChallengeCreate* = Call_VerifiedaccessChallengeCreate_578610(
    name: "verifiedaccessChallengeCreate", meth: HttpMethod.HttpPost,
    host: "verifiedaccess.googleapis.com", route: "/v1/challenge",
    validator: validate_VerifiedaccessChallengeCreate_578611, base: "/",
    url: url_VerifiedaccessChallengeCreate_578612, schemes: {Scheme.Https})
type
  Call_VerifiedaccessChallengeVerify_578884 = ref object of OpenApiRestCall_578339
proc url_VerifiedaccessChallengeVerify_578886(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_VerifiedaccessChallengeVerify_578885(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_578899: Call_VerifiedaccessChallengeVerify_578884; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## VerifyChallengeResponse API
  ## 
...
proc call*(call_578900: Call_VerifiedaccessChallengeVerify_578884;
          key: string = ""; prettyPrint: bool = true; oauthToken: string = "";
          Xgafv: string = "1"; alt: string = "json"; uploadType: string = "";
          quotaUser: string = ""; body: JsonNode = nil; callback: string = "";
          fields: string = ""; accessToken: string = ""; uploadProtocol: string = ""): Recallable =
...
var verifiedaccessChallengeVerify* = Call_VerifiedaccessChallengeVerify_578884(
    name: "verifiedaccessChallengeVerify", meth: HttpMethod.HttpPost,
    host: "verifiedaccess.googleapis.com", route: "/v1/challenge:verify",
    validator: validate_VerifiedaccessChallengeVerify_578885, base: "/",
    url: url_VerifiedaccessChallengeVerify_578886, schemes: {Scheme.Https})
export
  rest
