...
type
  Call_AccessapprovalProjectsApprovalRequestsGet_578610 = ref object of OpenApiRestCall_578339
proc url_AccessapprovalProjectsApprovalRequestsGet_578612(protocol: Scheme;
...
proc validate_AccessapprovalProjectsApprovalRequestsGet_578611(path: JsonNode;
...
proc call*(call_578785: Call_AccessapprovalProjectsApprovalRequestsGet_578610;
...
proc call*(call_578856: Call_AccessapprovalProjectsApprovalRequestsGet_578610;
...
var accessapprovalProjectsApprovalRequestsGet* = Call_AccessapprovalProjectsApprovalRequestsGet_578610(
    ...
    validator: validate_AccessapprovalProjectsApprovalRequestsGet_578611,
    base: "/", url: url_AccessapprovalProjectsApprovalRequestsGet_578612,
    schemes: {Scheme.Https})
type
  Call_AccessapprovalProjectsUpdateAccessApprovalSettings_578898 = ref object of OpenApiRestCall_578339
proc url_AccessapprovalProjectsUpdateAccessApprovalSettings_578900(
...
proc validate_AccessapprovalProjectsUpdateAccessApprovalSettings_578899(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
...
proc call*(call_578915: Call_AccessapprovalProjectsUpdateAccessApprovalSettings_578898;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Updates the settings associated with a project, folder, or organization.
  ## Settings to update are determined by the value of field_mask.
...
proc call*(call_578916: Call_AccessapprovalProjectsUpdateAccessApprovalSettings_578898;
          name: string; key: string = ""; prettyPrint: bool = true;
          oauthToken: string = ""; Xgafv: string = "1"; alt: string = "json";
...
var accessapprovalProjectsUpdateAccessApprovalSettings* = Call_AccessapprovalProjectsUpdateAccessApprovalSettings_578898(
    name: "accessapprovalProjectsUpdateAccessApprovalSettings",
    meth: HttpMethod.HttpPatch, host: "accessapproval.googleapis.com",
    route: "/v1beta1/{name}",
    validator: validate_AccessapprovalProjectsUpdateAccessApprovalSettings_578899,
    base: "/", url: url_AccessapprovalProjectsUpdateAccessApprovalSettings_578900,
    schemes: {Scheme.Https})
type
  Call_AccessapprovalProjectsApprovalRequestsApprove_578920 = ref object of OpenApiRestCall_578339
proc url_AccessapprovalProjectsApprovalRequestsApprove_578922(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_AccessapprovalProjectsApprovalRequestsApprove_578921(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_578936: Call_AccessapprovalProjectsApprovalRequestsApprove_578920;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Approves a request and returns the updated ApprovalRequest.
  ## 
...
proc call*(call_578937: Call_AccessapprovalProjectsApprovalRequestsApprove_578920;
          name: string; key: string = ""; prettyPrint: bool = true;
          oauthToken: string = ""; Xgafv: string = "1"; alt: string = "json";
...
var accessapprovalProjectsApprovalRequestsApprove* = Call_AccessapprovalProjectsApprovalRequestsApprove_578920(
    ...
    validator: validate_AccessapprovalProjectsApprovalRequestsApprove_578921,
    base: "/", url: url_AccessapprovalProjectsApprovalRequestsApprove_578922,
    schemes: {Scheme.Https})
type
  Call_AccessapprovalProjectsApprovalRequestsDismiss_578941 = ref object of OpenApiRestCall_578339
proc url_AccessapprovalProjectsApprovalRequestsDismiss_578943(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_AccessapprovalProjectsApprovalRequestsDismiss_578942(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_578957: Call_AccessapprovalProjectsApprovalRequestsDismiss_578941;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Dismisses a request. Returns the updated ApprovalRequest.
  ## 
...
proc call*(call_578958: Call_AccessapprovalProjectsApprovalRequestsDismiss_578941;
          name: string; key: string = ""; prettyPrint: bool = true;
          oauthToken: string = ""; Xgafv: string = "1"; alt: string = "json";
          uploadType: string = ""; quotaUser: string = ""; body: JsonNode = nil;
          callback: string = ""; fields: string = ""; accessToken: string = "";
...
var accessapprovalProjectsApprovalRequestsDismiss* = Call_AccessapprovalProjectsApprovalRequestsDismiss_578941(
    name: "accessapprovalProjectsApprovalRequestsDismiss",
    meth: HttpMethod.HttpPost, host: "accessapproval.googleapis.com",
    route: "/v1beta1/{name}:dismiss",
    validator: validate_AccessapprovalProjectsApprovalRequestsDismiss_578942,
    base: "/", url: url_AccessapprovalProjectsApprovalRequestsDismiss_578943,
    schemes: {Scheme.Https})
type
  Call_AccessapprovalProjectsApprovalRequestsList_578962 = ref object of OpenApiRestCall_578339
proc url_AccessapprovalProjectsApprovalRequestsList_578964(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_AccessapprovalProjectsApprovalRequestsList_578963(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_578974 = query.getOrDefault("filter")
  valid_578974 = validateParameter(valid_578974, JString, required = false,
                                 default = nil)
  if valid_578974 != nil:
    section.add "filter", valid_578974
...
proc call*(call_578980: Call_AccessapprovalProjectsApprovalRequestsList_578962;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Lists approval requests associated with a project, folder, or organization.
  ## Approval requests can be filtered by state (pending, active, dismissed).
...
proc call*(call_578981: Call_AccessapprovalProjectsApprovalRequestsList_578962;
  ...
  add(query_578983, "filter", newJString(filter))
...
var accessapprovalProjectsApprovalRequestsList* = Call_AccessapprovalProjectsApprovalRequestsList_578962(
    ...
    validator: validate_AccessapprovalProjectsApprovalRequestsList_578963,
    base: "/", url: url_AccessapprovalProjectsApprovalRequestsList_578964,
    schemes: {Scheme.Https})
export
  rest
