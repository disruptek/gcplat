...
type
  Call_LanguageDocumentsAnalyzeEntitySentiment_578884 = ref object of OpenApiRestCall_578339
proc url_LanguageDocumentsAnalyzeEntitySentiment_578886(protocol: Scheme;
...
proc validate_LanguageDocumentsAnalyzeEntitySentiment_578885(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_578899: Call_LanguageDocumentsAnalyzeEntitySentiment_578884;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Finds entities, similar to AnalyzeEntities in the text and analyzes
  ## sentiment associated with each entity and its mentions.
...
proc call*(call_578900: Call_LanguageDocumentsAnalyzeEntitySentiment_578884;
          key: string = ""; prettyPrint: bool = true; oauthToken: string = "";
          Xgafv: string = "1"; alt: string = "json"; uploadType: string = "";
          quotaUser: string = ""; body: JsonNode = nil; callback: string = "";
          fields: string = ""; accessToken: string = ""; uploadProtocol: string = ""): Recallable =
...
var languageDocumentsAnalyzeEntitySentiment* = Call_LanguageDocumentsAnalyzeEntitySentiment_578884(
    name: "languageDocumentsAnalyzeEntitySentiment", meth: HttpMethod.HttpPost,
    host: "language.googleapis.com",
    route: "/v1beta2/documents:analyzeEntitySentiment",
    validator: validate_LanguageDocumentsAnalyzeEntitySentiment_578885, base: "/",
    url: url_LanguageDocumentsAnalyzeEntitySentiment_578886,
    schemes: {Scheme.Https})
type
  Call_LanguageDocumentsAnalyzeSentiment_578903 = ref object of OpenApiRestCall_578339
proc url_LanguageDocumentsAnalyzeSentiment_578905(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_LanguageDocumentsAnalyzeSentiment_578904(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_578918: Call_LanguageDocumentsAnalyzeSentiment_578903;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Analyzes the sentiment of the provided text.
  ## 
...
proc call*(call_578919: Call_LanguageDocumentsAnalyzeSentiment_578903;
          key: string = ""; prettyPrint: bool = true; oauthToken: string = "";
          Xgafv: string = "1"; alt: string = "json"; uploadType: string = "";
          quotaUser: string = ""; body: JsonNode = nil; callback: string = "";
          fields: string = ""; accessToken: string = ""; uploadProtocol: string = ""): Recallable =
...
var languageDocumentsAnalyzeSentiment* = Call_LanguageDocumentsAnalyzeSentiment_578903(
    ...
    validator: validate_LanguageDocumentsAnalyzeSentiment_578904, base: "/",
    url: url_LanguageDocumentsAnalyzeSentiment_578905, schemes: {Scheme.Https})
type
  Call_LanguageDocumentsAnalyzeSyntax_578922 = ref object of OpenApiRestCall_578339
proc url_LanguageDocumentsAnalyzeSyntax_578924(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_LanguageDocumentsAnalyzeSyntax_578923(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_578937: Call_LanguageDocumentsAnalyzeSyntax_578922; path: JsonNode;
...
proc call*(call_578938: Call_LanguageDocumentsAnalyzeSyntax_578922;
          key: string = ""; prettyPrint: bool = true; oauthToken: string = "";
          Xgafv: string = "1"; alt: string = "json"; uploadType: string = "";
          quotaUser: string = ""; body: JsonNode = nil; callback: string = "";
          fields: string = ""; accessToken: string = ""; uploadProtocol: string = ""): Recallable =
...
var languageDocumentsAnalyzeSyntax* = Call_LanguageDocumentsAnalyzeSyntax_578922(
    ...
    validator: validate_LanguageDocumentsAnalyzeSyntax_578923, base: "/",
    url: url_LanguageDocumentsAnalyzeSyntax_578924, schemes: {Scheme.Https})
type
  Call_LanguageDocumentsAnnotateText_578941 = ref object of OpenApiRestCall_578339
proc url_LanguageDocumentsAnnotateText_578943(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_LanguageDocumentsAnnotateText_578942(path: JsonNode; query: JsonNode;
...
proc call*(call_578956: Call_LanguageDocumentsAnnotateText_578941; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## A convenience method that provides all syntax, sentiment, entity, and
  ## classification features in one call.
  ## 
...
proc call*(call_578957: Call_LanguageDocumentsAnnotateText_578941;
          key: string = ""; prettyPrint: bool = true; oauthToken: string = "";
          Xgafv: string = "1"; alt: string = "json"; uploadType: string = "";
          quotaUser: string = ""; body: JsonNode = nil; callback: string = "";
          fields: string = ""; accessToken: string = ""; uploadProtocol: string = ""): Recallable =
  ...
  result = call_578957.call(nil, query_578958, nil, nil, body_578959)

var languageDocumentsAnnotateText* = Call_LanguageDocumentsAnnotateText_578941(
    ...
    validator: validate_LanguageDocumentsAnnotateText_578942, base: "/",
    url: url_LanguageDocumentsAnnotateText_578943, schemes: {Scheme.Https})
type
  Call_LanguageDocumentsClassifyText_578960 = ref object of OpenApiRestCall_578339
proc url_LanguageDocumentsClassifyText_578962(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_LanguageDocumentsClassifyText_578961(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_578975: Call_LanguageDocumentsClassifyText_578960; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Classifies a document into categories.
  ## 
...
proc call*(call_578976: Call_LanguageDocumentsClassifyText_578960;
          key: string = ""; prettyPrint: bool = true; oauthToken: string = "";
          Xgafv: string = "1"; alt: string = "json"; uploadType: string = "";
          quotaUser: string = ""; body: JsonNode = nil; callback: string = "";
          fields: string = ""; accessToken: string = ""; uploadProtocol: string = ""): Recallable =
...
var languageDocumentsClassifyText* = Call_LanguageDocumentsClassifyText_578960(
    ...
    validator: validate_LanguageDocumentsClassifyText_578961, base: "/",
    url: url_LanguageDocumentsClassifyText_578962, schemes: {Scheme.Https})
export
  rest
