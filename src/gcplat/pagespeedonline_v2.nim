...
proc validate_PagespeedonlinePagespeedapiRunpagespeed_588710(path: JsonNode;
  ...
  section = newJObject()
  var valid_588823 = query.getOrDefault("locale")
  valid_588823 = validateParameter(valid_588823, JString, required = false,
                                 default = nil)
  if valid_588823 != nil:
    section.add "locale", valid_588823
  ...
  var valid_588842 = query.getOrDefault("filter_third_party_resources")
  valid_588842 = validateParameter(valid_588842, JBool, required = false,
                                 default = newJBool(false))
  if valid_588842 != nil:
    section.add "filter_third_party_resources", valid_588842
  assert query != nil, "query argument is necessary due to required `url` field"
  var valid_588843 = query.getOrDefault("url")
  valid_588843 = validateParameter(valid_588843, JString, required = true,
                                 default = nil)
  if valid_588843 != nil:
    section.add "url", valid_588843
  var valid_588844 = query.getOrDefault("key")
  valid_588844 = validateParameter(valid_588844, JString, required = false,
                                 default = nil)
  if valid_588844 != nil:
    section.add "key", valid_588844
  var valid_588845 = query.getOrDefault("rule")
  valid_588845 = validateParameter(valid_588845, JArray, required = false,
                                 default = nil)
  if valid_588845 != nil:
    section.add "rule", valid_588845
  var valid_588846 = query.getOrDefault("screenshot")
  valid_588846 = validateParameter(valid_588846, JBool, required = false,
                                 default = newJBool(false))
  if valid_588846 != nil:
    section.add "screenshot", valid_588846
...
proc call*(call_588871: Call_PagespeedonlinePagespeedapiRunpagespeed_588709;
...
proc call*(call_588942: Call_PagespeedonlinePagespeedapiRunpagespeed_588709;
  ...
  add(query_588943, "locale", newJString(locale))
  ...
  add(query_588943, "userIp", newJString(userIp))
  add(query_588943, "filter_third_party_resources",
      newJBool(filterThirdPartyResources))
  add(query_588943, "url", newJString(url))
  add(query_588943, "key", newJString(key))
  if rule != nil:
    query_588943.add "rule", rule
  add(query_588943, "screenshot", newJBool(screenshot))
  add(query_588943, "prettyPrint", newJBool(prettyPrint))
  add(query_588943, "strategy", newJString(strategy))
...
var pagespeedonlinePagespeedapiRunpagespeed* = Call_PagespeedonlinePagespeedapiRunpagespeed_588709(
    ...
    base: "/pagespeedonline/v2", url: url_PagespeedonlinePagespeedapiRunpagespeed_588711,
