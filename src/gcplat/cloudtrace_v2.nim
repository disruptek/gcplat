...
type
  Call_CloudtraceProjectsTracesSpansCreateSpan_578610 = ref object of OpenApiRestCall_578339
proc url_CloudtraceProjectsTracesSpansCreateSpan_578612(protocol: Scheme;
...
proc validate_CloudtraceProjectsTracesSpansCreateSpan_578611(path: JsonNode;
...
proc call*(call_578786: Call_CloudtraceProjectsTracesSpansCreateSpan_578610;
...
proc call*(call_578857: Call_CloudtraceProjectsTracesSpansCreateSpan_578610;
...
var cloudtraceProjectsTracesSpansCreateSpan* = Call_CloudtraceProjectsTracesSpansCreateSpan_578610(
    name: "cloudtraceProjectsTracesSpansCreateSpan", meth: HttpMethod.HttpPost,
    host: "cloudtrace.googleapis.com", route: "/v2/{name}",
    validator: validate_CloudtraceProjectsTracesSpansCreateSpan_578611, base: "/",
    url: url_CloudtraceProjectsTracesSpansCreateSpan_578612,
    schemes: {Scheme.Https})
type
  Call_CloudtraceProjectsTracesBatchWrite_578900 = ref object of OpenApiRestCall_578339
proc url_CloudtraceProjectsTracesBatchWrite_578902(protocol: Scheme; host: string;
...
proc validate_CloudtraceProjectsTracesBatchWrite_578901(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_578916: Call_CloudtraceProjectsTracesBatchWrite_578900;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Sends new spans to new or existing traces. You cannot update
  ## existing spans.
...
proc call*(call_578917: Call_CloudtraceProjectsTracesBatchWrite_578900;
          name: string; key: string = ""; prettyPrint: bool = true;
          oauthToken: string = ""; Xgafv: string = "1"; alt: string = "json";
          uploadType: string = ""; quotaUser: string = ""; body: JsonNode = nil;
          callback: string = ""; fields: string = ""; accessToken: string = "";
...
var cloudtraceProjectsTracesBatchWrite* = Call_CloudtraceProjectsTracesBatchWrite_578900(
    ...
    validator: validate_CloudtraceProjectsTracesBatchWrite_578901, base: "/",
    url: url_CloudtraceProjectsTracesBatchWrite_578902, schemes: {Scheme.Https})
export
  rest
