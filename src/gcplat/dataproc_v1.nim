...
type
  Call_DataprocProjectsRegionsAutoscalingPoliciesUpdate_580254 = ref object of OpenApiRestCall_579421
proc url_DataprocProjectsRegionsAutoscalingPoliciesUpdate_580256(
...
proc validate_DataprocProjectsRegionsAutoscalingPoliciesUpdate_580255(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
...
proc call*(call_580270: Call_DataprocProjectsRegionsAutoscalingPoliciesUpdate_580254;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Updates (replaces) autoscaling policy.Disabled check for update_mask, because all updates will be full replacements.
  ## 
...
proc call*(call_580271: Call_DataprocProjectsRegionsAutoscalingPoliciesUpdate_580254;
...
var dataprocProjectsRegionsAutoscalingPoliciesUpdate* = Call_DataprocProjectsRegionsAutoscalingPoliciesUpdate_580254(
    name: "dataprocProjectsRegionsAutoscalingPoliciesUpdate",
    meth: HttpMethod.HttpPut, host: "dataproc.googleapis.com", route: "/v1/{name}",
    validator: validate_DataprocProjectsRegionsAutoscalingPoliciesUpdate_580255,
    base: "/", url: url_DataprocProjectsRegionsAutoscalingPoliciesUpdate_580256,
    schemes: {Scheme.Https})
type
  Call_DataprocProjectsRegionsAutoscalingPoliciesGet_580234 = ref object of OpenApiRestCall_579421
proc url_DataprocProjectsRegionsAutoscalingPoliciesGet_580236(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_DataprocProjectsRegionsAutoscalingPoliciesGet_580235(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_580250: Call_DataprocProjectsRegionsAutoscalingPoliciesGet_580234;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Retrieves autoscaling policy.
  ## 
...
proc call*(call_580251: Call_DataprocProjectsRegionsAutoscalingPoliciesGet_580234;
          name: string; uploadProtocol: string = ""; fields: string = "";
          quotaUser: string = ""; alt: string = "json"; oauthToken: string = "";
          callback: string = ""; accessToken: string = ""; uploadType: string = "";
...
var dataprocProjectsRegionsAutoscalingPoliciesGet* = Call_DataprocProjectsRegionsAutoscalingPoliciesGet_580234(
    name: "dataprocProjectsRegionsAutoscalingPoliciesGet",
    meth: HttpMethod.HttpGet, host: "dataproc.googleapis.com", route: "/v1/{name}",
    validator: validate_DataprocProjectsRegionsAutoscalingPoliciesGet_580235,
    base: "/", url: url_DataprocProjectsRegionsAutoscalingPoliciesGet_580236,
    schemes: {Scheme.Https})
type
  Call_DataprocProjectsRegionsAutoscalingPoliciesDelete_580275 = ref object of OpenApiRestCall_579421
proc url_DataprocProjectsRegionsAutoscalingPoliciesDelete_580277(
    protocol: Scheme; host: string; base: string; route: string; path: JsonNode;
    query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DataprocProjectsRegionsAutoscalingPoliciesDelete_580276(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_580291: Call_DataprocProjectsRegionsAutoscalingPoliciesDelete_580275;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Deletes an autoscaling policy. It is an error to delete an autoscaling policy that is in use by one or more clusters.
  ## 
...
proc call*(call_580292: Call_DataprocProjectsRegionsAutoscalingPoliciesDelete_580275;
          name: string; uploadProtocol: string = ""; fields: string = "";
          quotaUser: string = ""; alt: string = "json"; oauthToken: string = "";
          callback: string = ""; accessToken: string = ""; uploadType: string = "";
          key: string = ""; Xgafv: string = "1"; version: int = 0; prettyPrint: bool = true): Recallable =
...
var dataprocProjectsRegionsAutoscalingPoliciesDelete* = Call_DataprocProjectsRegionsAutoscalingPoliciesDelete_580275(
    name: "dataprocProjectsRegionsAutoscalingPoliciesDelete",
    meth: HttpMethod.HttpDelete, host: "dataproc.googleapis.com",
    route: "/v1/{name}",
    validator: validate_DataprocProjectsRegionsAutoscalingPoliciesDelete_580276,
    base: "/", url: url_DataprocProjectsRegionsAutoscalingPoliciesDelete_580277,
    schemes: {Scheme.Https})
type
...
var dataprocProjectsRegionsOperationsCancel* = Call_DataprocProjectsRegionsOperationsCancel_580295(
    ...
    schemes: {Scheme.Https})
type
  Call_DataprocProjectsRegionsWorkflowTemplatesInstantiate_580314 = ref object of OpenApiRestCall_579421
proc url_DataprocProjectsRegionsWorkflowTemplatesInstantiate_580316(
    protocol: Scheme; host: string; base: string; route: string; path: JsonNode;
    query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DataprocProjectsRegionsWorkflowTemplatesInstantiate_580315(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_580330: Call_DataprocProjectsRegionsWorkflowTemplatesInstantiate_580314;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Instantiates a template and begins execution.The returned Operation can be used to track execution of workflow by polling operations.get. The Operation will complete when entire workflow is finished.The running workflow can be aborted via operations.cancel. This will cause any inflight jobs to be cancelled and workflow-owned clusters to be deleted.The Operation.metadata will be WorkflowMetadata. Also see Using WorkflowMetadata.On successful completion, Operation.response will be Empty.
  ## 
...
proc call*(call_580331: Call_DataprocProjectsRegionsWorkflowTemplatesInstantiate_580314;
          name: string; uploadProtocol: string = ""; fields: string = "";
          quotaUser: string = ""; alt: string = "json"; oauthToken: string = "";
          callback: string = ""; accessToken: string = ""; uploadType: string = "";
          key: string = ""; Xgafv: string = "1"; body: JsonNode = nil;
...
var dataprocProjectsRegionsWorkflowTemplatesInstantiate* = Call_DataprocProjectsRegionsWorkflowTemplatesInstantiate_580314(
    ...
    validator: validate_DataprocProjectsRegionsWorkflowTemplatesInstantiate_580315,
    base: "/", url: url_DataprocProjectsRegionsWorkflowTemplatesInstantiate_580316,
    schemes: {Scheme.Https})
type
  Call_DataprocProjectsRegionsAutoscalingPoliciesCreate_580356 = ref object of OpenApiRestCall_579421
proc url_DataprocProjectsRegionsAutoscalingPoliciesCreate_580358(
    protocol: Scheme; host: string; base: string; route: string; path: JsonNode;
    query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DataprocProjectsRegionsAutoscalingPoliciesCreate_580357(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_580372: Call_DataprocProjectsRegionsAutoscalingPoliciesCreate_580356;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Creates new autoscaling policy.
  ## 
...
proc call*(call_580373: Call_DataprocProjectsRegionsAutoscalingPoliciesCreate_580356;
...
var dataprocProjectsRegionsAutoscalingPoliciesCreate* = Call_DataprocProjectsRegionsAutoscalingPoliciesCreate_580356(
    name: "dataprocProjectsRegionsAutoscalingPoliciesCreate",
    meth: HttpMethod.HttpPost, host: "dataproc.googleapis.com",
    route: "/v1/{parent}/autoscalingPolicies",
    validator: validate_DataprocProjectsRegionsAutoscalingPoliciesCreate_580357,
    base: "/", url: url_DataprocProjectsRegionsAutoscalingPoliciesCreate_580358,
    schemes: {Scheme.Https})
type
  Call_DataprocProjectsRegionsAutoscalingPoliciesList_580335 = ref object of OpenApiRestCall_579421
proc url_DataprocProjectsRegionsAutoscalingPoliciesList_580337(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_DataprocProjectsRegionsAutoscalingPoliciesList_580336(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_580352: Call_DataprocProjectsRegionsAutoscalingPoliciesList_580335;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Lists autoscaling policies in the project.
  ## 
...
proc call*(call_580353: Call_DataprocProjectsRegionsAutoscalingPoliciesList_580335;
          parent: string; uploadProtocol: string = ""; fields: string = "";
...
var dataprocProjectsRegionsAutoscalingPoliciesList* = Call_DataprocProjectsRegionsAutoscalingPoliciesList_580335(
    name: "dataprocProjectsRegionsAutoscalingPoliciesList",
    meth: HttpMethod.HttpGet, host: "dataproc.googleapis.com",
    route: "/v1/{parent}/autoscalingPolicies",
    validator: validate_DataprocProjectsRegionsAutoscalingPoliciesList_580336,
    base: "/", url: url_DataprocProjectsRegionsAutoscalingPoliciesList_580337,
    schemes: {Scheme.Https})
type
  Call_DataprocProjectsRegionsWorkflowTemplatesCreate_580398 = ref object of OpenApiRestCall_579421
proc url_DataprocProjectsRegionsWorkflowTemplatesCreate_580400(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_DataprocProjectsRegionsWorkflowTemplatesCreate_580399(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_580414: Call_DataprocProjectsRegionsWorkflowTemplatesCreate_580398;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Creates new workflow template.
  ## 
...
proc call*(call_580415: Call_DataprocProjectsRegionsWorkflowTemplatesCreate_580398;
          parent: string; uploadProtocol: string = ""; fields: string = "";
          quotaUser: string = ""; alt: string = "json"; oauthToken: string = "";
          callback: string = ""; accessToken: string = ""; uploadType: string = "";
          key: string = ""; Xgafv: string = "1"; body: JsonNode = nil;
...
var dataprocProjectsRegionsWorkflowTemplatesCreate* = Call_DataprocProjectsRegionsWorkflowTemplatesCreate_580398(
    name: "dataprocProjectsRegionsWorkflowTemplatesCreate",
    meth: HttpMethod.HttpPost, host: "dataproc.googleapis.com",
    route: "/v1/{parent}/workflowTemplates",
    validator: validate_DataprocProjectsRegionsWorkflowTemplatesCreate_580399,
    base: "/", url: url_DataprocProjectsRegionsWorkflowTemplatesCreate_580400,
    schemes: {Scheme.Https})
type
  Call_DataprocProjectsRegionsWorkflowTemplatesList_580377 = ref object of OpenApiRestCall_579421
proc url_DataprocProjectsRegionsWorkflowTemplatesList_580379(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_DataprocProjectsRegionsWorkflowTemplatesList_580378(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_580394: Call_DataprocProjectsRegionsWorkflowTemplatesList_580377;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Lists workflows that match the specified filter in the request.
  ## 
...
proc call*(call_580395: Call_DataprocProjectsRegionsWorkflowTemplatesList_580377;
          parent: string; uploadProtocol: string = ""; fields: string = "";
          pageToken: string = ""; quotaUser: string = ""; alt: string = "json";
          oauthToken: string = ""; callback: string = ""; accessToken: string = "";
          uploadType: string = ""; key: string = ""; Xgafv: string = "1"; pageSize: int = 0;
...
var dataprocProjectsRegionsWorkflowTemplatesList* = Call_DataprocProjectsRegionsWorkflowTemplatesList_580377(
    name: "dataprocProjectsRegionsWorkflowTemplatesList",
    meth: HttpMethod.HttpGet, host: "dataproc.googleapis.com",
    route: "/v1/{parent}/workflowTemplates",
    validator: validate_DataprocProjectsRegionsWorkflowTemplatesList_580378,
    base: "/", url: url_DataprocProjectsRegionsWorkflowTemplatesList_580379,
    schemes: {Scheme.Https})
type
  Call_DataprocProjectsRegionsWorkflowTemplatesInstantiateInline_580419 = ref object of OpenApiRestCall_579421
proc url_DataprocProjectsRegionsWorkflowTemplatesInstantiateInline_580421(
    protocol: Scheme; host: string; base: string; route: string; path: JsonNode;
    query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DataprocProjectsRegionsWorkflowTemplatesInstantiateInline_580420(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_580436: Call_DataprocProjectsRegionsWorkflowTemplatesInstantiateInline_580419;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Instantiates a template and begins execution.This method is equivalent to executing the sequence CreateWorkflowTemplate, InstantiateWorkflowTemplate, DeleteWorkflowTemplate.The returned Operation can be used to track execution of workflow by polling operations.get. The Operation will complete when entire workflow is finished.The running workflow can be aborted via operations.cancel. This will cause any inflight jobs to be cancelled and workflow-owned clusters to be deleted.The Operation.metadata will be WorkflowMetadata. Also see Using WorkflowMetadata.On successful completion, Operation.response will be Empty.
  ## 
...
proc call*(call_580437: Call_DataprocProjectsRegionsWorkflowTemplatesInstantiateInline_580419;
          parent: string; uploadProtocol: string = ""; fields: string = "";
  ...
  add(query_580439, "requestId", newJString(requestId))
...
var dataprocProjectsRegionsWorkflowTemplatesInstantiateInline* = Call_DataprocProjectsRegionsWorkflowTemplatesInstantiateInline_580419(
    name: "dataprocProjectsRegionsWorkflowTemplatesInstantiateInline",
    meth: HttpMethod.HttpPost, host: "dataproc.googleapis.com",
    route: "/v1/{parent}/workflowTemplates:instantiateInline", validator: validate_DataprocProjectsRegionsWorkflowTemplatesInstantiateInline_580420,
    base: "/", url: url_DataprocProjectsRegionsWorkflowTemplatesInstantiateInline_580421,
    schemes: {Scheme.Https})
type
  Call_DataprocProjectsRegionsJobsGetIamPolicy_580441 = ref object of OpenApiRestCall_579421
proc url_DataprocProjectsRegionsJobsGetIamPolicy_580443(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_DataprocProjectsRegionsJobsGetIamPolicy_580442(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_580444 = path.getOrDefault("resource")
  valid_580444 = validateParameter(valid_580444, JString, required = true,
                                 default = nil)
  if valid_580444 != nil:
    section.add "resource", valid_580444
  result.add "path", section
  ## parameters in `query` object:
  ##   upload_protocol: JString
  ##                  : Upload protocol for media (e.g. "raw", "multipart").
  ...
  ##              : Returns response with indentations and line breaks.
  section = newJObject()
  var valid_580445 = query.getOrDefault("upload_protocol")
  valid_580445 = validateParameter(valid_580445, JString, required = false,
                                 default = nil)
  if valid_580445 != nil:
    section.add "upload_protocol", valid_580445
...
proc call*(call_580457: Call_DataprocProjectsRegionsJobsGetIamPolicy_580441;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
  ## 
...
proc call*(call_580458: Call_DataprocProjectsRegionsJobsGetIamPolicy_580441;
  ...
  add(path_580459, "resource", newJString(resource))
  if body != nil:
    body_580461 = body
  add(query_580460, "prettyPrint", newJBool(prettyPrint))
  result = call_580458.call(path_580459, query_580460, nil, nil, body_580461)

var dataprocProjectsRegionsJobsGetIamPolicy* = Call_DataprocProjectsRegionsJobsGetIamPolicy_580441(
    ...
    validator: validate_DataprocProjectsRegionsJobsGetIamPolicy_580442, base: "/",
    url: url_DataprocProjectsRegionsJobsGetIamPolicy_580443,
    schemes: {Scheme.Https})
type
  Call_DataprocProjectsRegionsJobsSetIamPolicy_580462 = ref object of OpenApiRestCall_579421
proc url_DataprocProjectsRegionsJobsSetIamPolicy_580464(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_DataprocProjectsRegionsJobsSetIamPolicy_580463(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_580478: Call_DataprocProjectsRegionsJobsSetIamPolicy_580462;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Sets the access control policy on the specified resource. Replaces any existing policy.
  ## 
...
proc call*(call_580479: Call_DataprocProjectsRegionsJobsSetIamPolicy_580462;
          resource: string; uploadProtocol: string = ""; fields: string = "";
          quotaUser: string = ""; alt: string = "json"; oauthToken: string = "";
          callback: string = ""; accessToken: string = ""; uploadType: string = "";
          key: string = ""; Xgafv: string = "1"; body: JsonNode = nil;
...
var dataprocProjectsRegionsJobsSetIamPolicy* = Call_DataprocProjectsRegionsJobsSetIamPolicy_580462(
    ...
    validator: validate_DataprocProjectsRegionsJobsSetIamPolicy_580463, base: "/",
    url: url_DataprocProjectsRegionsJobsSetIamPolicy_580464,
    schemes: {Scheme.Https})
type
  Call_DataprocProjectsRegionsJobsTestIamPermissions_580483 = ref object of OpenApiRestCall_579421
proc url_DataprocProjectsRegionsJobsTestIamPermissions_580485(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_DataprocProjectsRegionsJobsTestIamPermissions_580484(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_580499: Call_DataprocProjectsRegionsJobsTestIamPermissions_580483;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Returns permissions that a caller has on the specified resource. If the resource does not exist, this will return an empty set of permissions, not a NOT_FOUND error.Note: This operation is designed to be used for building permission-aware UIs and command-line tools, not for authorization checking. This operation may "fail open" without warning.
  ## 
...
proc call*(call_580500: Call_DataprocProjectsRegionsJobsTestIamPermissions_580483;
          resource: string; uploadProtocol: string = ""; fields: string = "";
          quotaUser: string = ""; alt: string = "json"; oauthToken: string = "";
          callback: string = ""; accessToken: string = ""; uploadType: string = "";
          key: string = ""; Xgafv: string = "1"; body: JsonNode = nil;
...
var dataprocProjectsRegionsJobsTestIamPermissions* = Call_DataprocProjectsRegionsJobsTestIamPermissions_580483(
    name: "dataprocProjectsRegionsJobsTestIamPermissions",
    meth: HttpMethod.HttpPost, host: "dataproc.googleapis.com",
    route: "/v1/{resource}:testIamPermissions",
    validator: validate_DataprocProjectsRegionsJobsTestIamPermissions_580484,
    base: "/", url: url_DataprocProjectsRegionsJobsTestIamPermissions_580485,
    schemes: {Scheme.Https})
export
  rest
