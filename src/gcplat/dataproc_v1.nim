...
type
  Call_DataprocProjectsLocationsWorkflowTemplatesUpdate_589285 = ref object of OpenApiRestCall_588450
proc url_DataprocProjectsLocationsWorkflowTemplatesUpdate_589287(
...
proc validate_DataprocProjectsLocationsWorkflowTemplatesUpdate_589286(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
...
proc call*(call_589301: Call_DataprocProjectsLocationsWorkflowTemplatesUpdate_589285;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Updates (replaces) workflow template. The updated template must contain version that matches the current server version.
  ## 
...
proc call*(call_589302: Call_DataprocProjectsLocationsWorkflowTemplatesUpdate_589285;
...
var dataprocProjectsLocationsWorkflowTemplatesUpdate* = Call_DataprocProjectsLocationsWorkflowTemplatesUpdate_589285(
    name: "dataprocProjectsLocationsWorkflowTemplatesUpdate",
    meth: HttpMethod.HttpPut, host: "dataproc.googleapis.com", route: "/v1/{name}",
    validator: validate_DataprocProjectsLocationsWorkflowTemplatesUpdate_589286,
    base: "/", url: url_DataprocProjectsLocationsWorkflowTemplatesUpdate_589287,
    schemes: {Scheme.Https})
type
  Call_DataprocProjectsLocationsWorkflowTemplatesGet_589263 = ref object of OpenApiRestCall_588450
proc url_DataprocProjectsLocationsWorkflowTemplatesGet_589265(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_DataprocProjectsLocationsWorkflowTemplatesGet_589264(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_589281: Call_DataprocProjectsLocationsWorkflowTemplatesGet_589263;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Retrieves the latest workflow template.Can retrieve previously instantiated template by specifying optional version parameter.
  ## 
...
proc call*(call_589282: Call_DataprocProjectsLocationsWorkflowTemplatesGet_589263;
          name: string; uploadProtocol: string = ""; fields: string = "";
...
var dataprocProjectsLocationsWorkflowTemplatesGet* = Call_DataprocProjectsLocationsWorkflowTemplatesGet_589263(
    name: "dataprocProjectsLocationsWorkflowTemplatesGet",
    meth: HttpMethod.HttpGet, host: "dataproc.googleapis.com", route: "/v1/{name}",
    validator: validate_DataprocProjectsLocationsWorkflowTemplatesGet_589264,
    base: "/", url: url_DataprocProjectsLocationsWorkflowTemplatesGet_589265,
    schemes: {Scheme.Https})
type
  Call_DataprocProjectsLocationsWorkflowTemplatesDelete_589306 = ref object of OpenApiRestCall_588450
proc url_DataprocProjectsLocationsWorkflowTemplatesDelete_589308(
    protocol: Scheme; host: string; base: string; route: string; path: JsonNode;
    query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DataprocProjectsLocationsWorkflowTemplatesDelete_589307(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_589322: Call_DataprocProjectsLocationsWorkflowTemplatesDelete_589306;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Deletes a workflow template. It does not cancel in-progress workflows.
  ## 
...
proc call*(call_589323: Call_DataprocProjectsLocationsWorkflowTemplatesDelete_589306;
          name: string; uploadProtocol: string = ""; fields: string = "";
          quotaUser: string = ""; alt: string = "json"; oauthToken: string = "";
          callback: string = ""; accessToken: string = ""; uploadType: string = "";
...
var dataprocProjectsLocationsWorkflowTemplatesDelete* = Call_DataprocProjectsLocationsWorkflowTemplatesDelete_589306(
    name: "dataprocProjectsLocationsWorkflowTemplatesDelete",
    meth: HttpMethod.HttpDelete, host: "dataproc.googleapis.com",
    route: "/v1/{name}",
    validator: validate_DataprocProjectsLocationsWorkflowTemplatesDelete_589307,
    base: "/", url: url_DataprocProjectsLocationsWorkflowTemplatesDelete_589308,
    schemes: {Scheme.Https})
type
...
var dataprocProjectsRegionsOperationsCancel* = Call_DataprocProjectsRegionsOperationsCancel_589326(
    ...
    schemes: {Scheme.Https})
type
  Call_DataprocProjectsLocationsWorkflowTemplatesInstantiate_589345 = ref object of OpenApiRestCall_588450
proc url_DataprocProjectsLocationsWorkflowTemplatesInstantiate_589347(
    protocol: Scheme; host: string; base: string; route: string; path: JsonNode;
    query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DataprocProjectsLocationsWorkflowTemplatesInstantiate_589346(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_589361: Call_DataprocProjectsLocationsWorkflowTemplatesInstantiate_589345;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Instantiates a template and begins execution.The returned Operation can be used to track execution of workflow by polling operations.get. The Operation will complete when entire workflow is finished.The running workflow can be aborted via operations.cancel. This will cause any inflight jobs to be cancelled and workflow-owned clusters to be deleted.The Operation.metadata will be WorkflowMetadata. Also see Using WorkflowMetadata.On successful completion, Operation.response will be Empty.
  ## 
...
proc call*(call_589362: Call_DataprocProjectsLocationsWorkflowTemplatesInstantiate_589345;
          name: string; uploadProtocol: string = ""; fields: string = "";
          quotaUser: string = ""; alt: string = "json"; oauthToken: string = "";
          callback: string = ""; accessToken: string = ""; uploadType: string = "";
          key: string = ""; Xgafv: string = "1"; body: JsonNode = nil;
...
var dataprocProjectsLocationsWorkflowTemplatesInstantiate* = Call_DataprocProjectsLocationsWorkflowTemplatesInstantiate_589345(
    ...
    validator: validate_DataprocProjectsLocationsWorkflowTemplatesInstantiate_589346,
    base: "/", url: url_DataprocProjectsLocationsWorkflowTemplatesInstantiate_589347,
    schemes: {Scheme.Https})
type
  Call_DataprocProjectsLocationsAutoscalingPoliciesCreate_589387 = ref object of OpenApiRestCall_588450
proc url_DataprocProjectsLocationsAutoscalingPoliciesCreate_589389(
    protocol: Scheme; host: string; base: string; route: string; path: JsonNode;
    query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DataprocProjectsLocationsAutoscalingPoliciesCreate_589388(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_589403: Call_DataprocProjectsLocationsAutoscalingPoliciesCreate_589387;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Creates new autoscaling policy.
  ## 
...
proc call*(call_589404: Call_DataprocProjectsLocationsAutoscalingPoliciesCreate_589387;
...
var dataprocProjectsLocationsAutoscalingPoliciesCreate* = Call_DataprocProjectsLocationsAutoscalingPoliciesCreate_589387(
    name: "dataprocProjectsLocationsAutoscalingPoliciesCreate",
    meth: HttpMethod.HttpPost, host: "dataproc.googleapis.com",
    route: "/v1/{parent}/autoscalingPolicies",
    validator: validate_DataprocProjectsLocationsAutoscalingPoliciesCreate_589388,
    base: "/", url: url_DataprocProjectsLocationsAutoscalingPoliciesCreate_589389,
    schemes: {Scheme.Https})
type
  Call_DataprocProjectsLocationsAutoscalingPoliciesList_589366 = ref object of OpenApiRestCall_588450
proc url_DataprocProjectsLocationsAutoscalingPoliciesList_589368(
    protocol: Scheme; host: string; base: string; route: string; path: JsonNode;
    query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DataprocProjectsLocationsAutoscalingPoliciesList_589367(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_589383: Call_DataprocProjectsLocationsAutoscalingPoliciesList_589366;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Lists autoscaling policies in the project.
  ## 
...
proc call*(call_589384: Call_DataprocProjectsLocationsAutoscalingPoliciesList_589366;
          parent: string; uploadProtocol: string = ""; fields: string = "";
          pageToken: string = ""; quotaUser: string = ""; alt: string = "json";
          oauthToken: string = ""; callback: string = ""; accessToken: string = "";
          uploadType: string = ""; key: string = ""; Xgafv: string = "1"; pageSize: int = 0;
...
var dataprocProjectsLocationsAutoscalingPoliciesList* = Call_DataprocProjectsLocationsAutoscalingPoliciesList_589366(
    name: "dataprocProjectsLocationsAutoscalingPoliciesList",
    meth: HttpMethod.HttpGet, host: "dataproc.googleapis.com",
    route: "/v1/{parent}/autoscalingPolicies",
    validator: validate_DataprocProjectsLocationsAutoscalingPoliciesList_589367,
    base: "/", url: url_DataprocProjectsLocationsAutoscalingPoliciesList_589368,
    schemes: {Scheme.Https})
type
  Call_DataprocProjectsLocationsWorkflowTemplatesCreate_589429 = ref object of OpenApiRestCall_588450
proc url_DataprocProjectsLocationsWorkflowTemplatesCreate_589431(
    protocol: Scheme; host: string; base: string; route: string; path: JsonNode;
    query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DataprocProjectsLocationsWorkflowTemplatesCreate_589430(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_589445: Call_DataprocProjectsLocationsWorkflowTemplatesCreate_589429;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Creates new workflow template.
  ## 
...
proc call*(call_589446: Call_DataprocProjectsLocationsWorkflowTemplatesCreate_589429;
          parent: string; uploadProtocol: string = ""; fields: string = "";
          quotaUser: string = ""; alt: string = "json"; oauthToken: string = "";
          callback: string = ""; accessToken: string = ""; uploadType: string = "";
          key: string = ""; Xgafv: string = "1"; body: JsonNode = nil;
...
var dataprocProjectsLocationsWorkflowTemplatesCreate* = Call_DataprocProjectsLocationsWorkflowTemplatesCreate_589429(
    name: "dataprocProjectsLocationsWorkflowTemplatesCreate",
    meth: HttpMethod.HttpPost, host: "dataproc.googleapis.com",
    route: "/v1/{parent}/workflowTemplates",
    validator: validate_DataprocProjectsLocationsWorkflowTemplatesCreate_589430,
    base: "/", url: url_DataprocProjectsLocationsWorkflowTemplatesCreate_589431,
    schemes: {Scheme.Https})
type
  Call_DataprocProjectsLocationsWorkflowTemplatesList_589408 = ref object of OpenApiRestCall_588450
proc url_DataprocProjectsLocationsWorkflowTemplatesList_589410(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_DataprocProjectsLocationsWorkflowTemplatesList_589409(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_589425: Call_DataprocProjectsLocationsWorkflowTemplatesList_589408;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Lists workflows that match the specified filter in the request.
  ## 
...
proc call*(call_589426: Call_DataprocProjectsLocationsWorkflowTemplatesList_589408;
          parent: string; uploadProtocol: string = ""; fields: string = "";
          pageToken: string = ""; quotaUser: string = ""; alt: string = "json";
          oauthToken: string = ""; callback: string = ""; accessToken: string = "";
          uploadType: string = ""; key: string = ""; Xgafv: string = "1"; pageSize: int = 0;
...
var dataprocProjectsLocationsWorkflowTemplatesList* = Call_DataprocProjectsLocationsWorkflowTemplatesList_589408(
    name: "dataprocProjectsLocationsWorkflowTemplatesList",
    meth: HttpMethod.HttpGet, host: "dataproc.googleapis.com",
    route: "/v1/{parent}/workflowTemplates",
    validator: validate_DataprocProjectsLocationsWorkflowTemplatesList_589409,
    base: "/", url: url_DataprocProjectsLocationsWorkflowTemplatesList_589410,
    schemes: {Scheme.Https})
type
  Call_DataprocProjectsLocationsWorkflowTemplatesInstantiateInline_589450 = ref object of OpenApiRestCall_588450
proc url_DataprocProjectsLocationsWorkflowTemplatesInstantiateInline_589452(
    protocol: Scheme; host: string; base: string; route: string; path: JsonNode;
    query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DataprocProjectsLocationsWorkflowTemplatesInstantiateInline_589451(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_589467: Call_DataprocProjectsLocationsWorkflowTemplatesInstantiateInline_589450;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Instantiates a template and begins execution.This method is equivalent to executing the sequence CreateWorkflowTemplate, InstantiateWorkflowTemplate, DeleteWorkflowTemplate.The returned Operation can be used to track execution of workflow by polling operations.get. The Operation will complete when entire workflow is finished.The running workflow can be aborted via operations.cancel. This will cause any inflight jobs to be cancelled and workflow-owned clusters to be deleted.The Operation.metadata will be WorkflowMetadata. Also see Using WorkflowMetadata.On successful completion, Operation.response will be Empty.
  ## 
...
proc call*(call_589468: Call_DataprocProjectsLocationsWorkflowTemplatesInstantiateInline_589450;
          parent: string; uploadProtocol: string = ""; fields: string = "";
  ...
  add(query_589470, "requestId", newJString(requestId))
...
var dataprocProjectsLocationsWorkflowTemplatesInstantiateInline* = Call_DataprocProjectsLocationsWorkflowTemplatesInstantiateInline_589450(
    name: "dataprocProjectsLocationsWorkflowTemplatesInstantiateInline",
    meth: HttpMethod.HttpPost, host: "dataproc.googleapis.com",
    route: "/v1/{parent}/workflowTemplates:instantiateInline", validator: validate_DataprocProjectsLocationsWorkflowTemplatesInstantiateInline_589451,
    base: "/",
    url: url_DataprocProjectsLocationsWorkflowTemplatesInstantiateInline_589452,
    schemes: {Scheme.Https})
type
  Call_DataprocProjectsLocationsWorkflowTemplatesGetIamPolicy_589472 = ref object of OpenApiRestCall_588450
proc url_DataprocProjectsLocationsWorkflowTemplatesGetIamPolicy_589474(
    protocol: Scheme; host: string; base: string; route: string; path: JsonNode;
    query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DataprocProjectsLocationsWorkflowTemplatesGetIamPolicy_589473(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
  ...
  var valid_589475 = path.getOrDefault("resource")
  valid_589475 = validateParameter(valid_589475, JString, required = true,
                                 default = nil)
  if valid_589475 != nil:
    section.add "resource", valid_589475
  result.add "path", section
  ## parameters in `query` object:
  ##   upload_protocol: JString
  ##                  : Upload protocol for media (e.g. "raw", "multipart").
...
proc call*(call_589488: Call_DataprocProjectsLocationsWorkflowTemplatesGetIamPolicy_589472;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
  ## 
...
proc call*(call_589489: Call_DataprocProjectsLocationsWorkflowTemplatesGetIamPolicy_589472;
  ...
  add(path_589490, "resource", newJString(resource))
  if body != nil:
    body_589492 = body
  add(query_589491, "prettyPrint", newJBool(prettyPrint))
  result = call_589489.call(path_589490, query_589491, nil, nil, body_589492)

var dataprocProjectsLocationsWorkflowTemplatesGetIamPolicy* = Call_DataprocProjectsLocationsWorkflowTemplatesGetIamPolicy_589472(
    name: "dataprocProjectsLocationsWorkflowTemplatesGetIamPolicy",
    meth: HttpMethod.HttpPost, host: "dataproc.googleapis.com",
    route: "/v1/{resource}:getIamPolicy",
    validator: validate_DataprocProjectsLocationsWorkflowTemplatesGetIamPolicy_589473,
    base: "/", url: url_DataprocProjectsLocationsWorkflowTemplatesGetIamPolicy_589474,
    schemes: {Scheme.Https})
type
  Call_DataprocProjectsLocationsWorkflowTemplatesSetIamPolicy_589493 = ref object of OpenApiRestCall_588450
proc url_DataprocProjectsLocationsWorkflowTemplatesSetIamPolicy_589495(
    protocol: Scheme; host: string; base: string; route: string; path: JsonNode;
    query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DataprocProjectsLocationsWorkflowTemplatesSetIamPolicy_589494(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_589509: Call_DataprocProjectsLocationsWorkflowTemplatesSetIamPolicy_589493;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Sets the access control policy on the specified resource. Replaces any existing policy.
  ## 
...
proc call*(call_589510: Call_DataprocProjectsLocationsWorkflowTemplatesSetIamPolicy_589493;
          resource: string; uploadProtocol: string = ""; fields: string = "";
          quotaUser: string = ""; alt: string = "json"; oauthToken: string = "";
          callback: string = ""; accessToken: string = ""; uploadType: string = "";
          key: string = ""; Xgafv: string = "1"; body: JsonNode = nil;
...
var dataprocProjectsLocationsWorkflowTemplatesSetIamPolicy* = Call_DataprocProjectsLocationsWorkflowTemplatesSetIamPolicy_589493(
    name: "dataprocProjectsLocationsWorkflowTemplatesSetIamPolicy",
    meth: HttpMethod.HttpPost, host: "dataproc.googleapis.com",
    route: "/v1/{resource}:setIamPolicy",
    validator: validate_DataprocProjectsLocationsWorkflowTemplatesSetIamPolicy_589494,
    base: "/", url: url_DataprocProjectsLocationsWorkflowTemplatesSetIamPolicy_589495,
    schemes: {Scheme.Https})
type
  Call_DataprocProjectsLocationsWorkflowTemplatesTestIamPermissions_589514 = ref object of OpenApiRestCall_588450
proc url_DataprocProjectsLocationsWorkflowTemplatesTestIamPermissions_589516(
    protocol: Scheme; host: string; base: string; route: string; path: JsonNode;
    query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DataprocProjectsLocationsWorkflowTemplatesTestIamPermissions_589515(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_589530: Call_DataprocProjectsLocationsWorkflowTemplatesTestIamPermissions_589514;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Returns permissions that a caller has on the specified resource. If the resource does not exist, this will return an empty set of permissions, not a NOT_FOUND error.Note: This operation is designed to be used for building permission-aware UIs and command-line tools, not for authorization checking. This operation may "fail open" without warning.
  ## 
...
proc call*(call_589531: Call_DataprocProjectsLocationsWorkflowTemplatesTestIamPermissions_589514;
          resource: string; uploadProtocol: string = ""; fields: string = "";
          quotaUser: string = ""; alt: string = "json"; oauthToken: string = "";
          callback: string = ""; accessToken: string = ""; uploadType: string = "";
          key: string = ""; Xgafv: string = "1"; body: JsonNode = nil;
...
var dataprocProjectsLocationsWorkflowTemplatesTestIamPermissions* = Call_DataprocProjectsLocationsWorkflowTemplatesTestIamPermissions_589514(
    name: "dataprocProjectsLocationsWorkflowTemplatesTestIamPermissions",
    meth: HttpMethod.HttpPost, host: "dataproc.googleapis.com",
    route: "/v1/{resource}:testIamPermissions", validator: validate_DataprocProjectsLocationsWorkflowTemplatesTestIamPermissions_589515,
    base: "/",
    url: url_DataprocProjectsLocationsWorkflowTemplatesTestIamPermissions_589516,
    schemes: {Scheme.Https})
export
  rest
