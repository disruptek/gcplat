...
type
  Call_DataprocProjectsLocationsWorkflowTemplatesUpdate_579185 = ref object of OpenApiRestCall_578348
proc url_DataprocProjectsLocationsWorkflowTemplatesUpdate_579187(
...
proc validate_DataprocProjectsLocationsWorkflowTemplatesUpdate_579186(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
...
proc call*(call_579201: Call_DataprocProjectsLocationsWorkflowTemplatesUpdate_579185;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Updates (replaces) workflow template. The updated template must contain version that matches the current server version.
  ## 
...
proc call*(call_579202: Call_DataprocProjectsLocationsWorkflowTemplatesUpdate_579185;
...
var dataprocProjectsLocationsWorkflowTemplatesUpdate* = Call_DataprocProjectsLocationsWorkflowTemplatesUpdate_579185(
    name: "dataprocProjectsLocationsWorkflowTemplatesUpdate",
    meth: HttpMethod.HttpPut, host: "dataproc.googleapis.com", route: "/v1/{name}",
    validator: validate_DataprocProjectsLocationsWorkflowTemplatesUpdate_579186,
    base: "/", url: url_DataprocProjectsLocationsWorkflowTemplatesUpdate_579187,
    schemes: {Scheme.Https})
type
  Call_DataprocProjectsLocationsWorkflowTemplatesGet_579163 = ref object of OpenApiRestCall_578348
proc url_DataprocProjectsLocationsWorkflowTemplatesGet_579165(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_DataprocProjectsLocationsWorkflowTemplatesGet_579164(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_579181: Call_DataprocProjectsLocationsWorkflowTemplatesGet_579163;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Retrieves the latest workflow template.Can retrieve previously instantiated template by specifying optional version parameter.
  ## 
...
proc call*(call_579182: Call_DataprocProjectsLocationsWorkflowTemplatesGet_579163;
          name: string; key: string = ""; prettyPrint: bool = true;
          oauthToken: string = ""; Xgafv: string = "1"; pageSize: int = 0;
...
var dataprocProjectsLocationsWorkflowTemplatesGet* = Call_DataprocProjectsLocationsWorkflowTemplatesGet_579163(
    name: "dataprocProjectsLocationsWorkflowTemplatesGet",
    meth: HttpMethod.HttpGet, host: "dataproc.googleapis.com", route: "/v1/{name}",
    validator: validate_DataprocProjectsLocationsWorkflowTemplatesGet_579164,
    base: "/", url: url_DataprocProjectsLocationsWorkflowTemplatesGet_579165,
    schemes: {Scheme.Https})
type
  Call_DataprocProjectsLocationsWorkflowTemplatesDelete_579206 = ref object of OpenApiRestCall_578348
proc url_DataprocProjectsLocationsWorkflowTemplatesDelete_579208(
    protocol: Scheme; host: string; base: string; route: string; path: JsonNode;
    query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DataprocProjectsLocationsWorkflowTemplatesDelete_579207(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_579222: Call_DataprocProjectsLocationsWorkflowTemplatesDelete_579206;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Deletes a workflow template. It does not cancel in-progress workflows.
  ## 
...
proc call*(call_579223: Call_DataprocProjectsLocationsWorkflowTemplatesDelete_579206;
          name: string; key: string = ""; prettyPrint: bool = true;
          oauthToken: string = ""; Xgafv: string = "1"; alt: string = "json";
...
var dataprocProjectsLocationsWorkflowTemplatesDelete* = Call_DataprocProjectsLocationsWorkflowTemplatesDelete_579206(
    name: "dataprocProjectsLocationsWorkflowTemplatesDelete",
    meth: HttpMethod.HttpDelete, host: "dataproc.googleapis.com",
    route: "/v1/{name}",
    validator: validate_DataprocProjectsLocationsWorkflowTemplatesDelete_579207,
    base: "/", url: url_DataprocProjectsLocationsWorkflowTemplatesDelete_579208,
    schemes: {Scheme.Https})
type
...
var dataprocProjectsRegionsOperationsCancel* = Call_DataprocProjectsRegionsOperationsCancel_579226(
    ...
    schemes: {Scheme.Https})
type
  Call_DataprocProjectsLocationsWorkflowTemplatesInstantiate_579245 = ref object of OpenApiRestCall_578348
proc url_DataprocProjectsLocationsWorkflowTemplatesInstantiate_579247(
    protocol: Scheme; host: string; base: string; route: string; path: JsonNode;
    query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DataprocProjectsLocationsWorkflowTemplatesInstantiate_579246(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_579261: Call_DataprocProjectsLocationsWorkflowTemplatesInstantiate_579245;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Instantiates a template and begins execution.The returned Operation can be used to track execution of workflow by polling operations.get. The Operation will complete when entire workflow is finished.The running workflow can be aborted via operations.cancel. This will cause any inflight jobs to be cancelled and workflow-owned clusters to be deleted.The Operation.metadata will be WorkflowMetadata. Also see Using WorkflowMetadata.On successful completion, Operation.response will be Empty.
  ## 
...
proc call*(call_579262: Call_DataprocProjectsLocationsWorkflowTemplatesInstantiate_579245;
          name: string; key: string = ""; prettyPrint: bool = true;
          oauthToken: string = ""; Xgafv: string = "1"; alt: string = "json";
          uploadType: string = ""; quotaUser: string = ""; body: JsonNode = nil;
          callback: string = ""; fields: string = ""; accessToken: string = "";
...
var dataprocProjectsLocationsWorkflowTemplatesInstantiate* = Call_DataprocProjectsLocationsWorkflowTemplatesInstantiate_579245(
    ...
    validator: validate_DataprocProjectsLocationsWorkflowTemplatesInstantiate_579246,
    base: "/", url: url_DataprocProjectsLocationsWorkflowTemplatesInstantiate_579247,
    schemes: {Scheme.Https})
type
  Call_DataprocProjectsLocationsAutoscalingPoliciesCreate_579287 = ref object of OpenApiRestCall_578348
proc url_DataprocProjectsLocationsAutoscalingPoliciesCreate_579289(
    protocol: Scheme; host: string; base: string; route: string; path: JsonNode;
    query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DataprocProjectsLocationsAutoscalingPoliciesCreate_579288(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_579303: Call_DataprocProjectsLocationsAutoscalingPoliciesCreate_579287;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Creates new autoscaling policy.
  ## 
...
proc call*(call_579304: Call_DataprocProjectsLocationsAutoscalingPoliciesCreate_579287;
...
var dataprocProjectsLocationsAutoscalingPoliciesCreate* = Call_DataprocProjectsLocationsAutoscalingPoliciesCreate_579287(
    name: "dataprocProjectsLocationsAutoscalingPoliciesCreate",
    meth: HttpMethod.HttpPost, host: "dataproc.googleapis.com",
    route: "/v1/{parent}/autoscalingPolicies",
    validator: validate_DataprocProjectsLocationsAutoscalingPoliciesCreate_579288,
    base: "/", url: url_DataprocProjectsLocationsAutoscalingPoliciesCreate_579289,
    schemes: {Scheme.Https})
type
  Call_DataprocProjectsLocationsAutoscalingPoliciesList_579266 = ref object of OpenApiRestCall_578348
proc url_DataprocProjectsLocationsAutoscalingPoliciesList_579268(
    protocol: Scheme; host: string; base: string; route: string; path: JsonNode;
    query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DataprocProjectsLocationsAutoscalingPoliciesList_579267(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_579283: Call_DataprocProjectsLocationsAutoscalingPoliciesList_579266;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Lists autoscaling policies in the project.
  ## 
...
proc call*(call_579284: Call_DataprocProjectsLocationsAutoscalingPoliciesList_579266;
          parent: string; key: string = ""; prettyPrint: bool = true;
          oauthToken: string = ""; Xgafv: string = "1"; pageSize: int = 0;
          alt: string = "json"; uploadType: string = ""; quotaUser: string = "";
...
var dataprocProjectsLocationsAutoscalingPoliciesList* = Call_DataprocProjectsLocationsAutoscalingPoliciesList_579266(
    name: "dataprocProjectsLocationsAutoscalingPoliciesList",
    meth: HttpMethod.HttpGet, host: "dataproc.googleapis.com",
    route: "/v1/{parent}/autoscalingPolicies",
    validator: validate_DataprocProjectsLocationsAutoscalingPoliciesList_579267,
    base: "/", url: url_DataprocProjectsLocationsAutoscalingPoliciesList_579268,
    schemes: {Scheme.Https})
type
  Call_DataprocProjectsLocationsWorkflowTemplatesCreate_579329 = ref object of OpenApiRestCall_578348
proc url_DataprocProjectsLocationsWorkflowTemplatesCreate_579331(
    protocol: Scheme; host: string; base: string; route: string; path: JsonNode;
    query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DataprocProjectsLocationsWorkflowTemplatesCreate_579330(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_579345: Call_DataprocProjectsLocationsWorkflowTemplatesCreate_579329;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Creates new workflow template.
  ## 
...
proc call*(call_579346: Call_DataprocProjectsLocationsWorkflowTemplatesCreate_579329;
          parent: string; key: string = ""; prettyPrint: bool = true;
          oauthToken: string = ""; Xgafv: string = "1"; alt: string = "json";
          uploadType: string = ""; quotaUser: string = ""; body: JsonNode = nil;
          callback: string = ""; fields: string = ""; accessToken: string = "";
...
var dataprocProjectsLocationsWorkflowTemplatesCreate* = Call_DataprocProjectsLocationsWorkflowTemplatesCreate_579329(
    name: "dataprocProjectsLocationsWorkflowTemplatesCreate",
    meth: HttpMethod.HttpPost, host: "dataproc.googleapis.com",
    route: "/v1/{parent}/workflowTemplates",
    validator: validate_DataprocProjectsLocationsWorkflowTemplatesCreate_579330,
    base: "/", url: url_DataprocProjectsLocationsWorkflowTemplatesCreate_579331,
    schemes: {Scheme.Https})
type
  Call_DataprocProjectsLocationsWorkflowTemplatesList_579308 = ref object of OpenApiRestCall_578348
proc url_DataprocProjectsLocationsWorkflowTemplatesList_579310(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_DataprocProjectsLocationsWorkflowTemplatesList_579309(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_579325: Call_DataprocProjectsLocationsWorkflowTemplatesList_579308;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Lists workflows that match the specified filter in the request.
  ## 
...
proc call*(call_579326: Call_DataprocProjectsLocationsWorkflowTemplatesList_579308;
          parent: string; key: string = ""; prettyPrint: bool = true;
          oauthToken: string = ""; Xgafv: string = "1"; pageSize: int = 0;
          alt: string = "json"; uploadType: string = ""; quotaUser: string = "";
          pageToken: string = ""; callback: string = ""; fields: string = "";
...
var dataprocProjectsLocationsWorkflowTemplatesList* = Call_DataprocProjectsLocationsWorkflowTemplatesList_579308(
    name: "dataprocProjectsLocationsWorkflowTemplatesList",
    meth: HttpMethod.HttpGet, host: "dataproc.googleapis.com",
    route: "/v1/{parent}/workflowTemplates",
    validator: validate_DataprocProjectsLocationsWorkflowTemplatesList_579309,
    base: "/", url: url_DataprocProjectsLocationsWorkflowTemplatesList_579310,
    schemes: {Scheme.Https})
type
  Call_DataprocProjectsLocationsWorkflowTemplatesInstantiateInline_579350 = ref object of OpenApiRestCall_578348
proc url_DataprocProjectsLocationsWorkflowTemplatesInstantiateInline_579352(
    protocol: Scheme; host: string; base: string; route: string; path: JsonNode;
    query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DataprocProjectsLocationsWorkflowTemplatesInstantiateInline_579351(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
  ...
  var valid_579359 = query.getOrDefault("uploadType")
  valid_579359 = validateParameter(valid_579359, JString, required = false,
                                 default = nil)
  if valid_579359 != nil:
    section.add "uploadType", valid_579359
  ...
  var valid_579361 = query.getOrDefault("callback")
  valid_579361 = validateParameter(valid_579361, JString, required = false,
                                 default = nil)
  if valid_579361 != nil:
    section.add "callback", valid_579361
  var valid_579362 = query.getOrDefault("requestId")
  valid_579362 = validateParameter(valid_579362, JString, required = false,
                                 default = nil)
  if valid_579362 != nil:
    section.add "requestId", valid_579362
...
proc call*(call_579367: Call_DataprocProjectsLocationsWorkflowTemplatesInstantiateInline_579350;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Instantiates a template and begins execution.This method is equivalent to executing the sequence CreateWorkflowTemplate, InstantiateWorkflowTemplate, DeleteWorkflowTemplate.The returned Operation can be used to track execution of workflow by polling operations.get. The Operation will complete when entire workflow is finished.The running workflow can be aborted via operations.cancel. This will cause any inflight jobs to be cancelled and workflow-owned clusters to be deleted.The Operation.metadata will be WorkflowMetadata. Also see Using WorkflowMetadata.On successful completion, Operation.response will be Empty.
  ## 
...
proc call*(call_579368: Call_DataprocProjectsLocationsWorkflowTemplatesInstantiateInline_579350;
          parent: string; key: string = ""; prettyPrint: bool = true;
          oauthToken: string = ""; Xgafv: string = "1"; alt: string = "json";
          uploadType: string = ""; quotaUser: string = ""; body: JsonNode = nil;
          callback: string = ""; requestId: string = ""; fields: string = "";
  ...
  add(query_579370, "requestId", newJString(requestId))
...
var dataprocProjectsLocationsWorkflowTemplatesInstantiateInline* = Call_DataprocProjectsLocationsWorkflowTemplatesInstantiateInline_579350(
    name: "dataprocProjectsLocationsWorkflowTemplatesInstantiateInline",
    meth: HttpMethod.HttpPost, host: "dataproc.googleapis.com",
    route: "/v1/{parent}/workflowTemplates:instantiateInline", validator: validate_DataprocProjectsLocationsWorkflowTemplatesInstantiateInline_579351,
    base: "/",
    url: url_DataprocProjectsLocationsWorkflowTemplatesInstantiateInline_579352,
    schemes: {Scheme.Https})
type
  Call_DataprocProjectsLocationsWorkflowTemplatesGetIamPolicy_579372 = ref object of OpenApiRestCall_578348
proc url_DataprocProjectsLocationsWorkflowTemplatesGetIamPolicy_579374(
    protocol: Scheme; host: string; base: string; route: string; path: JsonNode;
    query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DataprocProjectsLocationsWorkflowTemplatesGetIamPolicy_579373(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
  ...
  var valid_579375 = path.getOrDefault("resource")
  valid_579375 = validateParameter(valid_579375, JString, required = true,
                                 default = nil)
  if valid_579375 != nil:
    section.add "resource", valid_579375
  result.add "path", section
  ## parameters in `query` object:
  ##   key: JString
  ##      : API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
...
proc call*(call_579388: Call_DataprocProjectsLocationsWorkflowTemplatesGetIamPolicy_579372;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
  ## 
...
proc call*(call_579389: Call_DataprocProjectsLocationsWorkflowTemplatesGetIamPolicy_579372;
  ...
  add(path_579390, "resource", newJString(resource))
  if body != nil:
    body_579392 = body
...
var dataprocProjectsLocationsWorkflowTemplatesGetIamPolicy* = Call_DataprocProjectsLocationsWorkflowTemplatesGetIamPolicy_579372(
    name: "dataprocProjectsLocationsWorkflowTemplatesGetIamPolicy",
    meth: HttpMethod.HttpPost, host: "dataproc.googleapis.com",
    route: "/v1/{resource}:getIamPolicy",
    validator: validate_DataprocProjectsLocationsWorkflowTemplatesGetIamPolicy_579373,
    base: "/", url: url_DataprocProjectsLocationsWorkflowTemplatesGetIamPolicy_579374,
    schemes: {Scheme.Https})
type
  Call_DataprocProjectsLocationsWorkflowTemplatesSetIamPolicy_579393 = ref object of OpenApiRestCall_578348
proc url_DataprocProjectsLocationsWorkflowTemplatesSetIamPolicy_579395(
    protocol: Scheme; host: string; base: string; route: string; path: JsonNode;
    query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DataprocProjectsLocationsWorkflowTemplatesSetIamPolicy_579394(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_579409: Call_DataprocProjectsLocationsWorkflowTemplatesSetIamPolicy_579393;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Sets the access control policy on the specified resource. Replaces any existing policy.
  ## 
...
proc call*(call_579410: Call_DataprocProjectsLocationsWorkflowTemplatesSetIamPolicy_579393;
          resource: string; key: string = ""; prettyPrint: bool = true;
          oauthToken: string = ""; Xgafv: string = "1"; alt: string = "json";
          uploadType: string = ""; quotaUser: string = ""; body: JsonNode = nil;
          callback: string = ""; fields: string = ""; accessToken: string = "";
...
var dataprocProjectsLocationsWorkflowTemplatesSetIamPolicy* = Call_DataprocProjectsLocationsWorkflowTemplatesSetIamPolicy_579393(
    name: "dataprocProjectsLocationsWorkflowTemplatesSetIamPolicy",
    meth: HttpMethod.HttpPost, host: "dataproc.googleapis.com",
    route: "/v1/{resource}:setIamPolicy",
    validator: validate_DataprocProjectsLocationsWorkflowTemplatesSetIamPolicy_579394,
    base: "/", url: url_DataprocProjectsLocationsWorkflowTemplatesSetIamPolicy_579395,
    schemes: {Scheme.Https})
type
  Call_DataprocProjectsLocationsWorkflowTemplatesTestIamPermissions_579414 = ref object of OpenApiRestCall_578348
proc url_DataprocProjectsLocationsWorkflowTemplatesTestIamPermissions_579416(
    protocol: Scheme; host: string; base: string; route: string; path: JsonNode;
    query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DataprocProjectsLocationsWorkflowTemplatesTestIamPermissions_579415(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_579430: Call_DataprocProjectsLocationsWorkflowTemplatesTestIamPermissions_579414;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Returns permissions that a caller has on the specified resource. If the resource does not exist, this will return an empty set of permissions, not a NOT_FOUND error.Note: This operation is designed to be used for building permission-aware UIs and command-line tools, not for authorization checking. This operation may "fail open" without warning.
  ## 
...
proc call*(call_579431: Call_DataprocProjectsLocationsWorkflowTemplatesTestIamPermissions_579414;
          resource: string; key: string = ""; prettyPrint: bool = true;
          oauthToken: string = ""; Xgafv: string = "1"; alt: string = "json";
          uploadType: string = ""; quotaUser: string = ""; body: JsonNode = nil;
          callback: string = ""; fields: string = ""; accessToken: string = "";
...
var dataprocProjectsLocationsWorkflowTemplatesTestIamPermissions* = Call_DataprocProjectsLocationsWorkflowTemplatesTestIamPermissions_579414(
    name: "dataprocProjectsLocationsWorkflowTemplatesTestIamPermissions",
    meth: HttpMethod.HttpPost, host: "dataproc.googleapis.com",
    route: "/v1/{resource}:testIamPermissions", validator: validate_DataprocProjectsLocationsWorkflowTemplatesTestIamPermissions_579415,
    base: "/",
    url: url_DataprocProjectsLocationsWorkflowTemplatesTestIamPermissions_579416,
    schemes: {Scheme.Https})
export
  rest
