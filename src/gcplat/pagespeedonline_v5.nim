...
proc validate_PagespeedonlinePagespeedapiRunpagespeed_578610(path: JsonNode;
  ...
  var valid_578739 = query.getOrDefault("locale")
  valid_578739 = validateParameter(valid_578739, JString, required = false,
                                 default = nil)
  if valid_578739 != nil:
    section.add "locale", valid_578739
  var valid_578740 = query.getOrDefault("strategy")
  valid_578740 = validateParameter(valid_578740, JString, required = false,
                                 default = newJString("desktop"))
  if valid_578740 != nil:
    section.add "strategy", valid_578740
  ...
  var valid_578744 = query.getOrDefault("utm_campaign")
  valid_578744 = validateParameter(valid_578744, JString, required = false,
                                 default = nil)
  if valid_578744 != nil:
    section.add "utm_campaign", valid_578744
  var valid_578745 = query.getOrDefault("category")
  valid_578745 = validateParameter(valid_578745, JArray, required = false,
                                 default = nil)
  if valid_578745 != nil:
    section.add "category", valid_578745
  var valid_578746 = query.getOrDefault("fields")
  valid_578746 = validateParameter(valid_578746, JString, required = false,
                                 default = nil)
  if valid_578746 != nil:
    section.add "fields", valid_578746
  var valid_578747 = query.getOrDefault("utm_source")
  valid_578747 = validateParameter(valid_578747, JString, required = false,
                                 default = nil)
  if valid_578747 != nil:
    section.add "utm_source", valid_578747
...
proc call*(call_578842: Call_PagespeedonlinePagespeedapiRunpagespeed_578609;
  ...
  add(query_578843, "utm_campaign", newJString(utmCampaign))
  if category != nil:
    query_578843.add "category", category
  add(query_578843, "fields", newJString(fields))
  add(query_578843, "utm_source", newJString(utmSource))
...
var pagespeedonlinePagespeedapiRunpagespeed* = Call_PagespeedonlinePagespeedapiRunpagespeed_578609(
    ...
    base: "/pagespeedonline/v5", url: url_PagespeedonlinePagespeedapiRunpagespeed_578611,
