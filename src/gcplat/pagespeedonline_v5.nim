...
proc validate_PagespeedonlinePagespeedapiRunpagespeed_588710(path: JsonNode;
  ...
  var valid_588842 = query.getOrDefault("userIp")
  valid_588842 = validateParameter(valid_588842, JString, required = false,
                                 default = nil)
  if valid_588842 != nil:
    section.add "userIp", valid_588842
  ...
  var valid_588845 = query.getOrDefault("prettyPrint")
  valid_588845 = validateParameter(valid_588845, JBool, required = false,
                                 default = newJBool(true))
  if valid_588845 != nil:
    section.add "prettyPrint", valid_588845
  var valid_588846 = query.getOrDefault("category")
  valid_588846 = validateParameter(valid_588846, JArray, required = false,
                                 default = nil)
  if valid_588846 != nil:
    section.add "category", valid_588846
  var valid_588847 = query.getOrDefault("strategy")
  valid_588847 = validateParameter(valid_588847, JString, required = false,
                                 default = newJString("desktop"))
  if valid_588847 != nil:
    section.add "strategy", valid_588847
  var valid_588848 = query.getOrDefault("utm_campaign")
  valid_588848 = validateParameter(valid_588848, JString, required = false,
                                 default = nil)
  if valid_588848 != nil:
    section.add "utm_campaign", valid_588848
...
proc call*(call_588942: Call_PagespeedonlinePagespeedapiRunpagespeed_588709;
  ...
  add(query_588943, "utm_source", newJString(utmSource))
  ...
  if category != nil:
    query_588943.add "category", category
  add(query_588943, "strategy", newJString(strategy))
  add(query_588943, "utm_campaign", newJString(utmCampaign))
...
var pagespeedonlinePagespeedapiRunpagespeed* = Call_PagespeedonlinePagespeedapiRunpagespeed_588709(
    ...
    base: "/pagespeedonline/v5", url: url_PagespeedonlinePagespeedapiRunpagespeed_588711,
