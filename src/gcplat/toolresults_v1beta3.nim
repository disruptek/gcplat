...
var toolresultsProjectsHistoriesExecutionsStepsPerfMetricsSummaryCreate* = Call_ToolresultsProjectsHistoriesExecutionsStepsPerfMetricsSummaryCreate_589244(name: "toolresultsProjectsHistoriesExecutionsStepsPerfMetricsSummaryCreate",
    ...
    base: "/toolresults/v1beta3/projects", url: url_ToolresultsProjectsHistoriesExecutionsStepsPerfMetricsSummaryCreate_589246,
    schemes: {Scheme.Https})
type
...
var toolresultsProjectsHistoriesExecutionsStepsPerfSampleSeriesSamplesList* = Call_ToolresultsProjectsHistoriesExecutionsStepsPerfSampleSeriesSamplesList_589322(name: "toolresultsProjectsHistoriesExecutionsStepsPerfSampleSeriesSamplesList",
    ...
    base: "/toolresults/v1beta3/projects", url: url_ToolresultsProjectsHistoriesExecutionsStepsPerfSampleSeriesSamplesList_589324,
    schemes: {Scheme.Https})
type
...
var toolresultsProjectsHistoriesExecutionsStepsPerfSampleSeriesSamplesBatchCreate* = Call_ToolresultsProjectsHistoriesExecutionsStepsPerfSampleSeriesSamplesBatchCreate_589343(name: "toolresultsProjectsHistoriesExecutionsStepsPerfSampleSeriesSamplesBatchCreate",
    ...
    base: "/toolresults/v1beta3/projects", url: url_ToolresultsProjectsHistoriesExecutionsStepsPerfSampleSeriesSamplesBatchCreate_589345,
    schemes: {Scheme.Https})
type
  Call_ToolresultsProjectsHistoriesExecutionsStepsTestCasesList_589364 = ref object of OpenApiRestCall_588450
proc url_ToolresultsProjectsHistoriesExecutionsStepsTestCasesList_589366(
    protocol: Scheme; host: string; base: string; route: string; path: JsonNode;
    query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ToolresultsProjectsHistoriesExecutionsStepsTestCasesList_589365(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_589380: Call_ToolresultsProjectsHistoriesExecutionsStepsTestCasesList_589364;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Lists Test Cases attached to a Step. Experimental test cases API. Still in active development.
  ## 
...
proc call*(call_589381: Call_ToolresultsProjectsHistoriesExecutionsStepsTestCasesList_589364;
          stepId: string; projectId: string; historyId: string; executionId: string;
          fields: string = ""; pageToken: string = ""; quotaUser: string = "";
          alt: string = "json"; oauthToken: string = ""; userIp: string = "";
          key: string = ""; pageSize: int = 0; prettyPrint: bool = true): Recallable =
...
var toolresultsProjectsHistoriesExecutionsStepsTestCasesList* = Call_ToolresultsProjectsHistoriesExecutionsStepsTestCasesList_589364(
    name: "toolresultsProjectsHistoriesExecutionsStepsTestCasesList",
    meth: HttpMethod.HttpGet, host: "www.googleapis.com", route: "/{projectId}/histories/{historyId}/executions/{executionId}/steps/{stepId}/testCases", validator: validate_ToolresultsProjectsHistoriesExecutionsStepsTestCasesList_589365,
    base: "/toolresults/v1beta3/projects",
    url: url_ToolresultsProjectsHistoriesExecutionsStepsTestCasesList_589366,
    schemes: {Scheme.Https})
type
  Call_ToolresultsProjectsHistoriesExecutionsStepsTestCasesGet_589384 = ref object of OpenApiRestCall_588450
proc url_ToolresultsProjectsHistoriesExecutionsStepsTestCasesGet_589386(
    protocol: Scheme; host: string; base: string; route: string; path: JsonNode;
    query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ToolresultsProjectsHistoriesExecutionsStepsTestCasesGet_589385(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
  ...
  var valid_589391 = path.getOrDefault("testCaseId")
  valid_589391 = validateParameter(valid_589391, JString, required = true,
                                 default = nil)
  if valid_589391 != nil:
    section.add "testCaseId", valid_589391
  result.add "path", section
  ## parameters in `query` object:
  ##   fields: JString
  ##         : Selector specifying which fields to include in a partial response.
  ...
  var valid_589396 = query.getOrDefault("userIp")
  valid_589396 = validateParameter(valid_589396, JString, required = false,
                                 default = nil)
  if valid_589396 != nil:
    section.add "userIp", valid_589396
...
proc call*(call_589399: Call_ToolresultsProjectsHistoriesExecutionsStepsTestCasesGet_589384;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets details of a Test Case for a Step. Experimental test cases API. Still in active development.
  ## 
...
proc call*(call_589400: Call_ToolresultsProjectsHistoriesExecutionsStepsTestCasesGet_589384;
          stepId: string; projectId: string; historyId: string; executionId: string;
  ...
  add(path_589401, "testCaseId", newJString(testCaseId))
  result = call_589400.call(path_589401, query_589402, nil, nil, nil)

var toolresultsProjectsHistoriesExecutionsStepsTestCasesGet* = Call_ToolresultsProjectsHistoriesExecutionsStepsTestCasesGet_589384(
    name: "toolresultsProjectsHistoriesExecutionsStepsTestCasesGet",
    meth: HttpMethod.HttpGet, host: "www.googleapis.com", route: "/{projectId}/histories/{historyId}/executions/{executionId}/steps/{stepId}/testCases/{testCaseId}", validator: validate_ToolresultsProjectsHistoriesExecutionsStepsTestCasesGet_589385,
    base: "/toolresults/v1beta3/projects",
    url: url_ToolresultsProjectsHistoriesExecutionsStepsTestCasesGet_589386,
    schemes: {Scheme.Https})
type
  Call_ToolresultsProjectsHistoriesExecutionsStepsThumbnailsList_589403 = ref object of OpenApiRestCall_588450
proc url_ToolresultsProjectsHistoriesExecutionsStepsThumbnailsList_589405(
    protocol: Scheme; host: string; base: string; route: string; path: JsonNode;
    query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ToolresultsProjectsHistoriesExecutionsStepsThumbnailsList_589404(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `stepId` field"
  var valid_589406 = path.getOrDefault("stepId")
  valid_589406 = validateParameter(valid_589406, JString, required = true,
                                 default = nil)
  if valid_589406 != nil:
    section.add "stepId", valid_589406
  ...
  var valid_589408 = path.getOrDefault("historyId")
  valid_589408 = validateParameter(valid_589408, JString, required = true,
                                 default = nil)
  if valid_589408 != nil:
    section.add "historyId", valid_589408
  var valid_589409 = path.getOrDefault("executionId")
  valid_589409 = validateParameter(valid_589409, JString, required = true,
                                 default = nil)
  if valid_589409 != nil:
    section.add "executionId", valid_589409
  result.add "path", section
  ## parameters in `query` object:
  ##   fields: JString
  ##         : Selector specifying which fields to include in a partial response.
  ...
  var valid_589411 = query.getOrDefault("pageToken")
  valid_589411 = validateParameter(valid_589411, JString, required = false,
                                 default = nil)
  if valid_589411 != nil:
    section.add "pageToken", valid_589411
  ...
  var valid_589417 = query.getOrDefault("pageSize")
  valid_589417 = validateParameter(valid_589417, JInt, required = false, default = nil)
  if valid_589417 != nil:
    section.add "pageSize", valid_589417
...
proc call*(call_589419: Call_ToolresultsProjectsHistoriesExecutionsStepsThumbnailsList_589403;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Lists thumbnails of images attached to a step.
  ## 
  ## May return any of the following canonical error codes: - PERMISSION_DENIED - if the user is not authorized to read from the project, or from any of the images - INVALID_ARGUMENT - if the request is malformed - NOT_FOUND - if the step does not exist, or if any of the images do not exist
  ## 
  let valid = call_589419.validator(path, query, header, formData, body)
  let scheme = call_589419.pickScheme
  if scheme.isNone:
    raise newException(IOError, "unable to find a supported scheme")
  let url = call_589419.url(scheme.get, call_589419.host, call_589419.base,
                         call_589419.route, valid.getOrDefault("path"),
                         valid.getOrDefault("query"))
  result = hook(call_589419, url, valid)

proc call*(call_589420: Call_ToolresultsProjectsHistoriesExecutionsStepsThumbnailsList_589403;
          stepId: string; projectId: string; historyId: string; executionId: string;
          fields: string = ""; pageToken: string = ""; quotaUser: string = "";
          alt: string = "json"; oauthToken: string = ""; userIp: string = "";
          key: string = ""; pageSize: int = 0; prettyPrint: bool = true): Recallable =
  ...
  ## 
  ## Required.
  var path_589421 = newJObject()
  var query_589422 = newJObject()
  add(path_589421, "stepId", newJString(stepId))
  add(query_589422, "fields", newJString(fields))
  add(query_589422, "pageToken", newJString(pageToken))
  add(query_589422, "quotaUser", newJString(quotaUser))
  add(query_589422, "alt", newJString(alt))
  add(query_589422, "oauth_token", newJString(oauthToken))
  add(query_589422, "userIp", newJString(userIp))
  add(query_589422, "key", newJString(key))
  add(path_589421, "projectId", newJString(projectId))
  add(query_589422, "pageSize", newJInt(pageSize))
  add(path_589421, "historyId", newJString(historyId))
  add(query_589422, "prettyPrint", newJBool(prettyPrint))
  add(path_589421, "executionId", newJString(executionId))
  result = call_589420.call(path_589421, query_589422, nil, nil, nil)

var toolresultsProjectsHistoriesExecutionsStepsThumbnailsList* = Call_ToolresultsProjectsHistoriesExecutionsStepsThumbnailsList_589403(
    name: "toolresultsProjectsHistoriesExecutionsStepsThumbnailsList",
    meth: HttpMethod.HttpGet, host: "www.googleapis.com", route: "/{projectId}/histories/{historyId}/executions/{executionId}/steps/{stepId}/thumbnails", validator: validate_ToolresultsProjectsHistoriesExecutionsStepsThumbnailsList_589404,
    base: "/toolresults/v1beta3/projects",
    url: url_ToolresultsProjectsHistoriesExecutionsStepsThumbnailsList_589405,
    schemes: {Scheme.Https})
type
  Call_ToolresultsProjectsHistoriesExecutionsStepsPublishXunitXmlFiles_589423 = ref object of OpenApiRestCall_588450
proc url_ToolresultsProjectsHistoriesExecutionsStepsPublishXunitXmlFiles_589425(
    protocol: Scheme; host: string; base: string; route: string; path: JsonNode;
    query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ToolresultsProjectsHistoriesExecutionsStepsPublishXunitXmlFiles_589424(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `stepId` field"
  var valid_589426 = path.getOrDefault("stepId")
  valid_589426 = validateParameter(valid_589426, JString, required = true,
                                 default = nil)
  if valid_589426 != nil:
    section.add "stepId", valid_589426
  ...
  var valid_589428 = path.getOrDefault("historyId")
  valid_589428 = validateParameter(valid_589428, JString, required = true,
                                 default = nil)
  if valid_589428 != nil:
    section.add "historyId", valid_589428
  var valid_589429 = path.getOrDefault("executionId")
  valid_589429 = validateParameter(valid_589429, JString, required = true,
                                 default = nil)
  if valid_589429 != nil:
    section.add "executionId", valid_589429
  result.add "path", section
  ## parameters in `query` object:
  ##   fields: JString
  ##         : Selector specifying which fields to include in a partial response.
...
proc call*(call_589438: Call_ToolresultsProjectsHistoriesExecutionsStepsPublishXunitXmlFiles_589423;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Publish xml files to an existing Step.
  ## 
...
proc call*(call_589439: Call_ToolresultsProjectsHistoriesExecutionsStepsPublishXunitXmlFiles_589423;
          stepId: string; projectId: string; historyId: string; executionId: string;
          fields: string = ""; quotaUser: string = ""; alt: string = "json";
          oauthToken: string = ""; userIp: string = ""; key: string = "";
          body: JsonNode = nil; prettyPrint: bool = true): Recallable =
  ...
  add(path_589440, "stepId", newJString(stepId))
  ...
  add(path_589440, "projectId", newJString(projectId))
  add(path_589440, "historyId", newJString(historyId))
  if body != nil:
    body_589442 = body
  add(query_589441, "prettyPrint", newJBool(prettyPrint))
  add(path_589440, "executionId", newJString(executionId))
  result = call_589439.call(path_589440, query_589441, nil, nil, body_589442)

var toolresultsProjectsHistoriesExecutionsStepsPublishXunitXmlFiles* = Call_ToolresultsProjectsHistoriesExecutionsStepsPublishXunitXmlFiles_589423(
    name: "toolresultsProjectsHistoriesExecutionsStepsPublishXunitXmlFiles",
    meth: HttpMethod.HttpPost, host: "www.googleapis.com", route: "/{projectId}/histories/{historyId}/executions/{executionId}/steps/{stepId}:publishXunitXmlFiles", validator: validate_ToolresultsProjectsHistoriesExecutionsStepsPublishXunitXmlFiles_589424,
    base: "/toolresults/v1beta3/projects",
    url: url_ToolresultsProjectsHistoriesExecutionsStepsPublishXunitXmlFiles_589425,
    schemes: {Scheme.Https})
type
  Call_ToolresultsProjectsGetSettings_589443 = ref object of OpenApiRestCall_588450
proc url_ToolresultsProjectsGetSettings_589445(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_ToolresultsProjectsGetSettings_589444(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `projectId` field"
  var valid_589446 = path.getOrDefault("projectId")
  valid_589446 = validateParameter(valid_589446, JString, required = true,
                                 default = nil)
  if valid_589446 != nil:
    section.add "projectId", valid_589446
  result.add "path", section
  ## parameters in `query` object:
  ##   fields: JString
  ##         : Selector specifying which fields to include in a partial response.
  ...
  var valid_589451 = query.getOrDefault("userIp")
  valid_589451 = validateParameter(valid_589451, JString, required = false,
                                 default = nil)
  if valid_589451 != nil:
    section.add "userIp", valid_589451
...
proc call*(call_589454: Call_ToolresultsProjectsGetSettings_589443; path: JsonNode;
...
proc call*(call_589455: Call_ToolresultsProjectsGetSettings_589443;
  ...
  add(path_589456, "projectId", newJString(projectId))
  add(query_589457, "prettyPrint", newJBool(prettyPrint))
  result = call_589455.call(path_589456, query_589457, nil, nil, nil)

var toolresultsProjectsGetSettings* = Call_ToolresultsProjectsGetSettings_589443(
    name: "toolresultsProjectsGetSettings", meth: HttpMethod.HttpGet,
    host: "www.googleapis.com", route: "/{projectId}/settings",
    validator: validate_ToolresultsProjectsGetSettings_589444,
    base: "/toolresults/v1beta3/projects",
    url: url_ToolresultsProjectsGetSettings_589445, schemes: {Scheme.Https})
type
  Call_ToolresultsProjectsInitializeSettings_589458 = ref object of OpenApiRestCall_588450
proc url_ToolresultsProjectsInitializeSettings_589460(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_ToolresultsProjectsInitializeSettings_589459(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `projectId` field"
  var valid_589461 = path.getOrDefault("projectId")
  valid_589461 = validateParameter(valid_589461, JString, required = true,
                                 default = nil)
  if valid_589461 != nil:
    section.add "projectId", valid_589461
  result.add "path", section
  ## parameters in `query` object:
  ##   fields: JString
  ##         : Selector specifying which fields to include in a partial response.
  ...
  ##              : Returns response with indentations and line breaks.
  section = newJObject()
  var valid_589462 = query.getOrDefault("fields")
  valid_589462 = validateParameter(valid_589462, JString, required = false,
                                 default = nil)
  if valid_589462 != nil:
    section.add "fields", valid_589462
  ...
  var valid_589466 = query.getOrDefault("userIp")
  valid_589466 = validateParameter(valid_589466, JString, required = false,
                                 default = nil)
  if valid_589466 != nil:
    section.add "userIp", valid_589466
...
proc call*(call_589469: Call_ToolresultsProjectsInitializeSettings_589458;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Creates resources for settings which have not yet been set.
  ## 
...
proc call*(call_589470: Call_ToolresultsProjectsInitializeSettings_589458;
          projectId: string; fields: string = ""; quotaUser: string = "";
          alt: string = "json"; oauthToken: string = ""; userIp: string = "";
          key: string = ""; prettyPrint: bool = true): Recallable =
  ...
  add(query_589472, "userIp", newJString(userIp))
  add(query_589472, "key", newJString(key))
  add(path_589471, "projectId", newJString(projectId))
  add(query_589472, "prettyPrint", newJBool(prettyPrint))
  result = call_589470.call(path_589471, query_589472, nil, nil, nil)

var toolresultsProjectsInitializeSettings* = Call_ToolresultsProjectsInitializeSettings_589458(
    ...
    validator: validate_ToolresultsProjectsInitializeSettings_589459,
    base: "/toolresults/v1beta3/projects",
    url: url_ToolresultsProjectsInitializeSettings_589460, schemes: {Scheme.Https})
export
  rest
