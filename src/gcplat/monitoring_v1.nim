...
type
  Call_MonitoringOperationsGet_578610 = ref object of OpenApiRestCall_578339
proc url_MonitoringOperationsGet_578612(protocol: Scheme; host: string; base: string;
...
proc validate_MonitoringOperationsGet_578611(path: JsonNode; query: JsonNode;
...
proc call*(call_578785: Call_MonitoringOperationsGet_578610; path: JsonNode;
...
proc call*(call_578856: Call_MonitoringOperationsGet_578610; name: string;
...
var monitoringOperationsGet* = Call_MonitoringOperationsGet_578610(
    name: "monitoringOperationsGet", meth: HttpMethod.HttpGet,
    host: "monitoring.googleapis.com", route: "/v1/{name}",
    validator: validate_MonitoringOperationsGet_578611, base: "/",
    url: url_MonitoringOperationsGet_578612, schemes: {Scheme.Https})
type
  Call_MonitoringOperationsDelete_578898 = ref object of OpenApiRestCall_578339
proc url_MonitoringOperationsDelete_578900(protocol: Scheme; host: string;
...
proc validate_MonitoringOperationsDelete_578899(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_578913: Call_MonitoringOperationsDelete_578898; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a long-running operation. This method indicates that the client is no longer interested in the operation result. It does not cancel the operation. If the server doesn't support this method, it returns google.rpc.Code.UNIMPLEMENTED.
  ## 
...
proc call*(call_578914: Call_MonitoringOperationsDelete_578898; name: string;
          key: string = ""; prettyPrint: bool = true; oauthToken: string = "";
          Xgafv: string = "1"; alt: string = "json"; uploadType: string = "";
          quotaUser: string = ""; callback: string = ""; fields: string = "";
          accessToken: string = ""; uploadProtocol: string = ""): Recallable =
...
var monitoringOperationsDelete* = Call_MonitoringOperationsDelete_578898(
    name: "monitoringOperationsDelete", meth: HttpMethod.HttpDelete,
    host: "monitoring.googleapis.com", route: "/v1/{name}",
    validator: validate_MonitoringOperationsDelete_578899, base: "/",
    url: url_MonitoringOperationsDelete_578900, schemes: {Scheme.Https})
type
  Call_MonitoringOperationsCancel_578917 = ref object of OpenApiRestCall_578339
proc url_MonitoringOperationsCancel_578919(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_MonitoringOperationsCancel_578918(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_578933: Call_MonitoringOperationsCancel_578917; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Starts asynchronous cancellation on a long-running operation. The server makes a best effort to cancel the operation, but success is not guaranteed. If the server doesn't support this method, it returns google.rpc.Code.UNIMPLEMENTED. Clients can use Operations.GetOperation or other methods to check whether the cancellation succeeded or whether the operation completed despite cancellation. On successful cancellation, the operation is not deleted; instead, it becomes an operation with an Operation.error value with a google.rpc.Status.code of 1, corresponding to Code.CANCELLED.
  ## 
...
proc call*(call_578934: Call_MonitoringOperationsCancel_578917; name: string;
          key: string = ""; prettyPrint: bool = true; oauthToken: string = "";
          Xgafv: string = "1"; alt: string = "json"; uploadType: string = "";
...
var monitoringOperationsCancel* = Call_MonitoringOperationsCancel_578917(
    name: "monitoringOperationsCancel", meth: HttpMethod.HttpPost,
    host: "monitoring.googleapis.com", route: "/v1/{name}:cancel",
    validator: validate_MonitoringOperationsCancel_578918, base: "/",
    url: url_MonitoringOperationsCancel_578919, schemes: {Scheme.Https})
export
  rest
