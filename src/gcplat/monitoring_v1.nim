...
type
  Call_MonitoringOperationsGet_579677 = ref object of OpenApiRestCall_579408
proc url_MonitoringOperationsGet_579679(protocol: Scheme; host: string; base: string;
...
proc validate_MonitoringOperationsGet_579678(path: JsonNode; query: JsonNode;
...
proc call*(call_579852: Call_MonitoringOperationsGet_579677; path: JsonNode;
...
proc call*(call_579923: Call_MonitoringOperationsGet_579677; name: string;
...
var monitoringOperationsGet* = Call_MonitoringOperationsGet_579677(
    name: "monitoringOperationsGet", meth: HttpMethod.HttpGet,
    host: "monitoring.googleapis.com", route: "/v1/{name}",
    validator: validate_MonitoringOperationsGet_579678, base: "/",
    url: url_MonitoringOperationsGet_579679, schemes: {Scheme.Https})
type
  Call_MonitoringOperationsDelete_579965 = ref object of OpenApiRestCall_579408
proc url_MonitoringOperationsDelete_579967(protocol: Scheme; host: string;
...
proc validate_MonitoringOperationsDelete_579966(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_579980: Call_MonitoringOperationsDelete_579965; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a long-running operation. This method indicates that the client is no longer interested in the operation result. It does not cancel the operation. If the server doesn't support this method, it returns google.rpc.Code.UNIMPLEMENTED.
  ## 
...
proc call*(call_579981: Call_MonitoringOperationsDelete_579965; name: string;
          uploadProtocol: string = ""; fields: string = ""; quotaUser: string = "";
          alt: string = "json"; oauthToken: string = ""; callback: string = "";
          accessToken: string = ""; uploadType: string = ""; key: string = "";
          Xgafv: string = "1"; prettyPrint: bool = true): Recallable =
...
var monitoringOperationsDelete* = Call_MonitoringOperationsDelete_579965(
    name: "monitoringOperationsDelete", meth: HttpMethod.HttpDelete,
    host: "monitoring.googleapis.com", route: "/v1/{name}",
    validator: validate_MonitoringOperationsDelete_579966, base: "/",
    url: url_MonitoringOperationsDelete_579967, schemes: {Scheme.Https})
type
  Call_MonitoringOperationsCancel_579984 = ref object of OpenApiRestCall_579408
proc url_MonitoringOperationsCancel_579986(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_MonitoringOperationsCancel_579985(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_580000: Call_MonitoringOperationsCancel_579984; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Starts asynchronous cancellation on a long-running operation. The server makes a best effort to cancel the operation, but success is not guaranteed. If the server doesn't support this method, it returns google.rpc.Code.UNIMPLEMENTED. Clients can use Operations.GetOperation or other methods to check whether the cancellation succeeded or whether the operation completed despite cancellation. On successful cancellation, the operation is not deleted; instead, it becomes an operation with an Operation.error value with a google.rpc.Status.code of 1, corresponding to Code.CANCELLED.
  ## 
...
proc call*(call_580001: Call_MonitoringOperationsCancel_579984; name: string;
          uploadProtocol: string = ""; fields: string = ""; quotaUser: string = "";
          alt: string = "json"; oauthToken: string = ""; callback: string = "";
          accessToken: string = ""; uploadType: string = ""; key: string = "";
...
var monitoringOperationsCancel* = Call_MonitoringOperationsCancel_579984(
    name: "monitoringOperationsCancel", meth: HttpMethod.HttpPost,
    host: "monitoring.googleapis.com", route: "/v1/{name}:cancel",
    validator: validate_MonitoringOperationsCancel_579985, base: "/",
    url: url_MonitoringOperationsCancel_579986, schemes: {Scheme.Https})
export
  rest
