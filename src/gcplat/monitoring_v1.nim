...
type
  Call_MonitoringOperationsGet_588710 = ref object of OpenApiRestCall_588441
proc url_MonitoringOperationsGet_588712(protocol: Scheme; host: string; base: string;
...
proc validate_MonitoringOperationsGet_588711(path: JsonNode; query: JsonNode;
...
proc call*(call_588885: Call_MonitoringOperationsGet_588710; path: JsonNode;
...
proc call*(call_588956: Call_MonitoringOperationsGet_588710; name: string;
...
var monitoringOperationsGet* = Call_MonitoringOperationsGet_588710(
    name: "monitoringOperationsGet", meth: HttpMethod.HttpGet,
    host: "monitoring.googleapis.com", route: "/v1/{name}",
    validator: validate_MonitoringOperationsGet_588711, base: "/",
    url: url_MonitoringOperationsGet_588712, schemes: {Scheme.Https})
type
  Call_MonitoringOperationsDelete_588998 = ref object of OpenApiRestCall_588441
proc url_MonitoringOperationsDelete_589000(protocol: Scheme; host: string;
...
proc validate_MonitoringOperationsDelete_588999(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_589013: Call_MonitoringOperationsDelete_588998; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a long-running operation. This method indicates that the client is no longer interested in the operation result. It does not cancel the operation. If the server doesn't support this method, it returns google.rpc.Code.UNIMPLEMENTED.
  ## 
...
proc call*(call_589014: Call_MonitoringOperationsDelete_588998; name: string;
          uploadProtocol: string = ""; fields: string = ""; quotaUser: string = "";
          alt: string = "json"; oauthToken: string = ""; callback: string = "";
          accessToken: string = ""; uploadType: string = ""; key: string = "";
          Xgafv: string = "1"; prettyPrint: bool = true): Recallable =
...
var monitoringOperationsDelete* = Call_MonitoringOperationsDelete_588998(
    name: "monitoringOperationsDelete", meth: HttpMethod.HttpDelete,
    host: "monitoring.googleapis.com", route: "/v1/{name}",
    validator: validate_MonitoringOperationsDelete_588999, base: "/",
    url: url_MonitoringOperationsDelete_589000, schemes: {Scheme.Https})
type
  Call_MonitoringOperationsCancel_589017 = ref object of OpenApiRestCall_588441
proc url_MonitoringOperationsCancel_589019(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_MonitoringOperationsCancel_589018(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_589033: Call_MonitoringOperationsCancel_589017; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Starts asynchronous cancellation on a long-running operation. The server makes a best effort to cancel the operation, but success is not guaranteed. If the server doesn't support this method, it returns google.rpc.Code.UNIMPLEMENTED. Clients can use Operations.GetOperation or other methods to check whether the cancellation succeeded or whether the operation completed despite cancellation. On successful cancellation, the operation is not deleted; instead, it becomes an operation with an Operation.error value with a google.rpc.Status.code of 1, corresponding to Code.CANCELLED.
  ## 
...
proc call*(call_589034: Call_MonitoringOperationsCancel_589017; name: string;
          uploadProtocol: string = ""; fields: string = ""; quotaUser: string = "";
          alt: string = "json"; oauthToken: string = ""; callback: string = "";
          accessToken: string = ""; uploadType: string = ""; key: string = "";
...
var monitoringOperationsCancel* = Call_MonitoringOperationsCancel_589017(
    name: "monitoringOperationsCancel", meth: HttpMethod.HttpPost,
    host: "monitoring.googleapis.com", route: "/v1/{name}:cancel",
    validator: validate_MonitoringOperationsCancel_589018, base: "/",
    url: url_MonitoringOperationsCancel_589019, schemes: {Scheme.Https})
export
  rest
