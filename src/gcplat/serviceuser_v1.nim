...
type
  Call_ServiceuserServicesSearch_593690 = ref object of OpenApiRestCall_593421
proc url_ServiceuserServicesSearch_593692(protocol: Scheme; host: string;
...
proc validate_ServiceuserServicesSearch_593691(path: JsonNode; query: JsonNode;
...
proc call*(call_593854: Call_ServiceuserServicesSearch_593690; path: JsonNode;
...
proc call*(call_593925: Call_ServiceuserServicesSearch_593690;
...
var serviceuserServicesSearch* = Call_ServiceuserServicesSearch_593690(
    name: "serviceuserServicesSearch", meth: HttpMethod.HttpGet,
    host: "serviceuser.googleapis.com", route: "/v1/services:search",
    validator: validate_ServiceuserServicesSearch_593691, base: "/",
    url: url_ServiceuserServicesSearch_593692, schemes: {Scheme.Https})
type
  Call_ServiceuserProjectsServicesDisable_593966 = ref object of OpenApiRestCall_593421
proc url_ServiceuserProjectsServicesDisable_593968(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ServiceuserProjectsServicesDisable_593967(path: JsonNode;
...
proc call*(call_593998: Call_ServiceuserProjectsServicesDisable_593966;
...
proc call*(call_593999: Call_ServiceuserProjectsServicesDisable_593966;
  ...
  add(query_594001, "upload_protocol", newJString(uploadProtocol))
  ...
  add(query_594001, "pp", newJBool(pp))
  add(query_594001, "oauth_token", newJString(oauthToken))
  add(query_594001, "callback", newJString(callback))
  add(query_594001, "access_token", newJString(accessToken))
  add(query_594001, "uploadType", newJString(uploadType))
  add(query_594001, "key", newJString(key))
  add(query_594001, "$.xgafv", newJString(Xgafv))
  if body != nil:
    body_594002 = body
  add(query_594001, "prettyPrint", newJBool(prettyPrint))
  add(query_594001, "bearer_token", newJString(bearerToken))
  result = call_593999.call(path_594000, query_594001, nil, nil, body_594002)

var serviceuserProjectsServicesDisable* = Call_ServiceuserProjectsServicesDisable_593966(
    name: "serviceuserProjectsServicesDisable", meth: HttpMethod.HttpPost,
    host: "serviceuser.googleapis.com", route: "/v1/{name}:disable",
    validator: validate_ServiceuserProjectsServicesDisable_593967, base: "/",
    url: url_ServiceuserProjectsServicesDisable_593968, schemes: {Scheme.Https})
type
  Call_ServiceuserProjectsServicesEnable_594003 = ref object of OpenApiRestCall_593421
proc url_ServiceuserProjectsServicesEnable_594005(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ServiceuserProjectsServicesEnable_594004(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594011 = query.getOrDefault("pp")
  valid_594011 = validateParameter(valid_594011, JBool, required = false,
                                 default = newJBool(true))
  if valid_594011 != nil:
    section.add "pp", valid_594011
  ...
  var valid_594019 = query.getOrDefault("bearer_token")
  valid_594019 = validateParameter(valid_594019, JString, required = false,
                                 default = nil)
  if valid_594019 != nil:
    section.add "bearer_token", valid_594019
  result.add "query", section
  section = newJObject()
  result.add "header", section
  section = newJObject()
...
proc call*(call_594021: Call_ServiceuserProjectsServicesEnable_594003;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Enable a service so it can be used with a project.
  ## See [Cloud Auth Guide](https://cloud.google.com/docs/authentication) for
...
proc call*(call_594022: Call_ServiceuserProjectsServicesEnable_594003;
          name: string; uploadProtocol: string = ""; fields: string = "";
          quotaUser: string = ""; alt: string = "json"; pp: bool = true;
          oauthToken: string = ""; callback: string = ""; accessToken: string = "";
          uploadType: string = ""; key: string = ""; Xgafv: string = "1";
...
var serviceuserProjectsServicesEnable* = Call_ServiceuserProjectsServicesEnable_594003(
    name: "serviceuserProjectsServicesEnable", meth: HttpMethod.HttpPost,
    host: "serviceuser.googleapis.com", route: "/v1/{name}:enable",
    validator: validate_ServiceuserProjectsServicesEnable_594004, base: "/",
    url: url_ServiceuserProjectsServicesEnable_594005, schemes: {Scheme.Https})
type
  Call_ServiceuserProjectsServicesList_594026 = ref object of OpenApiRestCall_593421
proc url_ServiceuserProjectsServicesList_594028(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ServiceuserProjectsServicesList_594027(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594029 = path.getOrDefault("parent")
  valid_594029 = validateParameter(valid_594029, JString, required = true,
                                 default = nil)
  if valid_594029 != nil:
    section.add "parent", valid_594029
  result.add "path", section
  ## parameters in `query` object:
  ##   upload_protocol: JString
  ##                  : Upload protocol for media (e.g. "raw", "multipart").
  ...
  var valid_594032 = query.getOrDefault("pageToken")
  valid_594032 = validateParameter(valid_594032, JString, required = false,
                                 default = nil)
  if valid_594032 != nil:
    section.add "pageToken", valid_594032
  ...
  var valid_594035 = query.getOrDefault("pp")
  valid_594035 = validateParameter(valid_594035, JBool, required = false,
                                 default = newJBool(true))
  if valid_594035 != nil:
    section.add "pp", valid_594035
...
proc call*(call_594045: Call_ServiceuserProjectsServicesList_594026;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## List enabled services for the specified consumer.
  ## 
...
proc call*(call_594046: Call_ServiceuserProjectsServicesList_594026;
  ...
  add(path_594047, "parent", newJString(parent))
  add(query_594048, "key", newJString(key))
  add(query_594048, "$.xgafv", newJString(Xgafv))
  add(query_594048, "pageSize", newJInt(pageSize))
...
var serviceuserProjectsServicesList* = Call_ServiceuserProjectsServicesList_594026(
    name: "serviceuserProjectsServicesList", meth: HttpMethod.HttpGet,
    host: "serviceuser.googleapis.com", route: "/v1/{parent}/services",
    validator: validate_ServiceuserProjectsServicesList_594027, base: "/",
    url: url_ServiceuserProjectsServicesList_594028, schemes: {Scheme.Https})
export
  rest
