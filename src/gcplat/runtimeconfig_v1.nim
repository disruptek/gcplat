...
type
  Call_RuntimeconfigOperationsList_588710 = ref object of OpenApiRestCall_588441
proc url_RuntimeconfigOperationsList_588712(protocol: Scheme; host: string;
...
proc validate_RuntimeconfigOperationsList_588711(path: JsonNode; query: JsonNode;
...
proc call*(call_588888: Call_RuntimeconfigOperationsList_588710; path: JsonNode;
...
proc call*(call_588959: Call_RuntimeconfigOperationsList_588710; name: string;
...
var runtimeconfigOperationsList* = Call_RuntimeconfigOperationsList_588710(
    name: "runtimeconfigOperationsList", meth: HttpMethod.HttpGet,
    host: "runtimeconfig.googleapis.com", route: "/v1/{name}",
    validator: validate_RuntimeconfigOperationsList_588711, base: "/",
    url: url_RuntimeconfigOperationsList_588712, schemes: {Scheme.Https})
type
  Call_RuntimeconfigOperationsDelete_589001 = ref object of OpenApiRestCall_588441
proc url_RuntimeconfigOperationsDelete_589003(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_RuntimeconfigOperationsDelete_589002(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_589016: Call_RuntimeconfigOperationsDelete_589001; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a long-running operation. This method indicates that the client is
  ## no longer interested in the operation result. It does not cancel the
  ## operation. If the server doesn't support this method, it returns
...
proc call*(call_589017: Call_RuntimeconfigOperationsDelete_589001; name: string;
...
var runtimeconfigOperationsDelete* = Call_RuntimeconfigOperationsDelete_589001(
    name: "runtimeconfigOperationsDelete", meth: HttpMethod.HttpDelete,
    host: "runtimeconfig.googleapis.com", route: "/v1/{name}",
    validator: validate_RuntimeconfigOperationsDelete_589002, base: "/",
    url: url_RuntimeconfigOperationsDelete_589003, schemes: {Scheme.Https})
type
  Call_RuntimeconfigOperationsCancel_589020 = ref object of OpenApiRestCall_588441
proc url_RuntimeconfigOperationsCancel_589022(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_RuntimeconfigOperationsCancel_589021(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_589036: Call_RuntimeconfigOperationsCancel_589020; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Starts asynchronous cancellation on a long-running operation.  The server
  ## makes a best effort to cancel the operation, but success is not
  ## guaranteed.  If the server doesn't support this method, it returns
...
proc call*(call_589037: Call_RuntimeconfigOperationsCancel_589020; name: string;
          uploadProtocol: string = ""; fields: string = ""; quotaUser: string = "";
          alt: string = "json"; oauthToken: string = ""; callback: string = "";
          accessToken: string = ""; uploadType: string = ""; key: string = "";
...
var runtimeconfigOperationsCancel* = Call_RuntimeconfigOperationsCancel_589020(
    name: "runtimeconfigOperationsCancel", meth: HttpMethod.HttpPost,
    host: "runtimeconfig.googleapis.com", route: "/v1/{name}:cancel",
    validator: validate_RuntimeconfigOperationsCancel_589021, base: "/",
    url: url_RuntimeconfigOperationsCancel_589022, schemes: {Scheme.Https})
export
  rest
