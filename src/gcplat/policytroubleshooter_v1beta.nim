...
type
  Call_PolicytroubleshooterIamTroubleshoot_588710 = ref object of OpenApiRestCall_588441
proc url_PolicytroubleshooterIamTroubleshoot_588712(protocol: Scheme; host: string;
...
proc validate_PolicytroubleshooterIamTroubleshoot_588711(path: JsonNode;
...
proc call*(call_588871: Call_PolicytroubleshooterIamTroubleshoot_588710;
...
proc call*(call_588942: Call_PolicytroubleshooterIamTroubleshoot_588710;
...
var policytroubleshooterIamTroubleshoot* = Call_PolicytroubleshooterIamTroubleshoot_588710(
    ...
    validator: validate_PolicytroubleshooterIamTroubleshoot_588711, base: "/",
    url: url_PolicytroubleshooterIamTroubleshoot_588712, schemes: {Scheme.Https})
export
  rest
