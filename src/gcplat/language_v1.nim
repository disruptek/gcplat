...
type
  Call_LanguageDocumentsAnalyzeEntitySentiment_579951 = ref object of OpenApiRestCall_579408
proc url_LanguageDocumentsAnalyzeEntitySentiment_579953(protocol: Scheme;
...
proc validate_LanguageDocumentsAnalyzeEntitySentiment_579952(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_579966: Call_LanguageDocumentsAnalyzeEntitySentiment_579951;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Finds entities, similar to AnalyzeEntities in the text and analyzes
  ## sentiment associated with each entity and its mentions.
...
proc call*(call_579967: Call_LanguageDocumentsAnalyzeEntitySentiment_579951;
          uploadProtocol: string = ""; fields: string = ""; quotaUser: string = "";
          alt: string = "json"; oauthToken: string = ""; callback: string = "";
          accessToken: string = ""; uploadType: string = ""; key: string = "";
          Xgafv: string = "1"; body: JsonNode = nil; prettyPrint: bool = true): Recallable =
...
var languageDocumentsAnalyzeEntitySentiment* = Call_LanguageDocumentsAnalyzeEntitySentiment_579951(
    name: "languageDocumentsAnalyzeEntitySentiment", meth: HttpMethod.HttpPost,
    host: "language.googleapis.com",
    route: "/v1/documents:analyzeEntitySentiment",
    validator: validate_LanguageDocumentsAnalyzeEntitySentiment_579952, base: "/",
    url: url_LanguageDocumentsAnalyzeEntitySentiment_579953,
    schemes: {Scheme.Https})
type
  Call_LanguageDocumentsAnalyzeSentiment_579970 = ref object of OpenApiRestCall_579408
proc url_LanguageDocumentsAnalyzeSentiment_579972(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_LanguageDocumentsAnalyzeSentiment_579971(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_579985: Call_LanguageDocumentsAnalyzeSentiment_579970;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Analyzes the sentiment of the provided text.
  ## 
...
proc call*(call_579986: Call_LanguageDocumentsAnalyzeSentiment_579970;
          uploadProtocol: string = ""; fields: string = ""; quotaUser: string = "";
          alt: string = "json"; oauthToken: string = ""; callback: string = "";
          accessToken: string = ""; uploadType: string = ""; key: string = "";
          Xgafv: string = "1"; body: JsonNode = nil; prettyPrint: bool = true): Recallable =
...
var languageDocumentsAnalyzeSentiment* = Call_LanguageDocumentsAnalyzeSentiment_579970(
    ...
    validator: validate_LanguageDocumentsAnalyzeSentiment_579971, base: "/",
    url: url_LanguageDocumentsAnalyzeSentiment_579972, schemes: {Scheme.Https})
type
  Call_LanguageDocumentsAnalyzeSyntax_579989 = ref object of OpenApiRestCall_579408
proc url_LanguageDocumentsAnalyzeSyntax_579991(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_LanguageDocumentsAnalyzeSyntax_579990(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_580004: Call_LanguageDocumentsAnalyzeSyntax_579989; path: JsonNode;
...
proc call*(call_580005: Call_LanguageDocumentsAnalyzeSyntax_579989;
          uploadProtocol: string = ""; fields: string = ""; quotaUser: string = "";
          alt: string = "json"; oauthToken: string = ""; callback: string = "";
          accessToken: string = ""; uploadType: string = ""; key: string = "";
          Xgafv: string = "1"; body: JsonNode = nil; prettyPrint: bool = true): Recallable =
...
var languageDocumentsAnalyzeSyntax* = Call_LanguageDocumentsAnalyzeSyntax_579989(
    ...
    validator: validate_LanguageDocumentsAnalyzeSyntax_579990, base: "/",
    url: url_LanguageDocumentsAnalyzeSyntax_579991, schemes: {Scheme.Https})
type
  Call_LanguageDocumentsAnnotateText_580008 = ref object of OpenApiRestCall_579408
proc url_LanguageDocumentsAnnotateText_580010(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_LanguageDocumentsAnnotateText_580009(path: JsonNode; query: JsonNode;
...
proc call*(call_580023: Call_LanguageDocumentsAnnotateText_580008; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## A convenience method that provides all the features that analyzeSentiment,
  ## analyzeEntities, and analyzeSyntax provide in one call.
  ## 
...
proc call*(call_580024: Call_LanguageDocumentsAnnotateText_580008;
          uploadProtocol: string = ""; fields: string = ""; quotaUser: string = "";
          alt: string = "json"; oauthToken: string = ""; callback: string = "";
          accessToken: string = ""; uploadType: string = ""; key: string = "";
          Xgafv: string = "1"; body: JsonNode = nil; prettyPrint: bool = true): Recallable =
  ...
  result = call_580024.call(nil, query_580025, nil, nil, body_580026)

var languageDocumentsAnnotateText* = Call_LanguageDocumentsAnnotateText_580008(
    name: "languageDocumentsAnnotateText", meth: HttpMethod.HttpPost,
    host: "language.googleapis.com", route: "/v1/documents:annotateText",
    validator: validate_LanguageDocumentsAnnotateText_580009, base: "/",
    url: url_LanguageDocumentsAnnotateText_580010, schemes: {Scheme.Https})
type
  Call_LanguageDocumentsClassifyText_580027 = ref object of OpenApiRestCall_579408
proc url_LanguageDocumentsClassifyText_580029(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_LanguageDocumentsClassifyText_580028(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_580042: Call_LanguageDocumentsClassifyText_580027; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Classifies a document into categories.
  ## 
...
proc call*(call_580043: Call_LanguageDocumentsClassifyText_580027;
          uploadProtocol: string = ""; fields: string = ""; quotaUser: string = "";
          alt: string = "json"; oauthToken: string = ""; callback: string = "";
          accessToken: string = ""; uploadType: string = ""; key: string = "";
          Xgafv: string = "1"; body: JsonNode = nil; prettyPrint: bool = true): Recallable =
...
var languageDocumentsClassifyText* = Call_LanguageDocumentsClassifyText_580027(
    name: "languageDocumentsClassifyText", meth: HttpMethod.HttpPost,
    host: "language.googleapis.com", route: "/v1/documents:classifyText",
    validator: validate_LanguageDocumentsClassifyText_580028, base: "/",
    url: url_LanguageDocumentsClassifyText_580029, schemes: {Scheme.Https})
export
  rest
