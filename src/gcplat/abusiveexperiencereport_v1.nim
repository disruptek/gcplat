...
type
  Call_AbusiveexperiencereportViolatingSitesList_578610 = ref object of OpenApiRestCall_578339
proc url_AbusiveexperiencereportViolatingSitesList_578612(protocol: Scheme;
...
proc validate_AbusiveexperiencereportViolatingSitesList_578611(path: JsonNode;
...
proc call*(call_578770: Call_AbusiveexperiencereportViolatingSitesList_578610;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Lists sites that are failing in the Abusive Experience Report.
  ## 
  let valid = call_578770.validator(path, query, header, formData, body)
  let scheme = call_578770.pickScheme
  if scheme.isNone:
    raise newException(IOError, "unable to find a supported scheme")
  let url = call_578770.url(scheme.get, call_578770.host, call_578770.base,
                         call_578770.route, valid.getOrDefault("path"),
                         valid.getOrDefault("query"))
  result = hook(call_578770, url, valid)

proc call*(call_578841: Call_AbusiveexperiencereportViolatingSitesList_578610;
  ...
  ##                 : Upload protocol for media (e.g. "raw", "multipart").
  var query_578842 = newJObject()
  add(query_578842, "key", newJString(key))
  add(query_578842, "prettyPrint", newJBool(prettyPrint))
  add(query_578842, "oauth_token", newJString(oauthToken))
  add(query_578842, "$.xgafv", newJString(Xgafv))
  add(query_578842, "alt", newJString(alt))
  add(query_578842, "uploadType", newJString(uploadType))
  add(query_578842, "quotaUser", newJString(quotaUser))
  add(query_578842, "callback", newJString(callback))
  add(query_578842, "fields", newJString(fields))
  add(query_578842, "access_token", newJString(accessToken))
  add(query_578842, "upload_protocol", newJString(uploadProtocol))
  result = call_578841.call(nil, query_578842, nil, nil, nil)

var abusiveexperiencereportViolatingSitesList* = Call_AbusiveexperiencereportViolatingSitesList_578610(
    ...
    validator: validate_AbusiveexperiencereportViolatingSitesList_578611,
    base: "/", url: url_AbusiveexperiencereportViolatingSitesList_578612,
    schemes: {Scheme.Https})
type
  Call_AbusiveexperiencereportSitesGet_578882 = ref object of OpenApiRestCall_578339
proc url_AbusiveexperiencereportSitesGet_578884(protocol: Scheme; host: string;
...
proc validate_AbusiveexperiencereportSitesGet_578883(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_578899 = path.getOrDefault("name")
  valid_578899 = validateParameter(valid_578899, JString, required = true,
                                 default = nil)
  if valid_578899 != nil:
    section.add "name", valid_578899
  result.add "path", section
  ## parameters in `query` object:
  ##   key: JString
  ##      : API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  var valid_578903 = query.getOrDefault("$.xgafv")
  valid_578903 = validateParameter(valid_578903, JString, required = false,
                                 default = newJString("1"))
  if valid_578903 != nil:
    section.add "$.xgafv", valid_578903
...
proc call*(call_578911: Call_AbusiveexperiencereportSitesGet_578882;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets a site's Abusive Experience Report summary.
  ## 
...
proc call*(call_578912: Call_AbusiveexperiencereportSitesGet_578882; name: string;
          key: string = ""; prettyPrint: bool = true; oauthToken: string = "";
          Xgafv: string = "1"; alt: string = "json"; uploadType: string = "";
          quotaUser: string = ""; callback: string = ""; fields: string = "";
          accessToken: string = ""; uploadProtocol: string = ""): Recallable =
  ...
  add(path_578913, "name", newJString(name))
  ...
  result = call_578912.call(path_578913, query_578914, nil, nil, nil)

var abusiveexperiencereportSitesGet* = Call_AbusiveexperiencereportSitesGet_578882(
    name: "abusiveexperiencereportSitesGet", meth: HttpMethod.HttpGet,
    host: "abusiveexperiencereport.googleapis.com", route: "/v1/{name}",
    validator: validate_AbusiveexperiencereportSitesGet_578883, base: "/",
    url: url_AbusiveexperiencereportSitesGet_578884, schemes: {Scheme.Https})
export
  rest
