...
type
  Call_CommentanalyzerCommentsAnalyze_578610 = ref object of OpenApiRestCall_578339
proc url_CommentanalyzerCommentsAnalyze_578612(protocol: Scheme; host: string;
...
proc validate_CommentanalyzerCommentsAnalyze_578611(path: JsonNode;
...
proc call*(call_578771: Call_CommentanalyzerCommentsAnalyze_578610; path: JsonNode;
...
proc call*(call_578842: Call_CommentanalyzerCommentsAnalyze_578610;
...
var commentanalyzerCommentsAnalyze* = Call_CommentanalyzerCommentsAnalyze_578610(
    ...
    validator: validate_CommentanalyzerCommentsAnalyze_578611, base: "/",
    url: url_CommentanalyzerCommentsAnalyze_578612, schemes: {Scheme.Https})
type
  Call_CommentanalyzerCommentsSuggestscore_578884 = ref object of OpenApiRestCall_578339
proc url_CommentanalyzerCommentsSuggestscore_578886(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_CommentanalyzerCommentsSuggestscore_578885(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_578899: Call_CommentanalyzerCommentsSuggestscore_578884;
...
proc call*(call_578900: Call_CommentanalyzerCommentsSuggestscore_578884;
          key: string = ""; prettyPrint: bool = true; oauthToken: string = "";
          Xgafv: string = "1"; alt: string = "json"; uploadType: string = "";
          quotaUser: string = ""; body: JsonNode = nil; callback: string = "";
          fields: string = ""; accessToken: string = ""; uploadProtocol: string = ""): Recallable =
...
var commentanalyzerCommentsSuggestscore* = Call_CommentanalyzerCommentsSuggestscore_578884(
    ...
    validator: validate_CommentanalyzerCommentsSuggestscore_578885, base: "/",
    url: url_CommentanalyzerCommentsSuggestscore_578886, schemes: {Scheme.Https})
export
  rest
