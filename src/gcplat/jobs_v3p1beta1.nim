...
type
  Call_JobsProjectsCompaniesGet_578619 = ref object of OpenApiRestCall_578348
proc url_JobsProjectsCompaniesGet_578621(protocol: Scheme; host: string;
...
proc validate_JobsProjectsCompaniesGet_578620(path: JsonNode; query: JsonNode;
...
proc call*(call_578794: Call_JobsProjectsCompaniesGet_578619; path: JsonNode;
...
proc call*(call_578865: Call_JobsProjectsCompaniesGet_578619; name: string;
          key: string = ""; prettyPrint: bool = true; oauthToken: string = "";
          Xgafv: string = "1"; alt: string = "json"; uploadType: string = "";
          quotaUser: string = ""; callback: string = ""; fields: string = "";
          accessToken: string = ""; uploadProtocol: string = ""): Recallable =
  ## jobsProjectsCompaniesGet
  ## Retrieves specified company.
  ##   key: string
  ##      : API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ##   prettyPrint: bool
...
var jobsProjectsCompaniesGet* = Call_JobsProjectsCompaniesGet_578619(
    name: "jobsProjectsCompaniesGet", meth: HttpMethod.HttpGet,
    host: "jobs.googleapis.com", route: "/v3p1beta1/{name}",
    validator: validate_JobsProjectsCompaniesGet_578620, base: "/",
    url: url_JobsProjectsCompaniesGet_578621, schemes: {Scheme.Https})
type
  Call_JobsProjectsCompaniesPatch_578926 = ref object of OpenApiRestCall_578348
proc url_JobsProjectsCompaniesPatch_578928(protocol: Scheme; host: string;
...
proc validate_JobsProjectsCompaniesPatch_578927(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_578942: Call_JobsProjectsCompaniesPatch_578926; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates specified company. Company names can't be updated. To update a
  ## company name, delete the company and all jobs associated with it, and only
  ## then re-create them.
...
proc call*(call_578943: Call_JobsProjectsCompaniesPatch_578926; name: string;
          key: string = ""; prettyPrint: bool = true; oauthToken: string = "";
          Xgafv: string = "1"; alt: string = "json"; uploadType: string = "";
          quotaUser: string = ""; body: JsonNode = nil; callback: string = "";
          fields: string = ""; accessToken: string = ""; uploadProtocol: string = ""): Recallable =
  ## jobsProjectsCompaniesPatch
  ## Updates specified company. Company names can't be updated. To update a
  ## company name, delete the company and all jobs associated with it, and only
  ## then re-create them.
  ##   key: string
...
var jobsProjectsCompaniesPatch* = Call_JobsProjectsCompaniesPatch_578926(
    name: "jobsProjectsCompaniesPatch", meth: HttpMethod.HttpPatch,
    host: "jobs.googleapis.com", route: "/v3p1beta1/{name}",
    validator: validate_JobsProjectsCompaniesPatch_578927, base: "/",
    url: url_JobsProjectsCompaniesPatch_578928, schemes: {Scheme.Https})
type
  Call_JobsProjectsCompaniesDelete_578907 = ref object of OpenApiRestCall_578348
proc url_JobsProjectsCompaniesDelete_578909(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $composeQueryString(query)
...
proc validate_JobsProjectsCompaniesDelete_578908(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_578922: Call_JobsProjectsCompaniesDelete_578907; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes specified company.
  ## Prerequisite: The company has no jobs associated with it.
  ## 
...
proc call*(call_578923: Call_JobsProjectsCompaniesDelete_578907; name: string;
          key: string = ""; prettyPrint: bool = true; oauthToken: string = "";
          Xgafv: string = "1"; alt: string = "json"; uploadType: string = "";
          quotaUser: string = ""; callback: string = ""; fields: string = "";
          accessToken: string = ""; uploadProtocol: string = ""): Recallable =
  ## jobsProjectsCompaniesDelete
  ## Deletes specified company.
  ## Prerequisite: The company has no jobs associated with it.
  ##   key: string
  ##      : API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
...
var jobsProjectsCompaniesDelete* = Call_JobsProjectsCompaniesDelete_578907(
    name: "jobsProjectsCompaniesDelete", meth: HttpMethod.HttpDelete,
    host: "jobs.googleapis.com", route: "/v3p1beta1/{name}",
    validator: validate_JobsProjectsCompaniesDelete_578908, base: "/",
    url: url_JobsProjectsCompaniesDelete_578909, schemes: {Scheme.Https})
type
