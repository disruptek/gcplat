...
type
  Call_CloudassetOperationsGet_588710 = ref object of OpenApiRestCall_588441
proc url_CloudassetOperationsGet_588712(protocol: Scheme; host: string; base: string;
...
proc validate_CloudassetOperationsGet_588711(path: JsonNode; query: JsonNode;
...
proc call*(call_588885: Call_CloudassetOperationsGet_588710; path: JsonNode;
...
proc call*(call_588956: Call_CloudassetOperationsGet_588710; name: string;
...
var cloudassetOperationsGet* = Call_CloudassetOperationsGet_588710(
    name: "cloudassetOperationsGet", meth: HttpMethod.HttpGet,
    host: "cloudasset.googleapis.com", route: "/v1/{name}",
    validator: validate_CloudassetOperationsGet_588711, base: "/",
    url: url_CloudassetOperationsGet_588712, schemes: {Scheme.Https})
type
  Call_CloudassetBatchGetAssetsHistory_588998 = ref object of OpenApiRestCall_588441
proc url_CloudassetBatchGetAssetsHistory_589000(protocol: Scheme; host: string;
...
proc validate_CloudassetBatchGetAssetsHistory_588999(path: JsonNode;
...
proc call*(call_589017: Call_CloudassetBatchGetAssetsHistory_588998;
...
proc call*(call_589018: Call_CloudassetBatchGetAssetsHistory_588998;
...
var cloudassetBatchGetAssetsHistory* = Call_CloudassetBatchGetAssetsHistory_588998(
    ...
    validator: validate_CloudassetBatchGetAssetsHistory_588999, base: "/",
    url: url_CloudassetBatchGetAssetsHistory_589000, schemes: {Scheme.Https})
type
  Call_CloudassetExportAssets_589021 = ref object of OpenApiRestCall_588441
proc url_CloudassetExportAssets_589023(protocol: Scheme; host: string; base: string;
...
proc validate_CloudassetExportAssets_589022(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_589037: Call_CloudassetExportAssets_589021; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Exports assets with time and resource types to a given Cloud Storage
  ## location. The output format is newline-delimited JSON.
  ## This API implements the google.longrunning.Operation API allowing you
...
proc call*(call_589038: Call_CloudassetExportAssets_589021; parent: string;
          uploadProtocol: string = ""; fields: string = ""; quotaUser: string = "";
          alt: string = "json"; oauthToken: string = ""; callback: string = "";
          accessToken: string = ""; uploadType: string = ""; key: string = "";
...
var cloudassetExportAssets* = Call_CloudassetExportAssets_589021(
    name: "cloudassetExportAssets", meth: HttpMethod.HttpPost,
    host: "cloudasset.googleapis.com", route: "/v1/{parent}:exportAssets",
    validator: validate_CloudassetExportAssets_589022, base: "/",
    url: url_CloudassetExportAssets_589023, schemes: {Scheme.Https})
export
  rest
