...
type
  Call_CloudassetOperationsGet_579677 = ref object of OpenApiRestCall_579408
proc url_CloudassetOperationsGet_579679(protocol: Scheme; host: string; base: string;
...
proc validate_CloudassetOperationsGet_579678(path: JsonNode; query: JsonNode;
...
proc call*(call_579852: Call_CloudassetOperationsGet_579677; path: JsonNode;
...
proc call*(call_579923: Call_CloudassetOperationsGet_579677; name: string;
...
var cloudassetOperationsGet* = Call_CloudassetOperationsGet_579677(
    name: "cloudassetOperationsGet", meth: HttpMethod.HttpGet,
    host: "cloudasset.googleapis.com", route: "/v1/{name}",
    validator: validate_CloudassetOperationsGet_579678, base: "/",
    url: url_CloudassetOperationsGet_579679, schemes: {Scheme.Https})
type
  Call_CloudassetBatchGetAssetsHistory_579965 = ref object of OpenApiRestCall_579408
proc url_CloudassetBatchGetAssetsHistory_579967(protocol: Scheme; host: string;
...
proc validate_CloudassetBatchGetAssetsHistory_579966(path: JsonNode;
...
proc call*(call_579984: Call_CloudassetBatchGetAssetsHistory_579965;
...
proc call*(call_579985: Call_CloudassetBatchGetAssetsHistory_579965;
...
var cloudassetBatchGetAssetsHistory* = Call_CloudassetBatchGetAssetsHistory_579965(
    name: "cloudassetBatchGetAssetsHistory", meth: HttpMethod.HttpGet,
    host: "cloudasset.googleapis.com",
    route: "/v1/{parent}:batchGetAssetsHistory",
    validator: validate_CloudassetBatchGetAssetsHistory_579966, base: "/",
    url: url_CloudassetBatchGetAssetsHistory_579967, schemes: {Scheme.Https})
type
  Call_CloudassetExportAssets_579988 = ref object of OpenApiRestCall_579408
proc url_CloudassetExportAssets_579990(protocol: Scheme; host: string; base: string;
...
proc validate_CloudassetExportAssets_579989(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_580004: Call_CloudassetExportAssets_579988; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Exports assets with time and resource types to a given Cloud Storage
  ## location. The output format is newline-delimited JSON.
  ## This API implements the google.longrunning.Operation API allowing you
...
proc call*(call_580005: Call_CloudassetExportAssets_579988; parent: string;
          uploadProtocol: string = ""; fields: string = ""; quotaUser: string = "";
          alt: string = "json"; oauthToken: string = ""; callback: string = "";
          accessToken: string = ""; uploadType: string = ""; key: string = "";
...
var cloudassetExportAssets* = Call_CloudassetExportAssets_579988(
    name: "cloudassetExportAssets", meth: HttpMethod.HttpPost,
    host: "cloudasset.googleapis.com", route: "/v1/{parent}:exportAssets",
    validator: validate_CloudassetExportAssets_579989, base: "/",
    url: url_CloudassetExportAssets_579990, schemes: {Scheme.Https})
export
  rest
