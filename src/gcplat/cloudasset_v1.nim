...
type
  Call_CloudassetOperationsGet_597677 = ref object of OpenApiRestCall_597408
proc url_CloudassetOperationsGet_597679(protocol: Scheme; host: string; base: string;
...
proc validate_CloudassetOperationsGet_597678(path: JsonNode; query: JsonNode;
...
proc call*(call_597852: Call_CloudassetOperationsGet_597677; path: JsonNode;
...
proc call*(call_597923: Call_CloudassetOperationsGet_597677; name: string;
...
var cloudassetOperationsGet* = Call_CloudassetOperationsGet_597677(
    name: "cloudassetOperationsGet", meth: HttpMethod.HttpGet,
    host: "cloudasset.googleapis.com", route: "/v1/{name}",
    validator: validate_CloudassetOperationsGet_597678, base: "/",
    url: url_CloudassetOperationsGet_597679, schemes: {Scheme.Https})
type
  Call_CloudassetBatchGetAssetsHistory_597965 = ref object of OpenApiRestCall_597408
proc url_CloudassetBatchGetAssetsHistory_597967(protocol: Scheme; host: string;
...
proc validate_CloudassetBatchGetAssetsHistory_597966(path: JsonNode;
...
proc call*(call_597984: Call_CloudassetBatchGetAssetsHistory_597965;
...
proc call*(call_597985: Call_CloudassetBatchGetAssetsHistory_597965;
...
var cloudassetBatchGetAssetsHistory* = Call_CloudassetBatchGetAssetsHistory_597965(
    ...
    validator: validate_CloudassetBatchGetAssetsHistory_597966, base: "/",
    url: url_CloudassetBatchGetAssetsHistory_597967, schemes: {Scheme.Https})
type
  Call_CloudassetExportAssets_597988 = ref object of OpenApiRestCall_597408
proc url_CloudassetExportAssets_597990(protocol: Scheme; host: string; base: string;
...
proc validate_CloudassetExportAssets_597989(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_598004: Call_CloudassetExportAssets_597988; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Exports assets with time and resource types to a given Cloud Storage
  ## location. The output format is newline-delimited JSON.
  ## This API implements the google.longrunning.Operation API allowing you
...
proc call*(call_598005: Call_CloudassetExportAssets_597988; parent: string;
          uploadProtocol: string = ""; fields: string = ""; quotaUser: string = "";
          alt: string = "json"; oauthToken: string = ""; callback: string = "";
          accessToken: string = ""; uploadType: string = ""; key: string = "";
...
var cloudassetExportAssets* = Call_CloudassetExportAssets_597988(
    name: "cloudassetExportAssets", meth: HttpMethod.HttpPost,
    host: "cloudasset.googleapis.com", route: "/v1/{parent}:exportAssets",
    validator: validate_CloudassetExportAssets_597989, base: "/",
    url: url_CloudassetExportAssets_597990, schemes: {Scheme.Https})
export
  rest
